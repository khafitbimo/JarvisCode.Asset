        ...
        Private Sub SetShift()
            If mTerimajasa_id <> "" Then
                ...
                Try
                    ...
                    tblShift = clsUtil.GetDataTable("as_TrnTerimajasausedEditing_Select", Me.DSN, parCriteria)
        ...
        Private Sub SetEps()
            If mTerimajasa_id <> "" Then
                ...
                Try
                    ...
                    tblEpisode = clsUtil.GetDataTable("as_TrnTerimajasausededitingeps_Select", Me.DSN, parCriteria)
