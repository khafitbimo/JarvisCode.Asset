...
Namespace DataSource
    Public Class clsRptBarangDetil
        ...
        Private mPeran As String
        Private mEpisode As String
        Private mUsage As Decimal

        'deklar untuk editing
        Private mShift1 As Integer
        Private mShift2 As Integer
        Private mShift3 As Integer
        Private mBoot1 As Integer
        Private mBoot2 As Integer
        Private mBoot3 As Integer
        Private meps_usage1_start As String
        Private meps_usage1_end As String
        Private meps_usage2_start As String
        Private meps_usage2_end As String
        Private meps_usage3_start As String
        Private meps_usage3_end As String
        Private meps_usage_total As String
        Private medit_date As Date
        ...
        Public Property shift3() As Integer
            ...
            End Set
        End Property
        Public Property boot1() As Integer
            Get
                Return mBoot1
            End Get
            Set(ByVal value As Integer)
            ...
            End Set
        End Property
        Public Property boot2() As Integer
            Get
                Return mBoot2
            End Get
            Set(ByVal value As Integer)
            ...
            End Set
        End Property
        Public Property boot3() As Integer
            Get
                Return mBoot3
            End Get
            Set(ByVal value As Integer)
            ...
            End Set
        End Property
        Public Property eps_usage1_start() As String
            Get
                Return meps_usage1_start
            End Get
            Set(ByVal value As String)
                meps_usage1_start = value
            End Set
        End Property
        Public Property eps_usage1_end() As String
            Get
                Return meps_usage1_end
            End Get
            Set(ByVal value As String)
                meps_usage1_end = value
            End Set
        End Property
        Public Property eps_usage2_start() As String
            Get
                Return meps_usage2_start
            End Get
            Set(ByVal value As String)
                meps_usage2_start = value
            End Set
        End Property
        Public Property eps_usage2_end() As String
            Get
                Return meps_usage2_end
            End Get
            Set(ByVal value As String)
                meps_usage2_end = value
            End Set
        End Property
        Public Property eps_usage3_start() As String
            Get
                Return meps_usage3_start
            End Get
            Set(ByVal value As String)
                meps_usage3_start = value
            End Set
        End Property
        Public Property eps_usage3_end() As String
            Get
                Return meps_usage3_end
            End Get
            Set(ByVal value As String)
                meps_usage3_end = value
            End Set
        End Property
        Public Property eps_usage_total() As String
            Get
                Return meps_usage_total
            End Get
            Set(ByVal value As String)
                meps_usage_total = value
            End Set
        End Property
        ...
        Private Sub setbarcode()
            ...
            End If
        End Sub
        Private Sub setUsage()
            If mChannel_id <> "" And mTerimabarang_id <> "" Then
                Dim tblUsage As DataTable
                Dim parCriteria As OleDbParameter
                Dim parCriteria1 As OleDbParameter
                Dim totalUsage As Decimal
                Dim i As Integer
                ...
                Try
                    ...
                    parCriteria1 = New OleDbParameter("@channel_id", OleDbType.VarChar, 10)
                    parCriteria1.Value = mChannel_id
                    parCriteria.Value = String.Format(" AND terimabarang_id = '{0}' AND terimabarang_check = 1 ", mTerimabarang_id)
                    tblUsage = clsUtil.GetDataTable("as_TrnTerimabarangdetilused_select", Me.DSN, parCriteria1, parCriteria)
                    If tblUsage.Rows.Count > 0 Then
                        For i = 0 To tblUsage.Rows.Count - 1
                            totalUsage += clsUtil.IsDbNull(tblUsage.Rows(i)("terimabarangused_qty"), 0)
                        Next
                        Me.mUsage = totalUsage
                    End If

                Catch ex As Exception
                    MsgBox("error on retrieving transaksi_terimabarangused")
                Finally
                    parCriteria = Nothing
                    parCriteria1 = Nothing
                    tblUsage = Nothing
