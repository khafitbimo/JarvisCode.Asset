...
Public Class clsDatabaseConfig : Implements IDisposable
    ...
    Private _dsnTempForLinq As String = "User ID={0}; Password={1}; Data Source=""{2}""; Initial Catalog={3};"
...
#Region " Property "
    ...
    Public ReadOnly Property DSNForLinq() As String
        Get
            Return String.Format(Me._dsnTempForLinq, Me.UserName, Me.Password, Me.ServerName, Me.DatabaseName)
        End Get
    End Property
#End Region
