...
#End Region
    ...
    Public Sub DataFill(ByRef datatable As DataTable, ByVal procedure As String, ByVal criteria As String, ByVal dbConn As OleDb.OleDbConnection, _
                             ByVal dbTrans As OleDb.OleDbTransaction, Optional ByVal channel_id As String = "", Optional ByVal Top As Integer = 0)
