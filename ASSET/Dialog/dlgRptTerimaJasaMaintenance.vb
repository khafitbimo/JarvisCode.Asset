Public Class dlgRptTerimaJasaMaintenance
    ...
    Private Function GenerateReport() As Boolean
        ...
        If Me.mKet = "Internal" Then
            objReportViewer.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter() {parRptImageURL, _
                                                                                                          parRptChannelID, parRptChannel_namereport, parRptChannel_address, _
                                                                                                          parRptTerimaJasa_id, parRptDomain, parRptSumTotal, parRptSumDiscount, _
                                                                                                          parRptSumPPN, parRptSumPPH, parRptSumGrandTotal})
        Else
            objReportViewer.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter() {parRptImageURL, _
                                                                                                          parRptChannelID, parRptChannel_namereport, parRptChannel_address, _
                                                                                                          parRptTerimaJasa_id, parRptDomain})
        End If
    ...
    Private Sub GenerateDataDetail()
        ...
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaMaintenanceDetil(Me.DSN)
            With objDetil
