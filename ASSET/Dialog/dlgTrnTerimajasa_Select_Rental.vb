...
Public Class dlgTrnTerimajasa_Select_Rental
...
#Region " UI Layout & Format "
    ...
    Function CreateTblTrnTerimaJasa_List_RentalOrder() As DataTable
        ...
        tbl.Columns.Add(New DataColumn("order_foreignrate", GetType(System.Decimal)))
        ...
        tbl.Columns("order_foreignrate").DefaultValue = 0
        ...
        Return tbl
    End Function
    Private Function FormatDgvTrnTerimaJasa_Select_RentalOrder(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
...
#Region " User defined function "
    ...
    Private Function dlgTrnTerimajasa_Select_Rental_Load(ByVal channel_id As String) As Boolean
        ...
        Dim tbl_DetilSA As DataTable = CreateTblTrnTerimaJasa_List_RentalOrder()
        Dim criteria = ""
        ...
        'dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasa_Select_Rental", dbConnAsset)
        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasa_Select_Rental_1", dbConn)
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "dlgTrnTerimajasa_Select_Rental" & ": dlgTrnTerimajasa_Select_Rental_Load()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
...
#End Region
    ...
    Private Sub dlgTrnTerimajasa_Select_Rental_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Me.Cursor = Cursors.WaitCursor
        Me.FormatDgvTrnTerimaJasa_Select_RentalOrder(Me.DgvRentalOrder)
        ...
        Me.obj_Source.Items.Add("RENTAL")
        Me.obj_Source.SelectedItem = "RENTAL"
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Me.dlgTrnTerimajasa_Select_Rental_Load(Me.mChannel_id)
        Me.DgvRentalOrder.DataSource = Me.tbl_TrnTerimaJasa_Rental

    End Sub

    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Dim tblH As DataTable = CreateTblTrnTerimaJasa_List_RentalOrder()
        Dim row As DataRow
    ...
    Private Sub DgvRentalOrder_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvRentalOrder.CellClick
        ...
        For i = 0 To Me.DgvRentalOrder.Rows.Count - 1
            If i <> e.RowIndex Then
                Me.DgvRentalOrder.Rows(i).Cells("terimajasa_check").Value = False
            End If
        Next
    End Sub
