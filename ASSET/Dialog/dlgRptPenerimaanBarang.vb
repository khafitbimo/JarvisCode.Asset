Public Class dlgRptPenerimaanBarang
    ...
    Private Function GenerateReport() As Boolean
        ...
        Try
            objReportViewer.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter() {parRptImageURL, parRptChannelID, parRptChannel_namereport, parRptChannel_address, parRptTerimaBarang_ID, parRptDomain, parRptSumTotal, parRptSumDiscount, parRptSumPPN, parRptSumGrandTotal, parRptSumPPH}) ', parRptStrukturUnit})
    ...
    Private Function GenerateDataHeader() As ArrayList
        ...
        currency = Me.tbl_Print.Rows(0).Item("currency_id")
        ...
        For a As Integer = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            ...
            Total = Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_foreign") * Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_foreignrate") * Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_qty")

            If currency = 1 Then
                Total = Math.Round(Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_foreign") * Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_foreignrate") * Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_qty"))
            End If
        ...
        'For a As Integer = 0 To Me.tbl_PrintDetil.Rows.Count - 1
        '    SumPPN += Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_ppnforeign") * Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_foreignrate")
        'Next

        'For a As Integer = 0 To Me.tbl_PrintDetil.Rows.Count - 1
        '    SumPPH += Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_pphforeign") * Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_foreignrate")
        'Next
        ...
        'For a As Integer = 0 To Me.tbl_PrintDetil.Rows.Count - 1
        '    SumGrandTotal += Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_totalforeign") * Me.tbl_PrintDetil.Rows(a).Item("terimabarangdetil_foreignrate")
        'Next
        ...
        For i = 0 To Me.tbl_Print.Rows.Count - 1
            ...
            With objPrintHeader
                ...
                .employee_id_owner = StrConv(clsUtil.IsDbNull(Me.tbl_Print.Rows(0).Item("employee_name_owner").ToString, String.Empty), vbProperCase)
