...
Public Class dlgTrnTerimajasa_Select_Talent
...
#Region " UI Layout & Format "
    ...
    Function CreateTblTrnTerimaJasa_List_TalentOrder() As DataTable
        ...
        Return tbl
    End Function
    Private Function FormatDgvTrnTerimaJasa_Select_TalentOrder(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
...
#Region " User defined function "
    ...
    Private Function dlgTrnTerimajasa_Select_Talent_Load(ByVal channel_id As String) As Boolean
        ' Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.mDSN)
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.mDSN)
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        Dim tbl_DetilSA As DataTable = CreateTblTrnTerimaJasa_List_TalentOrder()
        Dim criteria = ""
        ...
        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasa_Select_Talent_1", dbConn)
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "dlgTrnTerimajasa_Select_Talent" & ": dlgTrnTerimajasa_Select_Talent_Load()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
...
#End Region
    ...
    Private Sub dlgTrnTerimajasa_Select_Talent_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Me.Cursor = Cursors.WaitCursor
        Me.FormatDgvTrnTerimaJasa_Select_TalentOrder(Me.DgvTalentOrder)
        ...
        Me.obj_Source.Items.Add("TALENT")
        Me.obj_Source.SelectedItem = "TALENT"
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Me.dlgTrnTerimajasa_Select_Talent_Load(Me.mChannel_id)
        Me.DgvTalentOrder.DataSource = Me.tbl_TrnTerimaJasa_Talent

    End Sub

    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Dim tblH As DataTable = CreateTblTrnTerimaJasa_List_TalentOrder()
        Dim row As DataRow
    ...
    Private Sub DgvTalentOrder_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTalentOrder.CellClick
        Dim i As Integer

        For i = 0 To Me.DgvTalentOrder.Rows.Count - 1
            If i <> e.RowIndex Then
                Me.DgvTalentOrder.Rows(i).Cells("terimajasa_check").Value = False
            End If
        Next
    End Sub
    ...
    Private Sub DgvTalentOrder_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles DgvTalentOrder.CellFormatting
