Public Class dlgRptTrnTerimaBarang
    ...
    Private Sub dlgRptTrnTerimaBarang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtFiller.DataFill(Me.tbl_Print, "as_TrnPenerimaanbarang_Select", criteria, channel_id, Top)
        dtFiller.DataFill(Me.tbl_PrintDetil, "as_TrnPenerimaanbarangdetil_Select ", criteria, channel_id, Top)

        GenerateReport()
        Me.rvTerimaBarang.RefreshReport()
    End Sub
    ...
    Private Function GenerateReport() As Boolean
        ...
        Me.SuspendLayout()
        Me.Controls.Remove(Me.rvTerimaBarang)

        Me.rvTerimaBarang = Nothing
        Me.rvTerimaBarang = objReportViewer
        Me.rvTerimaBarang.LocalReport.EnableExternalImages = True

        Me.Controls.Add(Me.rvTerimaBarang)
        Me.ResumeLayout()
        Me.rvTerimaBarang.Dock = DockStyle.Fill
    End Function
