Public Class dlgRptTerimaJasaEditing
    ...
    Private Sub dlgRptTerimaJasaEditing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dtFiller As clsDataFiller = New clsDataFiller(Me.DSN)
        Dim dtFiller2 As clsDataFiller = New clsDataFiller(Me.DSN)

        dtFiller2.DataFillAsset(Me.DSN, Me.tbl_Print, "as_TrnTerimajasa_Select", " AND " & criteria, Me.mChannel_id, 1)
        dtFiller2.DataFillAsset(Me.DSN, Me.tbl_PrintDetil, "as_TrnTerimajasadetil_Select", criteria)

        GenerateReport()
        Me.rvTerimaJasaEditing.RefreshReport()
    End Sub
    ...
    Private Function GenerateReport() As Boolean
        ...
        objReportViewer.Name = "rvTerimaJasaEditing"
        ...
        Me.SuspendLayout()
        Me.Controls.Remove(Me.rvTerimaJasaEditing)

        Me.rvTerimaJasaEditing = Nothing
        Me.rvTerimaJasaEditing = objReportViewer
        Me.rvTerimaJasaEditing.LocalReport.EnableExternalImages = True

        Me.Controls.Add(Me.rvTerimaJasaEditing)
        Me.ResumeLayout()
        Me.rvTerimaJasaEditing.Dock = DockStyle.Fill
    End Function

    Private Function GenerateDataHeader() As ArrayList
        Dim objPrintHeader As DataSource.clsRptTerimaJasaEditing
        Dim objDatalistHeader As ArrayList = New ArrayList()
        Dim i As Integer
        ...
        For a As Integer = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            Total = (Me.tbl_PrintDetil.Rows(a).Item("terimajasadetil_idrreal") / 8) * Me.tbl_PrintDetil.Rows(a).Item("terimajasadetil_qty_usage")
        ...
        For i = 0 To Me.tbl_Print.Rows.Count - 1
            ...
            With objPrintHeader
                ...
                .employee_id_owner = StrConv(clsUtil.IsDbNull(Me.tbl_Print.Rows(0).Item("employee_id_owner").ToString, String.Empty), VbStrConv.ProperCase)
    ...
    Private Sub GenerateDataDetail()
        ...
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaEditingDetil(Me.DSN)
            With objDetil
