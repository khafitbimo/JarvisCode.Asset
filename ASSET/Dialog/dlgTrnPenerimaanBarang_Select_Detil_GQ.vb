...
Public Class dlgTrnPenerimaanBarang_Select_Detil_GQ
    Private DSN As String
    Private clsTrnRequest As clsTrnRequest
    Private tbl_TrnRequestDetil As DataTable = Me.CreateViewTblTrnPenerimaanBarangSelectRequestDetil()
    Private tbl_MstTipeasset As DataTable = clsDataset.CreateTblMstTipeasset()
    Private request_id As String
    Private requestObjective As clsTrnRequest.Objective

#Region " Datasource "
    Private Function CreateViewTblTrnPenerimaanBarangSelectRequestDetil() As DataTable
        Dim tbl As DataTable = clsDataset.CreateViewTblTrnPenerimaanbarangSelectRequestDetil()
...
#Region " Constructor & Default Function"
    ...
    Sub New(ByVal dsn As String, ByVal request_id As String, _
                 ByVal requestObjective As clsTrnRequest.Objective)
...
#End Region
    ...
    Private Sub Retrieve()
        ...
        Dim Criteria As String = String.Format(" request_id = '{0}' AND requestdetil_qtyoutstanding > 0 ", Me.request_id)
