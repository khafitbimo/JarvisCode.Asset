Public Class dlgTrnTerimajasa_Select_General
...
#Region " User defined function "
    ...
    Private Function dlgTrnTerimajasa_Select_Rental_Load(ByVal channel_id As String) As Boolean
        ...
        'dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasa_Select_General", dbConnAsset)
        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasa_Select_General_1", dbConn)
...
#End Region
    ...
    Private Sub dlgTrnTerimajasa_Select_Rental_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.obj_Source.Items.Add("GENERAL")
        Me.obj_Source.SelectedItem = "GENERAL"
