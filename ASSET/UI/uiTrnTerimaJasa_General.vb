...
Public Class uiTrnTerimaJasa_General
    Private Const mUiName As String = "Transaksi Terima Jasa General Request"
    ...
    Private tbl_TravelDetilPerson As DataTable = CreateTblTrnOfficialTravelDetilPerson()
    Private tbl_TravelDetilOthers As DataTable = CreateTblOfficialtraveldetilitem()
    Private tbl_MstJenisKelamin As DataTable = CreateTblOfficialtravelJenisKelamin()
    Private tbl_MstObjective As DataTable = CreateTblOfficialtravelObjective()
...
#Region " Window Parameter "
    ...
    Private _STRUKTUR_UNIT As Decimal = 4310 '5559 '3130 '2610 '2610 '2360 '3501
...
#Region " Additional Overrides "
    ...
    Private Sub Isi_CurrencyBermasalah(ByVal terimajasa_id As String)
    ...
    Public Shared Function CreateTblTrnOfficialTravelDetilPerson() As DataTable
        Dim tbl As DataTable = New DataTable

        tbl.Columns.Clear()
        tbl.Columns.Add(New DataColumn("travel_id", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("travel_revnum", GetType(System.Int32)))
        tbl.Columns.Add(New DataColumn("traveldetil_line", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetil_typeperson", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_nikemployee", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_nameperson", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_gender", GetType(System.Int32)))
        tbl.Columns.Add(New DataColumn("traveldetil_kodejabatan", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_departuredt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetil_returndt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetil_days", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetil_dropoff", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_transportid", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_notes", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_budgetid", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetil_budgetdetilid", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("budgetdetil_desc", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_currencyid", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetil_prizeamountrate", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetil_prizeamount", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetil_prizeidr", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetil_isresponse", GetType(System.Int32)))
        tbl.Columns.Add(New DataColumn("traveldetil_responseid", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_responsedetilline", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetil_budgetdetilline", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetil_canceled", GetType(System.Boolean)))
        tbl.Columns.Add(New DataColumn("traveldetil_canceleddt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetil_canceledby", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_modifieddt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetil_modifiedby", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_approved", GetType(System.Boolean)))
        tbl.Columns.Add(New DataColumn("traveldetil_approveddt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetil_approvedby", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("position", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("number_jabatanid", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetil_ticketdep", GetType(System.Boolean)))
        tbl.Columns.Add(New DataColumn("traveldetil_ticketarr", GetType(System.Boolean)))
        tbl.Columns.Add(New DataColumn("traveldetil_refadj", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetil_refadjline", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetil_isvisa", GetType(System.Boolean)))
        tbl.Columns.Add(New DataColumn("statusadj", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("statusperdiems", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("employee_email", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("jabatan_desc", GetType(System.String)))

        '-------------------------------
        'Default Value: 
        tbl.Columns("travel_id").DefaultValue = ""
        tbl.Columns("travel_revnum").DefaultValue = 0
        tbl.Columns("traveldetil_line").DefaultValue = 0
        tbl.Columns("traveldetil_typeperson").DefaultValue = ""
        tbl.Columns("traveldetil_nikemployee").DefaultValue = ""
        tbl.Columns("traveldetil_nameperson").DefaultValue = ""
        tbl.Columns("traveldetil_gender").DefaultValue = 0
        tbl.Columns("traveldetil_kodejabatan").DefaultValue = ""
        tbl.Columns("traveldetil_departuredt").DefaultValue = Now()
        tbl.Columns("traveldetil_returndt").DefaultValue = Now()
        tbl.Columns("traveldetil_days").DefaultValue = 0
        tbl.Columns("traveldetil_dropoff").DefaultValue = ""
        tbl.Columns("traveldetil_transportid").DefaultValue = ""
        tbl.Columns("traveldetil_notes").DefaultValue = ""
        tbl.Columns("traveldetil_budgetid").DefaultValue = 0
        tbl.Columns("traveldetil_budgetdetilid").DefaultValue = 0
        tbl.Columns("budgetdetil_desc").DefaultValue = ""
        tbl.Columns("traveldetil_currencyid").DefaultValue = 0
        tbl.Columns("traveldetil_prizeamountrate").DefaultValue = 0
        tbl.Columns("traveldetil_prizeamount").DefaultValue = 0
        tbl.Columns("traveldetil_prizeidr").DefaultValue = 0
        tbl.Columns("traveldetil_isresponse").DefaultValue = 0
        tbl.Columns("traveldetil_responseid").DefaultValue = ""
        tbl.Columns("traveldetil_responsedetilline").DefaultValue = 0
        tbl.Columns("traveldetil_budgetdetilline").DefaultValue = 0
        tbl.Columns("traveldetil_canceled").DefaultValue = 0
        tbl.Columns("traveldetil_canceleddt").DefaultValue = Now()
        tbl.Columns("traveldetil_canceledby").DefaultValue = ""
        tbl.Columns("traveldetil_modifieddt").DefaultValue = Now()
        tbl.Columns("traveldetil_modifiedby").DefaultValue = ""
        tbl.Columns("traveldetil_approved").DefaultValue = 0
        tbl.Columns("traveldetil_approveddt").DefaultValue = Now()
        tbl.Columns("traveldetil_approvedby").DefaultValue = ""
        tbl.Columns("position").DefaultValue = ""
        tbl.Columns("number_jabatanid").DefaultValue = 0
        tbl.Columns("traveldetil_ticketdep").DefaultValue = 0
        tbl.Columns("traveldetil_ticketarr").DefaultValue = 0
        tbl.Columns("traveldetil_refadj").DefaultValue = ""
        tbl.Columns("traveldetil_refadjline").DefaultValue = 0
        tbl.Columns("traveldetil_isvisa").DefaultValue = 0
        tbl.Columns("statusadj").DefaultValue = ""
        tbl.Columns("statusperdiems").DefaultValue = ""
        tbl.Columns("employee_email").DefaultValue = ""
        tbl.Columns("jabatan_desc").DefaultValue = ""

        Return tbl
    End Function

    Public Shared Function CreateTblOfficialtraveldetilitem() As DataTable
        Dim tbl As DataTable = New DataTable

        tbl.Columns.Clear()
        tbl.Columns.Add(New DataColumn("travel_id", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("travel_revnum", GetType(System.Int32)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_line", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_name", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_objective", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_desc", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_qty", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_unit", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_days", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_person", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_rekanan", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("rekanan_name", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_budget", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_budgetdetil", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_currency", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_amountrate", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_amountforeign", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_amountidr", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_createdt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_createby", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_modifieddt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_modifiedby", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_canceled", GetType(System.Boolean)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_canceleddt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_canceledby", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_isresponse", GetType(System.Int32)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_responseid", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_responsedetilline", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_budgetdetilline", GetType(System.Int64)))
        tbl.Columns.Add(New DataColumn("budgetdetil_desc", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("ticket_type", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("ticket_ref_employee", GetType(System.Int32)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_totalidr", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_approved", GetType(System.Boolean)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_approveddt", GetType(System.DateTime)))
        tbl.Columns.Add(New DataColumn("traveldetilitem_approvedby", GetType(System.String)))    

        '-------------------------------
        'Default Value: 
        tbl.Columns("travel_id").DefaultValue = ""
        tbl.Columns("travel_revnum").DefaultValue = 0
        tbl.Columns("traveldetilitem_line").DefaultValue = 0
        tbl.Columns("traveldetilitem_name").DefaultValue = ""
        tbl.Columns("traveldetilitem_objective").DefaultValue = ""
        tbl.Columns("traveldetilitem_desc").DefaultValue = ""
        tbl.Columns("traveldetilitem_qty").DefaultValue = 0
        tbl.Columns("traveldetilitem_unit").DefaultValue = 0
        tbl.Columns("traveldetilitem_days").DefaultValue = 0
        tbl.Columns("traveldetilitem_person").DefaultValue = 0
        tbl.Columns("traveldetilitem_rekanan").DefaultValue = 0
        tbl.Columns("rekanan_name").DefaultValue = ""
        tbl.Columns("traveldetilitem_budget").DefaultValue = 0
        tbl.Columns("traveldetilitem_budgetdetil").DefaultValue = 0
        tbl.Columns("traveldetilitem_currency").DefaultValue = 0
        tbl.Columns("traveldetilitem_amountrate").DefaultValue = 0
        tbl.Columns("traveldetilitem_amountforeign").DefaultValue = 0
        tbl.Columns("traveldetilitem_amountidr").DefaultValue = 0
        tbl.Columns("traveldetilitem_createdt").DefaultValue = Now()
        tbl.Columns("traveldetilitem_createby").DefaultValue = ""
        tbl.Columns("traveldetilitem_modifieddt").DefaultValue = Now()
        tbl.Columns("traveldetilitem_modifiedby").DefaultValue = ""
        tbl.Columns("traveldetilitem_canceled").DefaultValue = 0
        tbl.Columns("traveldetilitem_canceleddt").DefaultValue = Now()
        tbl.Columns("traveldetilitem_canceledby").DefaultValue = ""
        tbl.Columns("traveldetilitem_isresponse").DefaultValue = 0
        tbl.Columns("traveldetilitem_responseid").DefaultValue = ""
        tbl.Columns("traveldetilitem_responsedetilline").DefaultValue = 0
        tbl.Columns("traveldetilitem_budgetdetilline").DefaultValue = 0
        tbl.Columns("budgetdetil_desc").DefaultValue = ""
        tbl.Columns("ticket_type").DefaultValue = ""
        tbl.Columns("ticket_ref_employee").DefaultValue = 0
        tbl.Columns("traveldetilitem_totalidr").DefaultValue = 0
        tbl.Columns("traveldetilitem_approved").DefaultValue = 0
        tbl.Columns("traveldetilitem_approveddt").DefaultValue = Now()
        tbl.Columns("traveldetilitem_approvedby").DefaultValue = ""

        Return tbl
    End Function

    Public Shared Function CreateTblOfficialtravelJenisKelamin() As DataTable
        Dim tbl As DataTable = New DataTable

        tbl.Columns.Clear()
        tbl.Columns.Add(New DataColumn("jeniskelamin_id", GetType(System.Int32)))
        tbl.Columns.Add(New DataColumn("jeniskelamin_desc", GetType(System.String)))

        tbl.Columns("jeniskelamin_id").DefaultValue = 0
        tbl.Columns("jeniskelamin_desc").DefaultValue = ""

        Return tbl
    End Function

    Public Shared Function CreateTblOfficialtravelObjective() As DataTable
        Dim tbl As DataTable = New DataTable

        tbl.Columns.Clear()
        tbl.Columns.Add(New DataColumn("objective_id", GetType(System.String)))
        tbl.Columns.Add(New DataColumn("objective_descr", GetType(System.String)))

        tbl.Columns("objective_id").DefaultValue = 0
        tbl.Columns("objective_descr").DefaultValue = ""
...
#Region " Layout & Init UI "
    ...
    Private Function FormatDgvTrnTravelPerson(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        'formating DgvTrnOrderdetil
        Dim cTravel_id As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_line As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_nikemployee As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_nameperson As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_gender As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        Dim cPosition As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cJabatan_desc As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_notes As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_departuredt As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_returndt As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_days As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_budgetid As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        Dim cTraveldetil_budgetdetilid As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_transportid As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_dropoff As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_ticketdep As System.Windows.Forms.DataGridViewCheckBoxColumn = New System.Windows.Forms.DataGridViewCheckBoxColumn
        Dim cTraveldetil_ticketarr As System.Windows.Forms.DataGridViewCheckBoxColumn = New System.Windows.Forms.DataGridViewCheckBoxColumn
        Dim cTraveldetil_currencyid As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        Dim cTraveldetil_prizeamountrate As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_prizeamount As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTraveldetil_prizeidr As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn

        cTravel_id.Name = "travel_id"
        cTravel_id.HeaderText = "ID"
        cTravel_id.DataPropertyName = "travel_id"
        cTravel_id.Width = 30
        cTravel_id.Visible = False
        cTravel_id.ReadOnly = True
        cTravel_id.Frozen = True

        cTraveldetil_line.Name = "traveldetil_line"
        cTraveldetil_line.HeaderText = "Line"
        cTraveldetil_line.DataPropertyName = "traveldetil_line"
        cTraveldetil_line.Width = 30
        cTraveldetil_line.Visible = True
        cTraveldetil_line.ReadOnly = True
        cTraveldetil_line.Frozen = True

        cTraveldetil_nikemployee.Name = "traveldetil_nikemployee"
        cTraveldetil_nikemployee.HeaderText = "NIK"
        cTraveldetil_nikemployee.DataPropertyName = "traveldetil_nikemployee"
        cTraveldetil_nikemployee.Width = 100
        cTraveldetil_nikemployee.Visible = True
        cTraveldetil_nikemployee.ReadOnly = True
        cTraveldetil_nikemployee.Frozen = True

        cTraveldetil_nameperson.Name = "traveldetil_nameperson"
        cTraveldetil_nameperson.HeaderText = "Name"
        cTraveldetil_nameperson.DataPropertyName = "traveldetil_nameperson"
        cTraveldetil_nameperson.Width = 130
        cTraveldetil_nameperson.Visible = True
        cTraveldetil_nameperson.ReadOnly = True
        cTraveldetil_nameperson.Frozen = True

        cTraveldetil_gender.Name = "traveldetil_gender"
        cTraveldetil_gender.HeaderText = "Gender"
        cTraveldetil_gender.DataPropertyName = "traveldetil_gender"
        cTraveldetil_gender.Width = 70
        cTraveldetil_gender.Visible = True
        cTraveldetil_gender.ReadOnly = False
        cTraveldetil_gender.DataSource = Me.tbl_MstJenisKelamin
        cTraveldetil_gender.ValueMember = "jeniskelamin_id"
        cTraveldetil_gender.DisplayMember = "jeniskelamin_descr"

        cPosition.Name = "position"
        ...
        cJabatan_desc.Name = "jabatan_desc"
        cJabatan_desc.HeaderText = "Jabatan"
        cJabatan_desc.DataPropertyName = "jabatan_desc"
        cJabatan_desc.Width = 120
        cJabatan_desc.Visible = True
        cJabatan_desc.ReadOnly = True

        cTraveldetil_notes.Name = "traveldetil_notes"
        cTraveldetil_notes.HeaderText = "Notes"
        cTraveldetil_notes.DataPropertyName = "traveldetil_notes"
        cTraveldetil_notes.Width = 150
        cTraveldetil_notes.Visible = True
        cTraveldetil_notes.ReadOnly = True

        cTraveldetil_departuredt.Name = "traveldetil_departuredt"
        cTraveldetil_departuredt.HeaderText = "Departure"
        cTraveldetil_departuredt.DataPropertyName = "traveldetil_departuredt"
        cTraveldetil_departuredt.Width = 120
        cTraveldetil_departuredt.Visible = True
        cTraveldetil_departuredt.ReadOnly = True

        cTraveldetil_returndt.Name = "traveldetil_returndt"
        cTraveldetil_returndt.HeaderText = "Arrival"
        cTraveldetil_returndt.DataPropertyName = "traveldetil_returndt"
        cTraveldetil_returndt.Width = 120
        cTraveldetil_returndt.Visible = True
        cTraveldetil_returndt.ReadOnly = True

        cTraveldetil_days.Name = "traveldetil_days"
        cTraveldetil_days.HeaderText = "Days"
        cTraveldetil_days.DataPropertyName = "traveldetil_days"
        cTraveldetil_days.Width = 120
        cTraveldetil_days.Visible = True
        cTraveldetil_days.ReadOnly = True

        cTraveldetil_budgetid.Name = "traveldetil_budgetid"
        cTraveldetil_budgetid.HeaderText = "Budget Header"
        cTraveldetil_budgetid.DataPropertyName = "traveldetil_budgetid"
        cTraveldetil_budgetid.Width = 130
        cTraveldetil_budgetid.Visible = True
        cTraveldetil_budgetid.ReadOnly = False
        cTraveldetil_budgetid.DataSource = Me.tbl_TrnBudget
        cTraveldetil_budgetid.ValueMember = "budget_id"
        cTraveldetil_budgetid.DisplayMember = "budget_nameshort"

        cTraveldetil_budgetdetilid.Name = "budgetdetil_desc"
        cTraveldetil_budgetdetilid.HeaderText = "Budget Detil"
        cTraveldetil_budgetdetilid.DataPropertyName = "budgetdetil_desc"
        cTraveldetil_budgetdetilid.Width = 130
        cTraveldetil_budgetdetilid.Visible = True
        cTraveldetil_budgetdetilid.ReadOnly = False
        'cTraveldetil_budgetdetilid.DataSource = Me.tbl_TrnBudgetDetil
        'cTraveldetil_budgetdetilid.ValueMember = "budgetdetil_id"
        'cTraveldetil_budgetdetilid.DisplayMember = "budgetdetil_desc"

        cTraveldetil_transportid.Name = "traveldetil_transportid"
        cTraveldetil_transportid.HeaderText = "Transportation"
        cTraveldetil_transportid.DataPropertyName = "traveldetil_transportid"
        cTraveldetil_transportid.Width = 120
        cTraveldetil_transportid.Visible = True
        cTraveldetil_transportid.ReadOnly = True

        cTraveldetil_dropoff.Name = "traveldetil_dropoff"
        cTraveldetil_dropoff.HeaderText = "Drop Off"
        cTraveldetil_dropoff.DataPropertyName = "traveldetil_dropoff"
        cTraveldetil_dropoff.Width = 120
        cTraveldetil_dropoff.Visible = True
        cTraveldetil_dropoff.ReadOnly = True

        cTraveldetil_ticketdep.Name = "traveldetil_ticketdep"
        cTraveldetil_ticketdep.HeaderText = "Ticket Departure"
        cTraveldetil_ticketdep.DataPropertyName = "traveldetil_ticketdep"
        cTraveldetil_ticketdep.Width = 120
        cTraveldetil_ticketdep.Visible = True
        cTraveldetil_ticketdep.ReadOnly = True

        cTraveldetil_ticketarr.Name = "traveldetil_ticketarr"
        cTraveldetil_ticketarr.HeaderText = "Ticket Arrival"
        cTraveldetil_ticketarr.DataPropertyName = "traveldetil_ticketarr"
        cTraveldetil_ticketarr.Width = 120
        cTraveldetil_ticketarr.Visible = True
        cTraveldetil_ticketarr.ReadOnly = True

        cTraveldetil_currencyid.Name = "traveldetil_currencyid"
        cTraveldetil_currencyid.HeaderText = "Curr."
        cTraveldetil_currencyid.DataPropertyName = "traveldetil_currencyid"
        cTraveldetil_currencyid.Width = 70
        cTraveldetil_currencyid.Visible = True
        cTraveldetil_currencyid.ReadOnly = True
        cTraveldetil_currencyid.DataSource = Me.tbl_MstCurrencyDetil
        cTraveldetil_currencyid.ValueMember = "currency_id"
        cTraveldetil_currencyid.DisplayMember = "currency_shortname"
        cTraveldetil_currencyid.DefaultCellStyle.BackColor = Color.Gainsboro

        cTraveldetil_prizeamountrate.Name = "traveldetil_prizeamountrate"
        cTraveldetil_prizeamountrate.HeaderText = "Rate"
        cTraveldetil_prizeamountrate.DataPropertyName = "traveldetil_prizeamountrate"
        cTraveldetil_prizeamountrate.DefaultCellStyle.Format = "#,##0.00"
        cTraveldetil_prizeamountrate.Width = 120
        cTraveldetil_prizeamountrate.Visible = True
        cTraveldetil_prizeamountrate.ReadOnly = True

        cTraveldetil_prizeamount.Name = "traveldetil_prizeamount"
        cTraveldetil_prizeamount.HeaderText = "Amount"
        cTraveldetil_prizeamount.DataPropertyName = "traveldetil_prizeamount"
        cTraveldetil_prizeamount.DefaultCellStyle.Format = "#,##0.00"
        cTraveldetil_prizeamount.Width = 120
        cTraveldetil_prizeamount.Visible = True
        cTraveldetil_prizeamount.ReadOnly = True

        cTraveldetil_prizeidr.Name = "traveldetil_prizeidr"
        cTraveldetil_prizeidr.HeaderText = "Amount IDR"
        cTraveldetil_prizeidr.DataPropertyName = "traveldetil_prizeidr"
        cTraveldetil_prizeidr.DefaultCellStyle.Format = "#,##0"
        cTraveldetil_prizeidr.Width = 120
        cTraveldetil_prizeidr.Visible = True
        cTraveldetil_prizeidr.ReadOnly = True
        ...
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() { _
            cTravel_id, _
            cTraveldetil_line, _
            cTraveldetil_nikemployee, _
            cTraveldetil_nameperson, _
            cTraveldetil_gender, _
            cPosition, _
            cJabatan_desc, _
            cTraveldetil_notes, _
            cTraveldetil_departuredt, _
            cTraveldetil_returndt, _
            cTraveldetil_days, _
            cTraveldetil_budgetid, _
            cTraveldetil_budgetdetilid, _
            cTraveldetil_transportid, _
            cTraveldetil_dropoff, _
            cTraveldetil_ticketdep, _
            cTraveldetil_ticketarr, _
            cTraveldetil_currencyid, _
            cTraveldetil_prizeamountrate, _
            cTraveldetil_prizeamount, _
            cTraveldetil_prizeidr
            })
        objDgv.AutoGenerateColumns = False
        objDgv.AllowUserToAddRows = False
        objDgv.AllowUserToOrderColumns = False
    ...
    Private Function FormatDgvTrnTravelOthers(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        'formating DgvTrnOrderdetil
        Dim ctraveldetilitem_line As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_name As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        Dim ctraveldetilitem_desc As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_objective As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        Dim ctraveldetilitem_qty As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_unit As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_days As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_budget As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        Dim ctraveldetilitem_budgetdetil As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_currency As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_amountforeign As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_amountrate As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_amountidr As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim ctraveldetilitem_totalidr As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn

        ctraveldetilitem_line.Name = "traveldetilitem_line"
        ctraveldetilitem_line.HeaderText = "Line"
        ctraveldetilitem_line.DataPropertyName = "traveldetilitem_line"
        ctraveldetilitem_line.Width = 30
        ctraveldetilitem_line.Visible = True
        ctraveldetilitem_line.ReadOnly = True
        ctraveldetilitem_line.Frozen = True

        ctraveldetilitem_name.Name = "traveldetilitem_name"
        ctraveldetilitem_name.HeaderText = "Item ID"
        ctraveldetilitem_name.DataPropertyName = "traveldetilitem_name"
        ctraveldetilitem_name.Width = 150
        ctraveldetilitem_name.Visible = True
        ctraveldetilitem_name.ReadOnly = True
        ctraveldetilitem_name.Frozen = True
        ctraveldetilitem_name.DataSource = Me.tbl_MstItem
        ctraveldetilitem_name.ValueMember = "item_id"
        ctraveldetilitem_name.DisplayMember = "item_name"

        ctraveldetilitem_desc.Name = "traveldetilitem_desc"
        ctraveldetilitem_desc.HeaderText = "Description"
        ctraveldetilitem_desc.DataPropertyName = "traveldetilitem_desc"
        ctraveldetilitem_desc.Width = 150
        ctraveldetilitem_desc.Visible = True
        ctraveldetilitem_desc.ReadOnly = True
        ctraveldetilitem_desc.Frozen = True

        ctraveldetilitem_objective.Name = "traveldetilitem_objective"
        ctraveldetilitem_objective.HeaderText = "Objective"
        ctraveldetilitem_objective.DataPropertyName = "traveldetilitem_objective"
        ctraveldetilitem_objective.Width = 120
        ctraveldetilitem_objective.Visible = True
        ctraveldetilitem_objective.ReadOnly = True
        ctraveldetilitem_objective.DataSource = Me.tbl_MstObjective
        ctraveldetilitem_objective.ValueMember = "objective_id"
        ctraveldetilitem_objective.DisplayMember = "objective_descr"

        ctraveldetilitem_qty.Name = "traveldetilitem_qty"
        ctraveldetilitem_qty.HeaderText = "Qty"
        ctraveldetilitem_qty.DataPropertyName = "traveldetilitem_qty"
        ctraveldetilitem_qty.Width = 150
        ctraveldetilitem_qty.Visible = True
        ctraveldetilitem_qty.ReadOnly = True

        ctraveldetilitem_unit.Name = "traveldetilitem_unit"
        ctraveldetilitem_unit.HeaderText = "Unit"
        ctraveldetilitem_unit.DataPropertyName = "traveldetilitem_unit"
        ctraveldetilitem_unit.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_unit.DefaultCellStyle.Format = "#,##0.00"
        ctraveldetilitem_unit.Width = 35
        ctraveldetilitem_unit.Visible = True
        ctraveldetilitem_unit.ReadOnly = True

        ctraveldetilitem_days.Name = "traveldetilitem_days"
        ctraveldetilitem_days.HeaderText = "Days"
        ctraveldetilitem_days.DataPropertyName = "traveldetilitem_days"
        ctraveldetilitem_days.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_days.Width = 35
        ctraveldetilitem_days.Visible = True
        ctraveldetilitem_days.ReadOnly = True

        ctraveldetilitem_budget.Name = "traveldetilitem_budget"
        ctraveldetilitem_budget.HeaderText = "Budget Header"
        ctraveldetilitem_budget.DataPropertyName = "traveldetilitem_budget"
        ctraveldetilitem_budget.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_budget.Width = 110
        ctraveldetilitem_budget.Visible = True
        ctraveldetilitem_budget.ReadOnly = True
        ctraveldetilitem_budget.DataSource = Me.tbl_TrnBudget
        ctraveldetilitem_budget.ValueMember = "budget_id"
        ctraveldetilitem_budget.DisplayMember = "budget_nameshort"

        ctraveldetilitem_budgetdetil.Name = "budgetdetil_desc"
        ctraveldetilitem_budgetdetil.HeaderText = "Budget Detil"
        ctraveldetilitem_budgetdetil.DataPropertyName = "budgetdetil_desc"
        ctraveldetilitem_budgetdetil.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_budgetdetil.Width = 110
        ctraveldetilitem_budgetdetil.Visible = True
        ctraveldetilitem_budgetdetil.ReadOnly = True
        'ctraveldetilitem_budgetdetil.DataSource = Me.tbl_TrnBudgetDetil
        'ctraveldetilitem_budgetdetil.ValueMember = "budgetdetil_id"
        'ctraveldetilitem_budgetdetil.DisplayMember = "budgetdetil_desc"

        ctraveldetilitem_currency.Name = "traveldetilitem_currency"
        ctraveldetilitem_currency.HeaderText = "Curr."
        ctraveldetilitem_currency.DataPropertyName = "traveldetilitem_currency"
        ctraveldetilitem_currency.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_currency.DefaultCellStyle.Format = "#,##0.00"
        ctraveldetilitem_currency.Width = 70
        ctraveldetilitem_currency.Visible = True
        ctraveldetilitem_currency.ReadOnly = True

        ctraveldetilitem_amountforeign.Name = "traveldetilitem_amountforeign"
        ctraveldetilitem_amountforeign.HeaderText = "Amount"
        ctraveldetilitem_amountforeign.DataPropertyName = "traveldetilitem_amountforeign"
        ctraveldetilitem_amountforeign.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_amountforeign.DefaultCellStyle.Format = "#,##0.00"
        ctraveldetilitem_amountforeign.Width = 120
        ctraveldetilitem_amountforeign.Visible = True
        ctraveldetilitem_amountforeign.ReadOnly = True

        ctraveldetilitem_amountrate.Name = "traveldetilitem_amountrate"
        ctraveldetilitem_amountrate.HeaderText = "Rate"
        ctraveldetilitem_amountrate.DataPropertyName = "traveldetilitem_amountrate"
        ctraveldetilitem_amountrate.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_amountrate.DefaultCellStyle.Format = "#,##0.00"
        ctraveldetilitem_amountrate.Width = 125
        ctraveldetilitem_amountrate.Visible = False
        ctraveldetilitem_amountrate.ReadOnly = False

        ctraveldetilitem_amountidr.Name = "traveldetilitem_amountidr"
        ctraveldetilitem_amountidr.HeaderText = "Amount IDR"
        ctraveldetilitem_amountidr.DataPropertyName = "traveldetilitem_amountidr"
        ctraveldetilitem_amountidr.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_amountidr.DefaultCellStyle.Format = "#,##0"
        ctraveldetilitem_amountidr.Width = 130
        ctraveldetilitem_amountidr.ReadOnly = True
        ctraveldetilitem_amountidr.Visible = True

        ctraveldetilitem_totalidr.Name = "traveldetilitem_totalidr"
        ctraveldetilitem_totalidr.HeaderText = "Total IDR"
        ctraveldetilitem_totalidr.DataPropertyName = "traveldetilitem_totalidr"
        ctraveldetilitem_totalidr.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        ctraveldetilitem_totalidr.DefaultCellStyle.Format = "#,##0"
        ctraveldetilitem_totalidr.Width = 130
        ctraveldetilitem_totalidr.Visible = True
        ctraveldetilitem_totalidr.ReadOnly = True


        objDgv.Columns.Clear()
        objDgv.Dock = DockStyle.Fill
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() { _
         ctraveldetilitem_line, _
         ctraveldetilitem_name, _
         ctraveldetilitem_desc, _
         ctraveldetilitem_objective, _
         ctraveldetilitem_qty, _
         ctraveldetilitem_unit, _
         ctraveldetilitem_days, _
         ctraveldetilitem_budget, _
         ctraveldetilitem_budgetdetil, _
         ctraveldetilitem_currency, _
         ctraveldetilitem_amountforeign, _
         ctraveldetilitem_amountrate, _
         ctraveldetilitem_amountidr, _
         ctraveldetilitem_totalidr})
        objDgv.AllowUserToAddRows = False
        objDgv.AllowUserToOrderColumns = False
        objDgv.AllowUserToDeleteRows = False
        objDgv.AutoGenerateColumns = False
    ...
    Private Function InitLayoutUI() As Boolean
        ...
        Me.FormatDgvTrnTravelPerson(Me.dgvTravelPerson)
        Me.FormatDgvTrnTravelOthers(Me.dgvTravelOthers)
...
#Region " User Defined Function "
    ...
    Private Function uiTrnTerimaJasa_Rental_NewData() As Boolean
        ...
        Me.tbl_TrnTerimajasa_Temp.Columns("terimajasa_type").DefaultValue = "GENERAL"
        ...
        Me.tbl_TrnTerimajasadetil.Columns("terimajasadetil_type").DefaultValue = "GENERAL"
        ...
        ' ''Me.tbl_TrnTerimajasaUsed.Columns("terimajasadetil_type").DefaultValue = "GENERAL"
    ...
    Private Function uiTrnTerimaJasa_Rental_Retrieve() As Boolean
        ...
        criteria &= " AND terimajasa_type = 'GENERAL'"
    ...
    Private Function uiTrnTerimaJasa_Rental_OpenRow(ByVal rowIndex As Integer) As Boolean
        ...
        Try
            ...
            Me.uiTrnTerimajasa_Rental_GetTravelData(channel_id, obj_Order_id.Text, dbConn)
    ...
    Private Function uiTrnTerimaJasa_Rental_OpenRowMaster(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        ...
        Try
            ...
            If Me.tbl_TrnTerimajasa_Temp.Rows.Count > 0 Then
                'Dim dbConnStart As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSNFrm)
                'dbConnStart.Open()
                'clsApplicationRole.SetAppRole(dbConnStart, cookie2)
    ...
    Private Function uiTrnRentalOrder2_OpenRowDetil(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        ...
        dbCmd = New OleDb.OleDbCommand("as_TrnOrderDetilBpjGeneral_Select", dbConn)
        dbCmd.Parameters.Add("@Criteria", Data.OleDb.OleDbType.VarChar)
    ...
    Private Function uiTrnTerimajasa_Rental_GetTravelData(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter

        dbCmd = New OleDb.OleDbCommand("act_TrnJurnalResponseTravelRV_Select2", dbConn)
        dbCmd.Parameters.Add("@channel_id", Data.OleDb.OleDbType.VarChar)
        dbCmd.Parameters("@channel_id").Value = channel_id
        ...
        Try
            While myReader.Read()
                Me.txtIDTravel.Text = myReader.GetString(0)
                Me.txtDepartureFr.Text = myReader.GetString(1)
                Me.txtDestinationTo.Text = myReader.GetString(2)
            End While

            'Me.txtIDTravel.Text = dbCmd.ExecuteScalar()

            Try
                Me.tbl_TravelDetilPerson.Clear()
                Me.dgvTravelPerson.DataSource = Nothing

                dbCmd = New OleDb.OleDbCommand("ms_TrnOfficialTravelDetil_Select", dbConn)
                dbCmd.Parameters.Add("@Criteria", Data.OleDb.OleDbType.VarChar)
                dbCmd.Parameters("@Criteria").Value = String.Format("travel_id = '{0}'", Me.txtIDTravel.Text)
                dbCmd.CommandType = CommandType.StoredProcedure
                dbCmd.CommandTimeout = 0
                dbDA = New OleDb.OleDbDataAdapter(dbCmd)
                dbDA.Fill(Me.tbl_TravelDetilPerson)

                Me.dgvTravelPerson.DataSource = Me.tbl_TravelDetilPerson
            Catch ex As Exception

            End Try

            Try
                Me.tbl_TravelDetilOthers.Clear()
                Me.dgvTravelOthers.DataSource = Nothing

                dbCmd = New OleDb.OleDbCommand("ms_TrnOfficialtraveldetilitem_Select", dbConn)
                dbCmd.Parameters.Add("@Criteria", Data.OleDb.OleDbType.VarChar)
                dbCmd.Parameters("@Criteria").Value = String.Format("travel_id = '{0}'", Me.txtIDTravel.Text)
                dbCmd.CommandType = CommandType.StoredProcedure
                dbCmd.CommandTimeout = 0
                dbDA = New OleDb.OleDbDataAdapter(dbCmd)
                dbDA.Fill(Me.tbl_TravelDetilOthers)

                Me.dgvTravelOthers.DataSource = Me.tbl_TravelDetilOthers
            Catch ex As Exception
...
#End Region
    ...
    Public Sub Form_Load(ByVal sender As Object)
        ...
        If Me._USERTYPE = "bma" Then
            ...
            Me.pnlclose4.Visible = False
            Me.pnlclose5.Visible = False
        ...
        Else
            ...
            Me.pnlclose4.Visible = True
            Me.pnlclose4.Dock = DockStyle.Fill
            Me.pnlclose5.Visible = True
            Me.pnlclose5.Dock = DockStyle.Fill
...
#Region " Untuk BackgroundWorker"
    ...
    Private Sub uiTrnTerimajasa_CollectionData_with_BackgroundWorker(ByVal worker As BackgroundWorker)
        ...
        Me.label_thread = "Gender"
        worker.ReportProgress(90)
        Me.DataFill(Me.tbl_MstJenisKelamin, "ms_MstJenisKelamin_Select", " ")
        Me.tbl_MstJenisKelamin.DefaultView.Sort = "jeniskelamin_descr"

        Me.label_thread = "Objective"
        worker.ReportProgress(92)
        Me.DataFill(Me.tbl_MstObjective, "ms_MstObjective_Select", " ")
        Me.tbl_MstObjective.DefaultView.Sort = "objective_descr"
    ...
    Private Sub btn_order_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_order.Click
        ...
        Try
            ...
            If Me.DgvTrnTerimajasadetil.Rows.Count = 0 Then
                Dim dlg As dlgTrnTerimajasa_Select_General = New dlgTrnTerimajasa_Select_General(Me.DSNFrm, Me.obj_Rekanan_id.SelectedValue, Me.tbl_MstRekanan.Copy, Me._STRUKTUR_UNIT)

                Dim retObj As Object
                Dim retData As Collection
                Dim tblH As DataTable

                retObj = dlg.OpenDialog(Me, Me.obj_Channel_id.Text, "General")
    ...
    Private Sub DgvTrnTerimajasadetil_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnTerimajasadetil.CellClick
        Select Case e.ColumnIndex
            Case Me.DgvTrnTerimajasadetil.Columns("select_days").Index
                ...
                Dim retObj As Object
                Dim retData As Collection
                Dim ListDaysOrder As New dlgTrnTerimaJasaUsed_General(Me.DSNFrm, Me._CHANNEL, Me.obj_Terimajasa_id.Text, Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("orderdetil_line").Value, Me.obj_Terimajasa_status.SelectedItem, _
...
#End Region
    ...
    Private Sub btn_BuiltJurnal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_BuiltJurnal.Click
        ...
        If isOk = True Then
            ...
            row.Item("strukturunit_id") = Me.tbl_TrnTerimajasa_Temp.Rows(0).Item("strukturunit_id")
...
ulang2:
    ...
    Private Sub Btn_Add_Click(sender As Object, e As EventArgs) Handles Btn_Add.Click
        Dim dlg As dlgTrnTerimaJasaDetil_Select_General = New dlgTrnTerimaJasaDetil_Select_General()
        ...
        If retObj IsNot Nothing Then
            ...
            For row_index = 0 To tblDetil.Rows.Count - 1
                ...
                row.Item("terimajasadetil_disc") = tblDetil.Rows(row_index).Item("orderdetil_discount") 'Math.Round(tblDetil.Rows(row_index).Item("orderdetil_discount") / (tblDetil.Rows(row_index).Item("orderdetil_qty") * tblDetil.Rows(row_index).Item("orderdetil_days")), 2, MidpointRounding.AwayFromZero)
                ...
                dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasadetilUsed_Select_General", dbConn)
    ...
    Private Sub btn_budget_Search_Click(sender As Object, e As EventArgs) Handles btn_budget_Search.Click
