...
Public Class uiTrnTerimaJasa_Rental_Wardrobe
    ...
    Private GQLine As New Specialized.ListDictionary
...
#Region " Window Parameter "
    ...
    Private _STRUKTUR_UNIT As Decimal = 5556 '4310 '5555 '3130 '2610 '2610 '2360 '3501
...
#Region " Additional Overrides "
    ...
    Private Sub uiTrnTerimaJasa_Rental_AppUser(ByVal status As String)
        ...
        Try
            ...
            Dim cmd As New OleDb.OleDbCommand("as_TrnTerimaJasa_UserApproved", dbConnAsset)
            cmd.CommandType = CommandType.StoredProcedure

            cmd.Parameters.Add("@terimajasa_id", System.Data.OleDb.OleDbType.VarWChar, 24).Value = Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value
            cmd.Parameters.Add("@user_applogin", System.Data.OleDb.OleDbType.VarWChar, 32).Value = Me.UserName
            cmd.Parameters.Add("@channel_id", System.Data.OleDb.OleDbType.VarWChar, 20).Value = Me.DgvTrnTerimajasa.Item("channel_id", DgvTrnTerimajasa.CurrentRow.Index).Value
            cmd.Parameters.Add("@status", System.Data.OleDb.OleDbType.VarWChar, 20).Value = status
            cmd.ExecuteNonQuery()
            cmd.Dispose()
    ...
    Private Sub uiTrnTerimaJasa_Rental_BuiltJurnal()
        ...
        If Me.tbl_TrnTerimajasadetil.Rows.Count > 0 Then
            ...
            Me.DataFill(tbl_debetTemp, "ms_MstAcc_SelectBySource", String.Format("B.source_id = 'BPJ-ListGQ' AND B.dk = 'K' WHERE B.source_id = 'BPJ-ListGQ' AND B.dk = 'K'"))
            ...
            If tbl_TrnTerimajasadetil.Rows.Count > 0 Then
                ...
                Me.tbl_TrnJurnal.Rows(0).Item("jurnal_source") = "BPJ-ListGQ"
...
#Region " Layout & Init UI "
    ...
    Private Function FormatDgvTrnTerimajasadetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        cTerimajasadetil_foreign.ReadOnly = False
        ...
        cTerimajasadetil_pphpersen.ReadOnly = False
        ...
        cTerimajasadetil_ppnpersen.ReadOnly = False
        ...
        cTerimajasadetil_disc.ReadOnly = False
    ...
    Private Function BindingStart() As Boolean
        ...
        Me.obj_Terimajasa_status.DataBindings.Add(New Binding("Text", Me.tbl_TrnTerimajasa_Temp, "terimajasa_status"))
        Me.obj_Terimajasa_statusrealization.DataBindings.Add(New Binding("Text", Me.tbl_TrnTerimajasa_Temp, "terimajasa_statusrealization"))
...
#Region " User Defined Function "
    ...
    Private Function uiTrnTerimaJasa_Rental_Retrieve() As Boolean
        ...
        criteria &= " AND terimajasa_type = 'RENTAL' and strukturunit_id = " & Me._STRUKTUR_UNIT
    ...
    Private Function uiTrnTerimaJasa_Rental_Save() As FormSaveResult
        'save data
    ...
    Private Function uiTrnTerimaJasa_Rental_FormChanges() As Boolean
        Dim tbltest As DataTable = Me.tbl_TrnTerimajasa_Temp.GetChanges()

        Dim tbl_TrnTerimajasa_Temp_Changes As DataTable
        Dim tbl_TrnTerimajasadetil_Changes As DataTable
        Dim tbl_TrnJurnal_Changes As DataTable
        Dim tbl_TrnJurnalDetilDebet_Changes As DataTable
        Dim tbl_TrnJurnalDetilKredit_Changes As DataTable
        ...
        Me.BindingContext(Me.tbl_TrnJurnaldetil_debet).EndCurrentEdit()
        tbl_TrnJurnalDetilDebet_Changes = Me.tbl_TrnJurnaldetil_debet.GetChanges()

        Me.BindingContext(Me.tbl_TrnJurnaldetil_kredit).EndCurrentEdit()
        tbl_TrnJurnalDetilKredit_Changes = Me.tbl_TrnJurnaldetil_kredit.GetChanges()
        ...
        Try
            ...
            If tbl_TrnJurnalDetilDebet_Changes IsNot Nothing Then
                Throw New Exception
            End If

            If tbl_TrnJurnalDetilKredit_Changes IsNot Nothing Then
                Throw New Exception
            End If
        Catch ex As Exception
            ...
            If res = MsgBoxResult.Ok Then
                ...
                If Me.uiTrnTerimaJasa_Rental_Save() = FormSaveResult.SaveError Then
                    Return True
                End If
...
#End Region
    ...
    Private Sub btn_order_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_order.Click
        If Me.DgvTrnTerimajasadetil.Rows.Count = 0 Then
            ...
            Dim dlg As dlgTrnPenerimaanBarang_Select_Header_GQ = New dlgTrnPenerimaanBarang_Select_Header_GQ(Me.DSNFrm,
                                                                        Me._CHANNEL, Me._STRUKTUR_UNIT, clsTrnRequest.Objective.Rental)
            ...
            If dlg.ShowDialog() = DialogResult.OK Then
                ...
                tempRow.Item("terimajasa_foreignrate") = 1

                Me.obj_Budget_id.SelectedValue = clsUtil.IsDbNull(rowResult.Item("budget_id"), 0)
                Me.obj_Order_id.Text = clsUtil.IsDbNull(rowResult.Item("request_id"), 0)
                Me.obj_Terimajasa_notes.Text = clsUtil.IsDbNull(rowResult.Item("request_descr"), String.Empty)
            End If
    ...
    Private Sub Btn_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Add.Click
        If Me.uiTrnTerimaJasa_Rental_FormChanges() Then
            Exit Sub
        End If

        Dim GQLines As String = ""
        For Each rows As DataRow In Me.tbl_TrnTerimajasadetil.Rows
            If GQLines = "" Then
                GQLines = rows.Item("orderdetil_line").ToString
            Else
                GQLines = GQLines + "," + rows.Item("orderdetil_line").ToString
            End If
        Next


        Dim dlg As New dlgTrnPenerimaanBarang_Select_Detil_GQ_Jasa(Me.DSNFrm, Me.obj_Order_id.Text, GQLines)

        If dlg.ShowDialog() = DialogResult.OK Then
            Dim rowSelected As DataRow() = CType(dlg.DgvTrnRequest.DataSource, DataTable).Select("col_pilih = 'True'")
            Dim newRow, newRowUsed As DataRow
            Dim tblDetilUsed As New DataTable()
            Dim rv As New clsTrnPenerimaanBarang()
            Dim usedLine As Integer = 0

            For Each row As DataRow In rowSelected
                newRow = Me.tbl_TrnTerimajasadetil.NewRow()

                newRow.Item("terimajasadetil_desc") = row.Item("requestdetil_descr")
                newRow.Item("terimajasadetil_date") = Date.Now
                newRow.Item("terimajasadetil_qty") = row.Item("qty")
                newRow.Item("terimajasadetil_qty_day_eps") = 0
                newRow.Item("terimajasadetil_qty_usage") = 0
                newRow.Item("order_id") = row.Item("request_id")
                newRow.Item("orderdetil_line") = row.Item("requestdetil_line")
                newRow.Item("item_id") = row.Item("item_id")
                newRow.Item("kategoriitem_id") = row.Item("category_id")
                newRow.Item("brand_id") = 0
                newRow.Item("budget_id") = row.Item("budget_id")
                newRow.Item("budgetdetil_id") = row.Item("budgetdetil_id")
                newRow.Item("acc_id") = row.Item("acc_id")
                newRow.Item("type_pajak") = 1
                newRow.Item("kategori_pajak") = 0
                newRow.Item("terimajasadetil_foreign") = 0
                newRow.Item("currency_id") = 1
                newRow.Item("terimajasadetil_foreignrate") = 1
                newRow.Item("terimajasadetil_idrreal") = 0
                newRow.Item("terimajasadetil_pphpersen") = 0
                newRow.Item("terimajasadetil_ppnpersen") = 0
                newRow.Item("terimajasadetil_disc") = 0
                newRow.Item("terimajasadetil_pphforeign") = 0
                newRow.Item("terimajasadetil_pphidrreal") = 0
                newRow.Item("terimajasadetil_ppnforeign") = 0
                newRow.Item("terimajasadetil_ppnidrreal") = 0
                newRow.Item("terimajasadetil_totalforeign") = 0
                newRow.Item("terimajasadetil_totalidrreal") = 0

                Me.tbl_TrnTerimajasadetil.Rows.Add(newRow)

                '====================================================================================================
                If tblDetilUsed IsNot Nothing Then
                    tblDetilUsed.Clear()
                End If

                rv.RetrieveDetilUsedRentalWardrobe(tblDetilUsed,
                                                   row.Item("request_id"), row.Item("requestdetil_line"),
                                                   Me.DSNFrm)

                usedLine = 0
                For Each rowUsed As DataRow In tblDetilUsed.Rows
                    newRowUsed = Me.tbl_TrnTerimajasaUsed.NewRow()

                    usedLine += 10
                    newRowUsed.Item("channel_id") = Me._CHANNEL
                    newRowUsed.Item("terimajasa_line") = newRow.Item("terimajasadetil_line")
                    newRowUsed.Item("terimajasa_lineday") = usedLine
                    newRowUsed.Item("order_id") = row.Item("request_id")
                    newRowUsed.Item("orderdetil_line") = row.Item("requestdetil_line")
                    newRowUsed.Item("orderdetiluse_line") = 0
                    newRowUsed.Item("terimajasa_date") = rowUsed.Item("requestdetiluse_date")
                    newRowUsed.Item("terimajasa_detilused_note") = ""
                    newRowUsed.Item("terimajasa_check") = 0
                    newRowUsed.Item("terimajasaused_qty") = rowUsed.Item("requestdetil_qty")
                    newRowUsed.Item("terimajasaused_qty_idle") = 0
                    newRowUsed.Item("terimajasaused_usagestart") = CDate(rowUsed.Item("request_useddt")).ToString("HH:mm")
                    newRowUsed.Item("terimajasaused_usgaeend") = CDate(rowUsed.Item("request_useddt2")).ToString("HH:mm")
                    newRowUsed.Item("terimajasaused_status") = "Fair"

                    Me.tbl_TrnTerimajasaUsed.Rows.Add(newRowUsed)
                Next
                '=====================================================================================================
            Next
            ...
            'retObj = dlg.OpenDialog(Me, Me.obj_Channel_id.Text, Me.DSNFrm, Me.DSNAsset, Me.obj_Order_id.Text, order_line)
    ...
    Private Sub DgvTrnTerimajasadetil_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnTerimajasadetil.CellClick
        Select Case e.ColumnIndex
            Case Me.DgvTrnTerimajasadetil.Columns("select_days").Index
                ...
                Dim retObj As Object
                Dim retData As Collection
                Dim ListDaysOrder As New dlgTrnTerimaJasaUsed_Rental_Wardrobe(Me.DSNFrm, Me._CHANNEL, Me.obj_Terimajasa_id.Text, Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("orderdetil_line").Value, Me.obj_Terimajasa_status.SelectedItem, _
                        ...
                        For j = 0 To Me.tbl_TrnTerimajasaUsed.Rows.Count - 1
                            If tbl_TrnTerimajasaDetilUsed_temps.DefaultView.Item(i).Item("order_id") = Me.tbl_TrnTerimajasaUsed.Rows(j).Item("order_id") And _
                                tbl_TrnTerimajasaDetilUsed_temps.DefaultView.Item(i).Item("orderdetil_line") = Me.tbl_TrnTerimajasaUsed.Rows(j).Item("orderdetil_line") And _
                                    tbl_TrnTerimajasaDetilUsed_temps.DefaultView.Item(i).Item("terimajasa_date") = Me.tbl_TrnTerimajasaUsed.Rows(j).Item("terimajasa_date") Then
    ...
    End Sub
    ' Rumus-----------------------------------------------------------------------------------------------------------------------
    Private Function calTaxForeign(ByVal foreign As Decimal, ByVal discount As Decimal, ByVal percent As Decimal) As Decimal
        Dim result As Decimal

        result = (foreign - discount) * (percent / 100)

        Return result
    End Function

    Private Function calTaxIdr(ByVal taxForeign As Decimal, ByVal rate As Decimal) As Decimal
        Dim result As Decimal

        result = taxForeign * rate

        Return result
    End Function

    Private Function calTotalForeign(ByVal foreign As Decimal, ByVal discount As Decimal,
                                     ByVal ppnForeign As Decimal, ByVal pphForeign As Decimal, ByVal qty As Decimal) As Decimal
        Dim result As Decimal

        result = (foreign - discount - pphForeign + ppnForeign) * qty

        Return result
    End Function

    Private Function calTotalIdr(ByVal totalForeign As Decimal, rate As Decimal) As Decimal
        Dim result As Decimal

        result = totalForeign * rate

        Return result
    End Function
    ' -----------------------------------------------------------------------------------------------------------------------
    Private Sub DgvTrnTerimajasadetil_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles DgvTrnTerimajasadetil.CellValueChanged
        If Me.DgvTrnTerimajasadetil.Columns(e.ColumnIndex).Name = "terimajasadetil_foreign" OrElse
            Me.DgvTrnTerimajasadetil.Columns(e.ColumnIndex).Name = "terimajasadetil_pphpersen" OrElse
            Me.DgvTrnTerimajasadetil.Columns(e.ColumnIndex).Name = "terimajasadetil_ppnpersen" OrElse
            Me.DgvTrnTerimajasadetil.Columns(e.ColumnIndex).Name = "terimajasadetil_disc" Then

            Dim currentRow As DataGridViewRow = Me.DgvTrnTerimajasadetil.CurrentRow
            Dim terimajasadetil_foreign As Decimal = clsUtil.IsDbNull(currentRow.Cells("terimajasadetil_foreign").Value, 0)
            Dim terimajasadetil_disc As Decimal = clsUtil.IsDbNull(currentRow.Cells("terimajasadetil_disc").Value, 0)
            Dim terimajasadetil_pphpersen As Decimal = clsUtil.IsDbNull(currentRow.Cells("terimajasadetil_pphpersen").Value, 0)
            Dim terimajasadetil_ppnpersen As Decimal = clsUtil.IsDbNull(currentRow.Cells("terimajasadetil_ppnpersen").Value, 0)
            Dim terimajasadetil_foreignrate As Decimal = clsUtil.IsDbNull(currentRow.Cells("terimajasadetil_foreignrate").Value, 0)
            Dim terimajasadetil_qty As Decimal = clsUtil.IsDbNull(currentRow.Cells("terimajasadetil_qty_usage").Value, 0)
            Dim terimajasadetil_idrreal As Decimal
            ...
            Dim terimajasadetil_totalforeign As Decimal
            Dim terimajasadetil_totalidrreal As Decimal

            terimajasadetil_idrreal = terimajasadetil_foreign * terimajasadetil_foreignrate
            terimajasadetil_ppnforeign = Me.calTaxForeign(terimajasadetil_foreign, terimajasadetil_disc, terimajasadetil_ppnpersen)
            terimajasadetil_ppnidrreal = Me.calTaxIdr(terimajasadetil_ppnforeign, terimajasadetil_foreignrate)
            terimajasadetil_pphforeign = Me.calTaxForeign(terimajasadetil_foreign, terimajasadetil_disc, terimajasadetil_pphpersen)
            terimajasadetil_pphidrreal = Me.calTaxIdr(terimajasadetil_pphforeign, terimajasadetil_foreignrate)

            terimajasadetil_totalforeign = Me.calTotalForeign(terimajasadetil_foreign, terimajasadetil_disc,
                                                               terimajasadetil_ppnforeign, terimajasadetil_pphforeign, terimajasadetil_qty)
            terimajasadetil_totalidrreal = Me.calTotalIdr(terimajasadetil_totalforeign, terimajasadetil_foreignrate)

            currentRow.Cells("terimajasadetil_idrreal").Value = terimajasadetil_idrreal
            currentRow.Cells("terimajasadetil_ppnforeign").Value = terimajasadetil_ppnforeign
            currentRow.Cells("terimajasadetil_ppnidrreal").Value = terimajasadetil_ppnidrreal
            currentRow.Cells("terimajasadetil_pphforeign").Value = terimajasadetil_pphforeign
            currentRow.Cells("terimajasadetil_pphidrreal").Value = terimajasadetil_pphidrreal
            currentRow.Cells("terimajasadetil_totalforeign").Value = terimajasadetil_totalforeign
            currentRow.Cells("terimajasadetil_totalidrreal").Value = terimajasadetil_totalidrreal
        End If
    End Sub
