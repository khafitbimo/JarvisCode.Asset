...
' Created Date: 6/10/2008 4:42:45 PM
' 
...
#Region " User Defined Function "
    ...
    Private Function uiTrnDepresiasi_Retrieve() As Boolean
        ...
        Try
            Me.DataFill(Me.tbl_TrnDepresiasi, "as_TrnDepresiasi_Select", criteria, Me.cboSearchChannel.SelectedValue)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
...
#Region " Individual Defined Function "
    Private Sub saveawal()
        ...
        Try
            ...
            dbCmdInsert = New OleDb.OleDbCommand("as_TrnDepresiasi_Insert", dbConn)
            dbCmdInsert.CommandType = CommandType.StoredProcedure
            dbCmdInsert.Parameters.Add("@channel_id", System.Data.OleDb.OleDbType.VarWChar, 10).Value = Me.cboSearchChannel.SelectedValue
...
#End Region
    ...
    Private Sub uiTrnDepresiasi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '    Dim dummyparameter As String = "CHANNEL_ID=TTV;CHANNEL_CANBE_CHANGED=1;CHANNEL_CANBE_BROWSED=1;"
        ...
        'Me.DgvTrnDepresiasidetil.DataBindings.Clear()
        'Me.DgvTrnDepresiasidetil.DataBindings.Add(New Binding("ReadOnly", Me.obj_Lock, "Checked", True))
        'Me.DgvTrnDepresiasidetil.ReadOnly = True
        databulan = 0
        datatahun = 0
    ...
    Private Sub Load_Rekapitulasi_Detil()
        ...
        Try
            Me.DataFill(tbl_rekapitulasi_detil, "as_trnDepresiasi_Select", criteria, Me._CHANNEL)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        tbl_temps_now.Clear()
        Try
            Me.DataFill(tbl_temps_before, "as_TrnDepresiasi_Select", criteria_before, Me.cboSearchChannel.SelectedValue)
            Me.DataFill(tbl_temps_now, "as_TrnDepresiasi_Select", criteria_now, Me.cboSearchChannel.SelectedValue)
            Me.DataFill(tbl_temps_mstAsset, "as_MstAssetFinance_Select", criteria_mstAsset, Me.cboSearchChannel.SelectedValue)
