Public Class dlgRptTerimaJasaEditing
    ...
    Private Sub dlgRptTerimaJasaEditing_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtFiller2.DataFillAsset(Me.AssetDSN, Me.tbl_Print, "as_TrnTerimajasa_Select", " AND " & criteria, Me.mChannel_id, 1)
        dtFiller2.DataFillAsset(Me.AssetDSN, Me.tbl_PrintDetil, "as_TrnTerimajasadetil_Select", criteria)
    ...
    Private Sub GenerateDataDetail()
        ...
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaEditingDetil(Me.DSN, Me.AssetDSN)
            With objDetil
