...
#Region " Constructor & Default Function"
    ...
    Public Sub New(ByVal dsn As String, ByVal asset_dsn As String, ByVal rekanan_id As Decimal, _
...
#Region " User defined function "
    ...
    Private Function dlgTrnTerimajasa_Select_Talent_Load(ByVal channel_id As String) As Boolean
        ...
        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasa_Select_Talent", dbConnAsset)
