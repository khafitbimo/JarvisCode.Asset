...
Public Class dlgTrnTerimaJasaDetil_Select_Maintenance
...
#Region " UI Layout & Format "
    ...
    Function CreateTblTrnTerimaJasa_List_MaintenanceOrder() As DataTable
        ...
        tbl.Columns.Add(New DataColumn("mo_outstanding", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("mo_realisasi", GetType(System.Decimal)))
        ...
        tbl.Columns("mo_outstanding").DefaultValue = 0
        tbl.Columns("mo_realisasi").DefaultValue = 0
    ...
    Private Function FormatDgvTrnOrderdetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        Dim cMo_outstanding As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cMo_realisasi As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        ...
        cMo_outstanding.Name = "mo_outstanding"
        cMo_outstanding.HeaderText = "Qty Outstanding"
        cMo_outstanding.DataPropertyName = "mo_outstanding"
        cMo_outstanding.Width = 120
        cMo_outstanding.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        cMo_outstanding.Visible = True
        cMo_outstanding.ReadOnly = True
        cMo_outstanding.DefaultCellStyle.Format = "#,##0"

        cMo_realisasi.Name = "mo_realisasi"
        cMo_realisasi.HeaderText = "Qty Realisasi"
        cMo_realisasi.DataPropertyName = "mo_realisasi"
        cMo_realisasi.Width = 100
        cMo_realisasi.DefaultCellStyle.Alignment = DataGridViewContentAlignment.NotSet
        cMo_realisasi.Visible = False
        cMo_realisasi.ReadOnly = False
        ...
        cOrderdetil_qty, cMo_outstanding, cMo_realisasi, cOrderdetil_days, cOrderdetil_idr, cOrderdetil_foreign, cOrderdetil_foreignrate, _
...
#Region " User defined function "
    ...
    Private Function dlgTrnJurnalDetilSelect_Load(ByVal channel_id As String) As Boolean
        ...
        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasadetil_Select_Maintenance", dbConn)
        ...
        Try
            ...
            If Me.order_line <> String.Empty Then
                Me.tbl_TrnTerimaJasa_Maintenance.DefaultView.RowFilter = String.Format(" orderdetil_line not in {0}", Me.order_line)
            End If
...
#End Region
    ...
    Private Sub dlgTrnTerimaJasaDetil_Select_Maintenance_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Me.Cursor = Cursors.WaitCursor
        Me.FormatDgvTrnOrderdetil(Me.DgvMaintenanceOrder)
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Dim tblDetil As DataTable = CreateTblTrnTerimaJasa_List_MaintenanceOrder()
        Dim row As DataRow
    ...
    Private Sub LinkCheck1_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkCheck1.LinkClicked
        ...
        For i = 0 To Me.tbl_TrnTerimaJasa_Maintenance.Rows.Count - 1
            Me.tbl_TrnTerimaJasa_Maintenance.Rows(i).Item("order_check") = True
        Next
        Me.DgvMaintenanceOrder.DataSource = Me.tbl_TrnTerimaJasa_Maintenance
    End Sub
    ...
    Private Sub LinkClear1_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkClear1.LinkClicked
        ...
        For i = 0 To Me.tbl_TrnTerimaJasa_Maintenance.Rows.Count - 1
            Me.tbl_TrnTerimaJasa_Maintenance.Rows(i).Item("order_check") = False
        Next
        Me.DgvMaintenanceOrder.DataSource = Me.tbl_TrnTerimaJasa_Maintenance
    End Sub
End Class