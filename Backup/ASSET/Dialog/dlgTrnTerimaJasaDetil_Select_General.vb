Public Class dlgTrnTerimaJasaDetil_Select_General
    ...
    Private tbl_TrnTerimaJasa_Rental As DataTable = CreateTblTrnTerimaJasa_List_RentalOrder()
...
#Region " Constructor & Default Function"
    ...
    Public Shadows Function OpenDialog(ByVal owner As System.Windows.Forms.IWin32Window, _
                ByVal channel_id As String, ByVal dsn As String, ByVal asset_dsn As String, ByVal order_id As String, _
...
#Region " UI Layout & Format "
    Function CreateTblTrnTerimaJasa_List_RentalOrder() As DataTable
        ...
        tbl.Columns.Add(New DataColumn("ro_outstanding", GetType(System.Decimal)))
        tbl.Columns.Add(New DataColumn("ro_realisasi", GetType(System.Decimal)))
        ...
        tbl.Columns("ro_outstanding").DefaultValue = 0
        tbl.Columns("ro_realisasi").DefaultValue = 0
    ...
    Private Function FormatDgvTrnOrderdetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        Dim cRo_outstanding As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cRo_realisasi As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        ...
        cRo_outstanding.Name = "ro_outstanding"
        cRo_outstanding.HeaderText = "Qty Outstanding"
        cRo_outstanding.DataPropertyName = "ro_outstanding"
        cRo_outstanding.Width = 120
        cRo_outstanding.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        cRo_outstanding.Visible = True
        cRo_outstanding.ReadOnly = True
        cRo_outstanding.DefaultCellStyle.Format = "#,##0"

        cRo_realisasi.Name = "ro_realisasi"
        cRo_realisasi.HeaderText = "Qty Realisasi"
        cRo_realisasi.DataPropertyName = "ro_realisasi"
        cRo_realisasi.Width = 100
        cRo_realisasi.DefaultCellStyle.Alignment = DataGridViewContentAlignment.NotSet
        cRo_realisasi.Visible = False
        cRo_realisasi.ReadOnly = False
        ...
        cOrderdetil_qty, cRo_outstanding, cRo_realisasi, cOrderdetil_days, cOrderdetil_idr, cOrderdetil_foreign, cOrderdetil_foreignrate, _
...
#Region " User defined function "
    ...
    Private Function dlgTrnJurnalDetilSelect_Load(ByVal channel_id As String) As Boolean
        ...
        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasadetil_Select_GENERAL", dbConn)
        ...
        Me.tbl_TrnTerimaJasa_Rental.Clear()

        Try
            dbConn.Open()
            dbConnAsset.Open()
            dbDA.Fill(Me.tbl_TrnTerimaJasa_Rental)
            If Me.order_line <> String.Empty Then
                Me.tbl_TrnTerimaJasa_Rental.DefaultView.RowFilter = String.Format(" orderdetil_line not in {0}", Me.order_line)
            End If
            Me.DgvRentalOrder.DataSource = Me.tbl_TrnTerimaJasa_Rental
...
#End Region
    ...
    Private Sub dlgTrnTerimaJasaDetil_Select_Rental_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Me.Cursor = Cursors.WaitCursor
        Me.FormatDgvTrnOrderdetil(Me.DgvRentalOrder)
    ...
    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Dim tblDetil As DataTable = CreateTblTrnTerimaJasa_List_RentalOrder()
        Dim row As DataRow
        Dim thisRetObj As Collection = New Collection

        Dim tbl_TrnTerimaJasa1 As DataTable = CreateTblTrnTerimaJasa_List_RentalOrder()
        Dim i, j As Integer
        Dim columnName As String

        tbl_TrnTerimaJasa1.Clear()
        tbl_TrnTerimaJasa1 = Me.tbl_TrnTerimaJasa_Rental.Copy()
    ...
    Private Sub LinkCheck1_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkCheck1.LinkClicked
        ...
        For i = 0 To Me.tbl_TrnTerimaJasa_Rental.Rows.Count - 1
            Me.tbl_TrnTerimaJasa_Rental.Rows(i).Item("order_check") = True
        Next
        Me.DgvRentalOrder.DataSource = Me.tbl_TrnTerimaJasa_Rental
    End Sub
    ...
    Private Sub LinkClear1_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkClear1.LinkClicked
        ...
        For i = 0 To Me.tbl_TrnTerimaJasa_Rental.Rows.Count - 1
            Me.tbl_TrnTerimaJasa_Rental.Rows(i).Item("order_check") = False
        Next
        Me.DgvRentalOrder.DataSource = Me.tbl_TrnTerimaJasa_Rental
    End Sub
End Class
