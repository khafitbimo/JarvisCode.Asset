...
Public Class dlgTrnTerimajasa_Select_Editing
...
#Region " Constructor & Default Function"
    ...
    Public Sub New(ByVal dsn As String, ByVal dsnAsset As String, ByVal rekanan_id As Decimal, _
...
#Region " UI Layout & Format "
    ...
    Function CreateTblTrnTerimaJasa_List_EditingOrder() As DataTable
        ...
        Return tbl
    End Function
    Private Function FormatDgvTrnTerimaJasa_Select_EditingOrder(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
...
#Region " User defined function "
    ...
    Private Function dlgTrnTerimajasa_Select_Editing_Load(ByVal channel_id As String) As Boolean
        ...
        Dim tbl_DetilSA As DataTable = CreateTblTrnTerimaJasa_List_EditingOrder()
        Dim criteria = ""
        ...
        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasa_Select_Editing", dbConnAsset)
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "dlgTrnTerimajasa_Select_Editing" & ": dlgTrnTerimajasa_Select_Editing_Load()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            dbConn.Close()
            dbConnAsset.Close()
        End Try
...
#End Region
    ...
    Private Sub dlgTrnTerimajasa_Select_Editing_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        Me.Cursor = Cursors.WaitCursor
        Me.FormatDgvTrnTerimaJasa_Select_EditingOrder(Me.DgvEditingOrder)
        ...
        Me.obj_Source.Items.Add("Editing")
        Me.obj_Source.SelectedItem = "Editing"
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Me.dlgTrnTerimajasa_Select_Editing_Load(Me.mChannel_id)
        Me.DgvEditingOrder.DataSource = Me.tbl_TrnTerimaJasa_Editing

    End Sub

    Private Sub btnSelect_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Dim tblH As DataTable = CreateTblTrnTerimaJasa_List_EditingOrder()
        Dim row As DataRow
    ...
    Private Sub DgvEditingOrder_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvEditingOrder.CellClick
        Dim i As Integer

        For i = 0 To Me.DgvEditingOrder.Rows.Count - 1
            If i <> e.RowIndex Then
                Me.DgvEditingOrder.Rows(i).Cells("terimajasa_check").Value = False
            End If
        Next
    End Sub
    ...
    Private Sub DgvEditingOrder_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles DgvEditingOrder.CellFormatting
