Public Class dlgRptTerimaJasaMaintenance
    ...
    Private Sub dlgRptTerimaJasaMaintenance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dtFiller As clsDataFiller = New clsDataFiller(Me.DSN)
        Dim dtFillerAsset As clsDataFiller = New clsDataFiller(Me.AssetDSN)

        dtFillerAsset.DataFillAsset(Me.AssetDSN, Me.tbl_Print, "as_TrnTerimajasa_Select", " AND " & criteria, Me.mChannel_id, 1)
        dtFillerAsset.DataFillAsset(Me.AssetDSN, Me.tbl_PrintDetil, "as_TrnTerimajasadetil_Select", criteria)

        GenerateReport()
        Me.rvTerimaJasaMaintenance.RefreshReport()
    End Sub
    ...
    Private Function GenerateReport() As Boolean
        ...
        objReportViewer.Name = "rvTerimaJasaMaintenance"
        ...
        objReportViewer.LocalReport.SetParameters(New Microsoft.Reporting.WinForms.ReportParameter() {parRptImageURL, parRptChannelID, parRptChannel_namereport, parRptChannel_address, parRptTerimaJasa_id, parRptDomain})
        objReportViewer.LocalReport.DataSources.Clear()
        objReportViewer.LocalReport.DataSources.Add(objRdsH)
        objReportViewer.RefreshReport()

        Me.SuspendLayout()
        Me.Controls.Remove(Me.rvTerimaJasaMaintenance)

        Me.rvTerimaJasaMaintenance = Nothing
        Me.rvTerimaJasaMaintenance = objReportViewer
        Me.rvTerimaJasaMaintenance.LocalReport.EnableExternalImages = True

        Me.Controls.Add(Me.rvTerimaJasaMaintenance)
        Me.ResumeLayout()
        Me.rvTerimaJasaMaintenance.Dock = DockStyle.Fill
    End Function

    Private Function GenerateDataHeader() As ArrayList
        Dim objPrintHeader As DataSource.clsRptTerimaJasaMaintenance
        Dim objDatalistHeader As ArrayList = New ArrayList()
        Dim i As Integer
    ...
    Private Sub GenerateDataDetail()
        ...
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaMaintenanceDetil(Me.DSN, Me.AssetDSN)
            With objDetil
    ...
    Public Sub New(ByVal strDSN As String, ByVal strAssetDSN As String, ByVal sptServer As String, ByVal sptChannel As String, ByVal ket As String)
        Me.DSN = strDSN
