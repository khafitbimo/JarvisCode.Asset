Public Class dlgRptTerimaJasaRental
    ...
    Private Sub dlgRptTerimaJasaRental_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GenerateReport()
        Me.rvTerimaJasaRental.RefreshReport()
    End Sub
    ...
    Private Function GenerateReport() As Boolean
        ...
        objReportViewer.Name = "rvTerimaJasaRental"
        ...
        Me.SuspendLayout()
        Me.Controls.Remove(Me.rvTerimaJasaRental)

        Me.rvTerimaJasaRental = Nothing
        Me.rvTerimaJasaRental = objReportViewer
        Me.rvTerimaJasaRental.LocalReport.EnableExternalImages = True

        Me.Controls.Add(Me.rvTerimaJasaRental)
        Me.ResumeLayout()
        Me.rvTerimaJasaRental.Dock = DockStyle.Fill
    End Function

    Private Function GenerateDataHeader() As ArrayList
        Dim objPrintHeader As DataSource.clsRptTerimaJasaRental
        Dim objDatalistHeader As ArrayList = New ArrayList()
        Dim i As Integer
    ...
    Private Sub GenerateDataDetail()
        ...
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaRentalDetil(Me.DSN, Me.AssetDSN)
            With objDetil
