...
#Region " Overrides "
    Public Overrides Function btnLoad_Click() As Boolean
        If Me.cboSearch_Source.SelectedItem = "-- Pilih --" Then
            MsgBox("Please choose your report name first")
            Exit Function
        ElseIf Me.cboSearch_Source.SelectedItem = "BPJ in Transaksi Order" Then
            If Me.cbo_rekap.SelectedItem = "No" Or Me.cbo_rekap.SelectedItem = "-- Pilih --" Then
                If Me.cbo_filter.SelectedItem = "-- Pilih --" Then
                    MsgBox("Please choose your filter first")
                    Exit Function
                End If
            End If
        End If
