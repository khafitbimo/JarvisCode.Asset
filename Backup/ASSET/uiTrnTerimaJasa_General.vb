...
' Created Date: 6/20/2012 1:41 PM
' 
...
#Region " Window Parameter "
    ...
    Private _STRUKTUR_UNIT As Decimal = 4310 '3130 '2610 '2610 '2360 '3501
...
#Region " Additional Overrides "
    ...
    Private Sub uiTrnTerimaJasa_Rental_AppBma(ByVal status As String)
        ...
        Try
            ...
            ' ''Me.DataFill(Me.tbl_MstPeriode, "ms_MstPeriodeCombo_Select", String.Format(" periode_id = '{0}'", String.Format("{0:yyMM}", Me.obj_Jurnal_bookdate.Value)))
            ' ''If Me.tbl_MstPeriode.Rows.Count <= 0 Then
            ' ''    MsgBox("Period is Closed. Please contact your administrator")
            ' ''    Exit Try
            ' ''End If
...
#Region " User Defined Function "
    ...
    Private Function uiTrnTerimaJasa_Rental_OpenRow(ByVal rowIndex As Integer) As Boolean
        ...
        Try
            ...
            dbConn.Open()
            dbConnAsset.Open()
            Me.uiTrnTerimaJasa_Rental_OpenRowMaster(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Rental_OpenRowDetil(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Rental_OpenRowDetilUsed(channel_id, terimajasa_id, dbConnAsset)
    ...
    Private Function uiTrnTerimaJasa_Rental_OpenRowMaster(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        ...
        Try
            ...
            If Me.tbl_TrnTerimajasa_Temp.Rows.Count > 0 Then
                Dim dbConnStart As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
                dbConnStart.Open()
                Me.uiTrnRentalOrder2_OpenRowDetil(channel_id, tbl_TrnTerimajasa_Temp.Rows(0).Item("order_id"), dbConnStart)
                dbConnStart.Close()
            End If
        Catch ex As Exception
...
#End Region
    ...
    Private Sub btn_order_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_order.Click
        ...
        If Me.DgvTrnTerimajasadetil.Rows.Count = 0 Then
            Dim dlg As dlgTrnTerimajasa_Select_General = New dlgTrnTerimajasa_Select_General(Me.DSN, Me.ASSET_DSN, Me.obj_Rekanan_id.SelectedValue, Me.tbl_MstRekanan.Copy, Me._STRUKTUR_UNIT)
    ...
    Private Sub Btn_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Add.Click
        ...
        retObj = dlg.OpenDialog(Me, Me.obj_Channel_id.Text, Me.DSN, Me.ASSET_DSN, Me.obj_Order_id.Text, order_line)
    ...
    Private Sub DgvTrnTerimajasadetil_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnTerimajasadetil.CellClick
        Select Case e.ColumnIndex
            Case Me.DgvTrnTerimajasadetil.Columns("select_days").Index
                ...
                Dim retObj As Object
                Dim retData As Collection
                Dim ListDaysOrder As New dlgTrnTerimaJasaUsed_General(Me.DSN, Me._CHANNEL, Me.obj_Terimajasa_id.Text, Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("orderdetil_line").Value, Me.obj_Terimajasa_status.SelectedItem, _
...
#Region "PRINT"
    Private Function GenerateDataHeader() As ArrayList
        ...
        objPrintHeader = New DataSource.clsRptTerimaJasaRental(Me.DSN)
        Dim odatafiller As clsDataFiller = New clsDataFiller(Me.ASSET_DSN)
    ...
    Private Sub GenerateDataDetail()
        ...
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaRentalDetil(Me.DSN, Me.ASSET_DSN)
            With objDetil
    ...
    Private Function uiTrnTerimaJasa_Rental_PrintPreview() As Boolean
        ...
        If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 1 Then
            ...
            Dim frmPrint As dlgRptTerimaJasaRental = New dlgRptTerimaJasaRental(Me.DSN, Me.ASSET_DSN, Me.SptServer, Me._CHANNEL, ket)
            Dim criteria As String = String.Empty
