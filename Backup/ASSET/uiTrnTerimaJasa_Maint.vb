...
' Created Date: 5/23/2010 9:36 PM
' 
...
Public Class uiTrnTerimaJasa_Maint
    Private Const mUiName As String = "Transaksi Terima Jasa Maintenance"
    ...
    Private objPrintHeader As DataSource.clsRptTerimaJasaMaintenance
...
#Region " Window Parameter "
    ...
    Private _STRUKTUR_UNIT As Decimal = 5560 '5554 '2610 '2360 '3501
...
#Region " Additional Overrides "
        ...
        If Me.DgvTrnTerimajasa.Rows.Count > 0 Then
            If Me._USERTYPE = "user" Then
                If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appuser").Value = 0 Then
                    Me.uiTrnTerimaJasa_Maintenance_AppUser("approved")
            ...
            ElseIf Me._USERTYPE = "spv" Then
                ...
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 0 Then
                    Me.uiTrnTerimaJasa_Maintenance_AppSpv("approved")
                End If
            ElseIf Me._USERTYPE = "bma" Then
                ...
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appbma").Value = 0 Then
                    Me.uiTrnTerimaJasa_Maintenance_AppBma("approved")
                End If
            End If
        End If
    End Sub
        ...
        If Me.DgvTrnTerimajasa.Rows.Count > 0 Then
            If Me._USERTYPE = "user" Then
                ...
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appuser").Value = 1 Then
                    'unapproved user
                    Me.uiTrnTerimaJasa_Maintenance_AppUser("unapproved")
            ...
            ElseIf Me._USERTYPE = "spv" Then
                If Me.DgvTrnTerimajasa.Item("terimajasa_appbma", DgvTrnTerimajasa.CurrentRow.Index).Value = 1 Then
                    MsgBox("Need BMA UnApproved", MsgBoxStyle.Information)
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 1 Then
                    Me.uiTrnTerimaJasa_Maintenance_AppSpv("unapproved")
                End If
            ElseIf Me._USERTYPE = "bma" Then
                ...
                Else
                    ...
                    If tbl_periode.Rows(0).Item("periode_isclosed") = True Then
                        ...
                        Exit Sub
                    Else
                        Me.uiTrnTerimaJasa_Maintenance_AppBma("unapproved")
                    End If
    ...
    Private Sub uiTrnTerimaJasa_Maintenance_AppUser(ByVal status As String)
    ...
    End Sub
    Private Sub uiTrnTerimaJasa_Maintenance_AppSpv(ByVal status_approved As String)
        ...
        If status_approved = "approved" Then
            ...
            If status IsNot Nothing Then
                ...
                Else
                    Try
                        Me.uiTrnTerimaJasa_Maintenance_BuiltJurnal()
                        dbConn.Open()
                        dbConnStart.Open()
        ...
        Else
            Try
                ...
                Me.uiTrnTerimaJasa_Maintenance_OpenRowJurnalDetil_kredit(Me.DgvTrnTerimajasa.Item("channel_id", DgvTrnTerimajasa.CurrentRow.Index).Value, Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value, dbConn)
                Me.uiTrnTerimaJasa_Maintenance_OpenRowJurnalDetil_Debet(Me.DgvTrnTerimajasa.Item("channel_id", DgvTrnTerimajasa.CurrentRow.Index).Value, Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value, dbConn)
                Me.uiTrnTerimajasa_Maintenance_OpenRowJurnalReference(Me.DgvTrnTerimajasa.Item("channel_id", DgvTrnTerimajasa.CurrentRow.Index).Value, Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value, dbConn)
            Catch ex As Data.OleDb.OleDbException
                MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, "SQL Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Catch ex As Exception
                MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        System.Windows.Forms.Cursor.Current = Cursors.Default
    End Sub
    Private Sub uiTrnTerimaJasa_Maintenance_AppBma(ByVal status As String)
        System.Windows.Forms.Cursor.Current = Cursors.WaitCursor
        If Me.uiTrnTerimaJasa_Maintenance_FormError() Then
            System.Windows.Forms.Cursor.Current = Cursors.Default
            Exit Sub
        End If
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        ...
        periode = Me.cbo_periode.SelectedValue
        book_date = Me.obj_Jurnal_bookdate.Value
        ...
        Try
            ...
            Try
                Dim oCmJurnal As New OleDb.OleDbCommand("as_TrnJurnal_Update", dbConn)

                oCmJurnal.CommandType = CommandType.StoredProcedure
                oCmJurnal.Parameters.Add("@terimajasa_id", System.Data.OleDb.OleDbType.VarWChar, 30).Value = Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value
                oCmJurnal.Parameters.Add("@periode_id", System.Data.OleDb.OleDbType.VarWChar, 32).Value = periode
                oCmJurnal.Parameters.Add("@jurnal_bookdate", System.Data.OleDb.OleDbType.DBTimeStamp, 4).Value = book_date
                oCmJurnal.Parameters.Add("@jurnal_duedate", System.Data.OleDb.OleDbType.DBTimeStamp, 4).Value = book_date

                oCmJurnal.ExecuteNonQuery()
                oCmJurnal.Dispose()
            ...
            Else
                ...
                Me.tbtnSave.Enabled = True
            End If
            'Me.uiTrnTerimaJasa_Maintenance_JurnalSave()
        Catch ex As Data.OleDb.OleDbException
            MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, "SQL Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Catch ex As Exception
            MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub uiTrnTerimaJasa_Maintenance_BuiltJurnal()
        ...
        If Me.tbl_TrnTerimajasadetil.Rows.Count > 0 Then
            ...
            For rows_debet = 0 To Me.tbl_TrnTerimajasadetil.Rows.Count - 1
                ...
                amountIdrreal += clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_idrreal"), 0) * clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_qty_usage"), 0)
            ...
            For rows_kredit = 0 To Me.tbl_TrnTerimajasadetil.Rows.Count - 1
                ...
                Me.tbl_TrnJurnaldetil_kredit.Rows(rows_kredit).Item("strukturunit_id") = Me._STRUKTUR_UNIT
            ...
            If isAcc_ok = "ok" Then
                Me.uiTrnTerimaJasa_Maintenance_JurnalSave()
            End If
            Me.uiTrnTerimaJasa_Maintenance_Save()
        End If
    End Sub
#End Region
#Region " Overrides "
    ...
    Public Overrides Function btnNew_Click() As Boolean
        ...
        End If
        Me.uiTrnTerimaJasa_Maintenance_NewData()
        Me.tbtnDel.Enabled = True
        Me.tbtnSave.Enabled = True
    ...
    Public Overrides Function btnLoad_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Maintenance_Retrieve()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrint_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Maintenance_Print()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrintPreview_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Maintenance_PrintPreview()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnDel_Click() As Boolean
        ...
        Else
            Me.uiTrnTerimaJasa_Maintenance_Delete()
        End If
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnFirst_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Maintenance_First()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrev_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Maintenance_Prev()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnNext_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Maintenance_Next()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnLast_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Maintenance_Last()
        Me.Cursor = Cursors.Arrow
...
#Region " Layout & Init UI "
    ...
    Private Function FormatDgvTrnTerimajasadetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        cTerimajasadetil_qty.HeaderText = "Qty"
        cTerimajasadetil_qty.DataPropertyName = "terimajasadetil_qty"
        cTerimajasadetil_qty.Width = 40
        cTerimajasadetil_qty.Visible = True
        ...
        cTerimajasadetil_qty_day_eps.Visible = False
        ...
        cTerimajasadetil_qty, cTerimajasadetil_qty_usage, cTerimajasadetil_desc, cKategoriitem_id, cBrand_id, _
    ...
    Private Function FormatDgvTrnTerimajasaused(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        objDgv.Columns.Clear()
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() _
        {cTerimajasa_check, cTerimajasa_date, cTerimajasaused_qty, cTerimajasaused_usagestart, cTerimajasaused_usgaeend, _
    ...
    Private Function FormatDgvTrnOrderdetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        corderdetil_rowtotalidr_incldisc.Name = "subtotalidr_incldisc"
        corderdetil_rowtotalidr_incldisc.HeaderText = "SubTotal IDR"
        corderdetil_rowtotalidr_incldisc.DataPropertyName = "subtotalidr_incldisc"
        ...
        cRequestdetil_foreignrate.Name = "orderdetil_foreignrate"
        cRequestdetil_foreignrate.HeaderText = "Rate"
        cRequestdetil_foreignrate.DataPropertyName = "orderdetil_foreignrate"
        ...
        cRequestdetil_foreignrate.Width = 75
        ...
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() { _
            ...
            cUnit_name, _
            cOrderdetil_days, _
            cCurrency_name, cRequestdetil_foreignrate, _
            cOrderdetil_foreign, _
            corderdetil_rowtotalforeign, _
            cOrderdetil_discount, _
            corderdetil_rowtotalforeign_incldisc, corderdetil_rowtotalidr_incldisc, _
...
#Region " User Defined Function "
    ...
    Private Function uiTrnTerimaJasa_Maintenance_NewData() As Boolean
        'new data
        ...
        Me.tbl_TrnTerimajasa_Temp.Columns("terimajasa_type").DefaultValue = "MAINTENANCE"
        ...
        Me.tbl_TrnTerimajasadetil.Columns("terimajasadetil_type").DefaultValue = "MAINTENANCE"
        ...
        ' ''Me.tbl_TrnTerimajasaUsed.Columns("terimajasadetil_type").DefaultValue = "MAINTENANCE"
    ...
    Private Function uiTrnTerimaJasa_Maintenance_Retrieve() As Boolean
        'retrieve data
        ...
        criteria &= " AND terimajasa_type = 'MAINTENANCE'"
    ...
    Private Function uiTrnTerimaJasa_Maintenance_Save() As Boolean
        'save data
        ...
        If tbl_TrnTerimajasa_Temp_Changes IsNot Nothing Or tbl_TrnTerimajasadetil_Changes IsNot Nothing Or tbl_TrnTerimajasaused_Changes IsNot Nothing Then
            ...
            Try
                ...
                If tbl_TrnTerimajasa_Temp_Changes IsNot Nothing Then
                    success = Me.uiTrnTerimaJasa_Maintenance_SaveMaster(terimajasa_id, tbl_TrnTerimajasa_Temp_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnTerimaJasa_Maintenance_SaveMaster(tbl_TrnTerimajasa_Temp_Changes)")
                ...
                If tbl_TrnTerimajasadetil_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnTerimajasadetil.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnTerimaJasa_Maintenance_SaveDetil(terimajasa_id, tbl_TrnTerimajasadetil_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnTerimaJasa_Maintenance_SaveDetil(tbl_TrnTerimajasadetil_Changes)")
                ...
                If tbl_TrnTerimajasaused_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnTerimajasaUsed.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnTerimaJasa_Maintenance_SaveDetilUsed(terimajasa_id, tbl_TrnTerimajasaused_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnTerimaJasa_Maintenance_SaveDetilUsed(tbl_TrnTerimajasadetilUsed_Changes)")
    ...
    End Function
    Private Function uiTrnTerimaJasa_Maintenance_SaveMaster(ByRef terimajasa_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        ...
        Return True
    End Function
    Private Function uiTrnTerimaJasa_Maintenance_SaveDetil(ByRef terimajasa_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnTerimaJasa_Maintenance_SaveDetilUsed(ByRef terimajasa_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        ...
        dbCmdInsert = New OleDb.OleDbCommand("as_TrnTerimajasaused_Insert", dbConnAsset)
        dbCmdInsert.CommandType = CommandType.StoredProcedure
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@channel_id", System.Data.OleDb.OleDbType.VarWChar, 20, "channel_id"))
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_id", System.Data.OleDb.OleDbType.VarWChar, 24))
        ...
        dbCmdUpdate = New OleDb.OleDbCommand("as_TrnTerimajasaused_Update", dbConnAsset)
        dbCmdUpdate.CommandType = CommandType.StoredProcedure
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@channel_id", System.Data.OleDb.OleDbType.VarWChar, 20, "channel_id"))
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_id", System.Data.OleDb.OleDbType.VarWChar, 24))
        ...
        dbCmdDelete = New OleDb.OleDbCommand("as_TrnTerimajasaused_Delete", dbConnAsset)
        dbCmdDelete.CommandType = CommandType.StoredProcedure
    ...
    Private Function uiTrnTerimaJasa_Maintenance_JurnalSave() As Boolean
        'save data
        ...
        If tbl_TrnJurnal_Changes IsNot Nothing Or tbl_JurnalReference_Changes IsNot Nothing Or tbl_TrnJurnaldetil_kredit_Changes IsNot Nothing Or tbl_TrnJurnaldetil_debet_Changes IsNot Nothing Then
            ...
            Try
                ...
                If tbl_TrnJurnal_Changes IsNot Nothing Then
                    ...
                    success = Me.uiTrnTerimaJasa_Maintenance_JurnalSaveMaster(jurnal_id, tbl_TrnJurnal_Changes, MasterDataState)
                ...
                If tbl_TrnJurnaldetil_kredit_Changes IsNot Nothing Then
                    ...
                    success = Me.uiTrnJurnalJasa_Maintenance_JurnalSaveDetilKredit(jurnal_id, tbl_TrnJurnaldetil_kredit_Changes, MasterDataState)
                ...
                If tbl_JurnalReference_Changes IsNot Nothing Then
                    success = Me.uiTrnJurnalJasa_Maintenance_JurnalSaveReference(jurnal_id, tbl_JurnalReference_Changes, MasterDataState)
                ...
                If tbl_TrnJurnaldetil_debet_Changes IsNot Nothing Then
                    ...
                    For i = 0 To Me.tbl_TrnJurnaldetil_debet.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnJurnalJasa_Maintenance_JurnalSaveDetilDebet(jurnal_id, tbl_TrnJurnaldetil_debet_Changes, MasterDataState)
    ...
    End Function
    Private Function uiTrnTerimaJasa_Maintenance_JurnalSaveMaster(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Return True
    End Function
    Private Function uiTrnJurnalJasa_Maintenance_JurnalSaveDetilKredit(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnJurnalJasa_Maintenance_JurnalSaveDetilDebet(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnJurnalJasa_Maintenance_JurnalSaveReference(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnTerimaJasa_Maintenance_Delete() As Boolean
        Dim res As String = ""
        Dim terimajasa_id As Object = New Object
        ...
        If Me.DgvTrnTerimajasa.CurrentRow IsNot Nothing Then
            ...
            If res = DialogResult.Yes Then
                Me.uiTrnTerimaJasa_Maintenance_DeleteRow(Me.DgvTrnTerimajasa.CurrentRow.Index)
            End If
    ...
    Private Function uiTrnTerimaJasa_Maintenance_DeleteRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Try
            ...
            If Me.DgvTrnTerimajasa.Rows.Count > 1 Then
                ...
                If rowIndex = 0 Then
                    ...
                    Me.uiTrnTerimaJasa_Maintenance_OpenRow(NewRowIndex)
                ...
                Else
                    Me.tbl_TrnTerimajasa.Rows.RemoveAt(rowIndex)
                    Me.uiTrnTerimaJasa_Maintenance_OpenRow(rowIndex)
                End If
    ...
    Private Function uiTrnTerimaJasa_Maintenance_OpenRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim terimajasa_id As String
        ...
        Try
            ...
            dbConn.Open()
            dbConnAsset.Open()
            Me.uiTrnTerimaJasa_Maintenance_OpenRowMaster(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Maintenance_OpenRowDetil(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Maintenance_OpenRowDetilUsed(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Maintenance_OpenRowJurnal(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimaJasa_Maintenance_OpenRowJurnalDetil_kredit(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimaJasa_Maintenance_OpenRowJurnalDetil_Debet(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimajasa_Maintenance_OpenRowJurnalReference(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimajasa_Maintenance_OpenRowResponse(channel_id, terimajasa_id, dbConn)
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, mUiName & ": uiTrnTerimaJasa_Maintenance_OpenRow()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            dbConn.Close()
            dbConnAsset.Close()
        End Try
    ...
    Private Function uiTrnTerimaJasa_Maintenance_OpenRowMaster(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        ...
        Try
            ...
            If Me.tbl_TrnTerimajasa_Temp.Rows.Count > 0 Then
                Dim dbConnStart As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.START_DSN)
                dbConnStart.Open()
                Me.uiTrnMaintenanceOrder2_OpenRowDetil(channel_id, tbl_TrnTerimajasa_Temp.Rows(0).Item("order_id"), dbConnStart)
                dbConnStart.Close()

            End If
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnTerimaJasa_Maintenance_OpenRowMaster()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnTerimaJasa_Maintenance_OpenRowDetil(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.DgvTrnTerimajasadetil.DataSource = Me.tbl_TrnTerimajasadetil
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnTerimaJasa_Maintenance_OpenRowDetil()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnTerimaJasa_Maintenance_OpenRowDetilUsed(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.dgvTerimaJasaUsed.DataSource = Me.tbl_TrnTerimajasaUsed
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnTerimaJasa_Maintenance_OpenRowDetilUsed()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnTerimaJasa_Maintenance_OpenRowJurnal(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimaJasa_Maintenance_OpenRowJurnalDetil_kredit(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimaJasa_Maintenance_OpenRowJurnalDetil_Debet(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimajasa_Maintenance_OpenRowJurnalReference(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimajasa_Maintenance_OpenRowResponse(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnMaintenanceOrder2_OpenRowDetil(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnJurnal_TblDetilInverse(ByVal tbl As DataTable) As Boolean
        ...
        Return True
    End Function
    Private Function uiTrnTerimaJasa_Maintenance_First() As Boolean
        ...
        If iTab = 1 Then
            If Me.DATA_ISLOCKED Then
                move = True
            Else
                move = Me.uiTrnTerimaJasa_Maintenance_ConfirmSaveBeforeMove(Message)
            End If
        Else
            move = True
        End If
        ...
        If move Then
            ...
            Me.uiTrnTerimaJasa_Maintenance_RefreshPosition()
        End If
    End Function

    Private Function uiTrnTerimaJasa_Maintenance_Prev() As Boolean
    ...
    Private Function uiTrnTerimaJasa_Maintenance_Next() As Boolean
    ...
    Private Function uiTrnTerimaJasa_Maintenance_Last() As Boolean
    ...
    Private Function uiTrnTerimaJasa_Maintenance_RefreshPosition() As Boolean
        'refresh position
        Dim iTab As Integer = Me.ftabMain.SelectedIndex
        If iTab = 1 Then uiTrnTerimaJasa_Maintenance_OpenRow(Me.DgvTrnTerimajasa.CurrentRow.Index)
    End Function

    Private Function uiTrnTerimaJasa_Maintenance_ConfirmSaveBeforeMove(ByVal Message As String) As Boolean
    ...
    Private Function uiTrnTerimaJasa_Maintenance_FormError() As Boolean
        ...
        Try
            ...
            For i = 0 To Me.DgvTrnTerimajasadetil.Rows.Count - 1
                Try
                    dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasausedMaintenance_qtyOutstandingErr", dbConn)
                    dbCmd.Parameters.Add("@order_id", Data.OleDb.OleDbType.VarWChar)
                    dbCmd.Parameters("@order_id").Value = Me.DgvTrnTerimajasadetil.Rows(i).Cells("order_id").Value
                    dbCmd.Parameters.Add("@orderdetil_line", Data.OleDb.OleDbType.Integer)
                    dbCmd.Parameters("@orderdetil_line").Value = Me.DgvTrnTerimajasadetil.Rows(i).Cells("orderdetil_line").Value
                    dbCmd.Parameters.Add("@terimajasa_id", Data.OleDb.OleDbType.VarWChar)
                    dbCmd.Parameters("@terimajasa_id").Value = Me.DgvTrnTerimajasadetil.Rows(i).Cells("terimajasa_id").Value
                    dbCmd.CommandType = CommandType.StoredProcedure
                    dbDA = New OleDb.OleDbDataAdapter(dbCmd)
                    tbl_err.Clear()
                    ...
                    dbDA.Fill(tbl_err)
                Catch ex As Exception
                    MessageBox.Show(ex.Message, mUiName, MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Return True
                Finally
                    dbConn.Close()
                End Try
                ...
                If tbl_err.Rows.Count > 0 Then
                    ...
                    cell_qty = Me.DgvTrnTerimajasadetil.Rows(i).Cells("terimajasadetil_qty")
...
#End Region
    ...
    Private Sub uiTrnTerimaJasa_Maintenance_FormBeforeNew() Handles Me.FormBeforeNew
        Me.objFormError.Clear()
    End Sub

    Private Sub uiTrnTerimaJasa_Maintenance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ftabMain_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ftabMain.SelectedIndexChanged
        ...
        Select Case ftabMain.SelectedIndex
            ...
            Case 1
                ...
                If Me.DgvTrnTerimajasa.CurrentRow IsNot Nothing Then
                    Me.uiTrnTerimaJasa_Maintenance_OpenRow(Me.DgvTrnTerimajasa.CurrentRow.Index)
...
#End Region
    ...
    Private Sub btn_order_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_order.Click
        ...
        If Me.DgvTrnTerimajasadetil.Rows.Count = 0 Then
            Dim dlg As dlgTrnTerimajasa_Select_Maintenance = New dlgTrnTerimajasa_Select_Maintenance(Me.DSN, Me.ASSET_DSN, Me.obj_Rekanan_id.SelectedValue, Me.tbl_MstRekanan.Copy, Me._STRUKTUR_UNIT)

            Dim retObj As Object
            Dim retData As Collection
            Dim tblH As DataTable

            retObj = dlg.OpenDialog(Me, Me.obj_Channel_id.Text, "Maintenance")
            ...
            If retObj IsNot Nothing Then
                ...
                Me.uiTrnMaintenanceOrder2_OpenRowDetil(Me._CHANNEL, tblH.Rows(0).Item("order_id"), dbConn)
            End If
        Else
    ...
    Private Sub Btn_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Add.Click
        Dim dlg As dlgTrnTerimaJasaDetil_Select_Maintenance = New dlgTrnTerimaJasaDetil_Select_Maintenance()
        ...
        If retObj IsNot Nothing Then
            ...
            For row_index = 0 To tblDetil.Rows.Count - 1
                ...
                row.Item("terimajasadetil_qty") = tblDetil.Rows(row_index).Item("mo_outstanding")
                row.Item("terimajasadetil_qty_day_eps") = 0 'tblDetil.Rows(row_index).Item("orderdetil_days")
                row.Item("terimajasadetil_qty_usage") = tblDetil.Rows(row_index).Item("orderdetil_qty")
                ...
                If tblDetil.Rows(row_index).Item("currency_id") = 1 Then
                    row.Item("terimajasadetil_pphforeign") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                    * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_pphpercent"), 0) / 100), 0, MidpointRounding.AwayFromZero)

                    row.Item("terimajasadetil_ppnforeign") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                                  * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_ppnpercent"), 0) / 100), 0, MidpointRounding.AwayFromZero)

                    row.Item("terimajasadetil_totalforeign") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                                   - (clsUtil.IsDbNull(row.Item("terimajasadetil_pphforeign"), 0)) + (clsUtil.IsDbNull(row.Item("terimajasadetil_ppnforeign"), 0)), 0, MidpointRounding.AwayFromZero)
                Else
                    row.Item("terimajasadetil_pphforeign") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                                       * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_pphpercent"), 0) / 100), 2, MidpointRounding.AwayFromZero)

                    row.Item("terimajasadetil_ppnforeign") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                                  * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_ppnpercent"), 0) / 100), 2, MidpointRounding.AwayFromZero)

                    row.Item("terimajasadetil_totalforeign") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                                   - (clsUtil.IsDbNull(row.Item("terimajasadetil_pphforeign"), 0)) + (clsUtil.IsDbNull(row.Item("terimajasadetil_ppnforeign"), 0)), 2, MidpointRounding.AwayFromZero)
                End If

                row.Item("terimajasadetil_pphidrreal") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_pphpercent"), 0) / 100) * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreignrate"), 0)), 0, MidpointRounding.AwayFromZero)

                row.Item("terimajasadetil_ppnidrreal") = Math.Round(((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_qty"), 0)) - clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0)) _
                                                * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_ppnpercent"), 0) / 100) * (clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreignrate"), 0)), 0, MidpointRounding.AwayFromZero)

                row.Item("terimajasadetil_totalidrreal") = Math.Round((clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreign"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("mo_outstanding"), 0)) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreignrate"), 0) - _
                                                clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_discount"), 0) * clsUtil.IsDbNull(tblDetil.Rows(row_index).Item("orderdetil_foreignrate"), 0) - _
                                                clsUtil.IsDbNull(row.Item("terimajasadetil_pphforeign"), 0) + clsUtil.IsDbNull(row.Item("terimajasadetil_ppnforeign"), 0), 0, MidpointRounding.AwayFromZero)
            ...
            Next
            Me.obj_Terimajasa_qtyrealization.Text = qty_order
    ...
    Private Sub DgvTrnTerimajasadetil_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnTerimajasadetil.CellValidated
        ...
        pphAmount = ((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_qty_usage").Value, 0)) _
        ...
        pphAmountIDR = ((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_qty_usage").Value, 0)) _
        ...
        ppnAmount = ((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_qty_usage").Value, 0)) _
        ...
        ppnAmountIDR = ((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_qty_usage").Value, 0)) _
        ...
        totalAmount = ((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_qty_usage").Value, 0)) _
                    - (clsUtil.IsDbNull(pphAmount, 0)) + (clsUtil.IsDbNull(ppnAmount, 0))

        totalAmountIDR = (clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreignrate").Value, 0) * _
                          clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_qty_usage").Value, 0) - _
    ...
    Private Sub DgvTrnTerimajasadetil_CellValueChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnTerimajasadetil.CellValueChanged

        Select Case e.ColumnIndex
            Case Me.DgvTrnTerimajasadetil.Columns("terimajasadetil_qty").Index
                Dim ppnAmount As Decimal
                Dim ppnAmountIDR As Decimal
                Dim pphAmount As Decimal
                Dim pphAmountIDR As Decimal
                ...
                Dim terimajasadetil_foreign, terimajasadetil_qty_usage, terimajasadetil_disc As Decimal
                Dim terimajasadetil_pphpersen, terimajasadetil_foreignrate, terimajasadetil_ppnpersen As Decimal

                Dim qty_usage As Decimal = 0

                qty_usage = clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_qty").Value, 0)



                terimajasadetil_foreign = clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_foreign").Value, 0)
                terimajasadetil_qty_usage = qty_usage
                terimajasadetil_disc = clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_disc").Value, 0)
                terimajasadetil_pphpersen = clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_pphpersen").Value, 0)
                terimajasadetil_foreignrate = clsUtil.IsDbNull(DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_foreignrate").Value, 0)
                terimajasadetil_ppnpersen = clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_ppnpersen").Value, 0)

                pphAmount = ((terimajasadetil_foreign - terimajasadetil_disc) * terimajasadetil_qty_usage) _
                                                   * (terimajasadetil_pphpersen / 100)

                pphAmountIDR = Math.Round((((terimajasadetil_foreign - terimajasadetil_disc) * terimajasadetil_qty_usage) _
                            * (terimajasadetil_pphpersen / 100) * terimajasadetil_foreignrate), 0, MidpointRounding.AwayFromZero)

                ppnAmount = ((terimajasadetil_foreign - terimajasadetil_disc) * terimajasadetil_qty_usage) _
                                               * (terimajasadetil_ppnpersen / 100)

                ppnAmountIDR = Math.Round((((terimajasadetil_foreign - terimajasadetil_disc) * terimajasadetil_qty_usage) _
                            * (terimajasadetil_ppnpersen / 100) * terimajasadetil_foreignrate), 0, MidpointRounding.AwayFromZero)

                totalAmount = ((terimajasadetil_foreign - terimajasadetil_disc) * terimajasadetil_qty_usage) _
                            - (clsUtil.IsDbNull(pphAmount, 0)) + (clsUtil.IsDbNull(ppnAmount, 0))

                totalAmountIDR = (terimajasadetil_foreign - terimajasadetil_disc) * terimajasadetil_foreignrate * _
                                  terimajasadetil_qty_usage - _
                                clsUtil.IsDbNull(pphAmountIDR, 0) + clsUtil.IsDbNull(ppnAmountIDR, 0)

                If Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("currency_id").Value = 1 Then
                    Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_pphforeign").Value = Math.Round(pphAmount, 0, MidpointRounding.AwayFromZero)
                    Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_ppnforeign").Value = Math.Round(ppnAmount, 0, MidpointRounding.AwayFromZero)
                    Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_totalforeign").Value = Math.Round(totalAmount, 0, MidpointRounding.AwayFromZero)
                Else
                    Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_pphforeign").Value = Math.Round(pphAmount, 2, MidpointRounding.AwayFromZero)
                    Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_ppnforeign").Value = Math.Round(ppnAmount, 2, MidpointRounding.AwayFromZero)
                    Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_totalforeign").Value = Math.Round(totalAmount, 2, MidpointRounding.AwayFromZero)
                End If
                Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_pphidrreal").Value = Math.Round(pphAmountIDR, 0, MidpointRounding.AwayFromZero)
                Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_ppnidrreal").Value = Math.Round(ppnAmountIDR, 0, MidpointRounding.AwayFromZero)
                Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_totalidrreal").Value = Math.Round(totalAmountIDR, 0, MidpointRounding.AwayFromZero)

                Me.DgvTrnTerimajasadetil.Rows(e.RowIndex).Cells("terimajasadetil_qty_usage").Value = qty_usage
...
#Region "PRINT"
    Private Function GenerateDataHeader() As ArrayList
        ...
        objPrintHeader = New DataSource.clsRptTerimaJasaMaintenance(Me.DSN)
        Dim odatafiller As clsDataFiller = New clsDataFiller(Me.ASSET_DSN)
    ...
    Private Sub GenerateDataDetail()
        Dim objDetil As DataSource.clsRptTerimaJasaMaintenanceDetil
        Dim i As Integer

        objDatalistDetil = New ArrayList()
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaMaintenanceDetil(Me.DSN, Me.ASSET_DSN)
            With objDetil
    ...
    Public Sub SubreportProcessing(ByVal sender As Object, ByVal e As Microsoft.Reporting.WinForms.SubreportProcessingEventArgs)
        e.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("ASSET_DataSource_clsRptTerimaJasaMaintenanceDetil", objDatalistDetil))
    End Sub
    ...
    Private Function uiTrnTerimaJasa_Maintenance_Print() As Boolean
        ...
        If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 1 Then
            ...
            objRdsH.Name = "ASSET_DataSource_clsRptTerimaJasaMaintenance"
            objRdsH.Value = objDatalistHeader

            If ket = "Internal" Then
                objReportH.ReportEmbeddedResource = "ASSET.RptTerimaJasaMaintenance.rdlc"
            Else
                objReportH.ReportEmbeddedResource = "ASSET.RptTerimaJasaMaintenanceX.rdlc"
            End If
    ...
    Private Function uiTrnTerimaJasa_Maintenance_PrintPreview() As Boolean
        ...
        If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 1 Then
            ...
            Dim frmPrint As dlgRptTerimaJasaMaintenance = New dlgRptTerimaJasaMaintenance(Me.DSN, Me.ASSET_DSN, Me.SptServer, Me._CHANNEL, ket)
            Dim criteria As String = String.Empty
...
#End Region
    ...
    Private Sub btn_BuiltJurnal_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_BuiltJurnal.Click
        ...
        If isOk = True Then
            ...
            'row.Item("jurnaldetil_foreign") = Math.Round(((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreign").Value, 0) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0)), 2, MidpointRounding.AwayFromZero)
            'row.Item("jurnaldetil_idr") = Math.Round(((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_idrreal").Value, 0) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0)), 0, MidpointRounding.AwayFromZero)
            ...
            If Me.DgvTrnTerimajasadetil.CurrentRow.Cells("currency_id").Value = 1 Then
                ...
                Else
                    row.Item("jurnaldetil_foreign") = Math.Round(((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)), 0, MidpointRounding.AwayFromZero)
                End If
            ...
            Else
                ...
                If clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0) = 0 Then
                    row.Item("jurnaldetil_foreign") = 0
                Else
                    row.Item("jurnaldetil_foreign") = Math.Round(((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreign").Value, 0) - clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)), 2, MidpointRounding.AwayFromZero)
                End If
            ...
            Else
                row.Item("jurnaldetil_idr") = Math.Round(((clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_idrreal").Value, 0) - (clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0) * Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreignrate").Value)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)), 0, MidpointRounding.AwayFromZero)
            End If
