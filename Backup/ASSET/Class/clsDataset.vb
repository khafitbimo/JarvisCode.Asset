...
' Nikulla Pudja Dhewangga
' TransTV
' 2/21/2008 4:22:28 PM
...
Public Class clsDataset
    ...
    Public Shared Function CreateTblTrnPenerimaanbarang() As DataTable
        ...
        'tbl.Columns.Add(New DataColumn("terimabarang_qtyitem", GetType(System.Int64)))
        'tbl.Columns.Add(New DataColumn("terimabarang_qtyrealization", GetType(System.Int64)))
        'tbl.Columns.Add(New DataColumn("order_qty", GetType(System.Int64)))
    ...
    Public Shared Function CreateTblTrnPenerimaanbarangdetil() As DataTable
        ...
        'tbl.Columns.Add(New DataColumn("terimabarangdetil_qty", GetType(System.Int64)))
        ...
        tbl.Columns("terimabarangdetil_date").DefaultValue = Now()
        ...
        tbl.Columns("terimabarangdetil_qty").DefaultValue = 0
        ...
        tbl.Columns("terimabarangdetil_golfiskal").DefaultValue = ""
