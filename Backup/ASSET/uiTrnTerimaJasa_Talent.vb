'================================================== 
' Created Date: 5/4/2010 1:49 PM
' 

Imports Microsoft.Win32
Imports System.Threading
Imports System.ComponentModel
Public Class uiTrnTerimaJasa_Talent

    Private Const mUiName As String = "Transaksi Terima Jasa Talent"
    ...
    Private tbl_TrnTerimajasaUsed As DataTable = clsDataset.CreateTblTrnTerimajasausedTalent()
    ...
    Private tbl_MstItemCategory As DataTable = clsDataset.CreateTblMstSkill()
    ...
    Private objPrintHeader As DataSource.clsRptTerimaJasaTalent
...
#Region " Window Parameter "
    ...
    Private _STRUKTUR_UNIT As Decimal = 2360  '2610 '2360 '3501
...
#Region " Additional Overrides "
        ...
        If Me.DgvTrnTerimajasa.Rows.Count > 0 Then
            If Me._USERTYPE = "user" Then
                If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appuser").Value = 0 Then
                    Me.uiTrnTerimaJasa_Talent_AppUser("approved")
            ...
            ElseIf Me._USERTYPE = "spv" Then
                ...
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 0 Then
                    ...
                    'If Me.uiFormErrorApprove() = False Then
                    '    MsgBox("Contract number has not been approve KaDept.", MsgBoxStyle.Information)
                    '    Exit Sub
                    'End If

                    Me.uiTrnTerimaJasa_Talent_AppSpv("approved")
                End If

            ElseIf Me._USERTYPE = "bma" Then
                If Me.uiTrnTerimaJasa_Talent_FormError() Then
                    Exit Sub
                End If
                If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appuser").Value = 0 Then
                    MsgBox("Need User Approved", MsgBoxStyle.Information)
                ...
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appbma").Value = 0 Then
                    Me.uiTrnTerimaJasa_Talent_AppBma("approved")
                End If
            End If
        End If
    End Sub
        ...
        If Me.DgvTrnTerimajasa.Rows.Count > 0 Then
            If Me._USERTYPE = "user" Then
                ...
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appuser").Value = 1 Then
                    'unapproved user
                    Me.uiTrnTerimaJasa_Talent_AppUser("unapproved")
            ...
            ElseIf Me._USERTYPE = "spv" Then
                If Me.DgvTrnTerimajasa.Item("terimajasa_appbma", DgvTrnTerimajasa.CurrentRow.Index).Value = 1 Then
                    MsgBox("Need BMA UnApproved", MsgBoxStyle.Information)
                ElseIf Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 1 Then
                    Me.uiTrnTerimaJasa_Talent_AppSpv("unapproved")
                End If
            ElseIf Me._USERTYPE = "bma" Then
                ...
                Else
                    ...
                    If tbl_periode.Rows(0).Item("periode_isclosed") = True Then
                        ...
                        Exit Sub
                    Else
                        Me.uiTrnTerimaJasa_Talent_AppBma("unapproved")
                    End If
    ...
    Private Sub uiTrnTerimaJasa_Talent_AppUser(ByVal status As String)
    ...
    End Sub
    Private Sub uiTrnTerimaJasa_Talent_AppSpv(ByVal status_approved As String)
        ...
        If status_approved = "approved" Then
            ...
            If status IsNot Nothing Then
                ...
                Else
                    Try
                        'Me.uiTrnTerimaJasa_Talent_BuiltJurnal2()
                        Me.uiTrnTerimaJasa_Talent_BuiltJurnal3()
                        dbConn.Open()
                        dbConnStart.Open()
        ...
        Else
            Try
                Me.uiTrnTerimaJasa_Talent_ReGenerate_pajakArtis()
                dbConn.Open()
                dbConnStart.Open()
                Dim oCm As New OleDb.OleDbCommand("as_TrnTerimajasa_SpvApproved", dbConnStart)
                oCm.CommandType = CommandType.StoredProcedure
                ...
                Me.uiTrnTerimaJasa_Talent_OpenRowJurnalDetil_kredit(Me.DgvTrnTerimajasa.Item("channel_id", DgvTrnTerimajasa.CurrentRow.Index).Value, Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value, dbConn)
                Me.uiTrnTerimaJasa_Talent_OpenRowJurnalDetil_Debet(Me.DgvTrnTerimajasa.Item("channel_id", DgvTrnTerimajasa.CurrentRow.Index).Value, Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value, dbConn)
                Me.uiTrnTerimajasa_Talent_OpenRowJurnalReference(Me.DgvTrnTerimajasa.Item("channel_id", DgvTrnTerimajasa.CurrentRow.Index).Value, Me.DgvTrnTerimajasa.Item("terimajasa_id", DgvTrnTerimajasa.CurrentRow.Index).Value, dbConn)
            Catch ex As Data.OleDb.OleDbException
                MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, "SQL Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Catch ex As Exception
                MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
        ...
        System.Windows.Forms.Cursor.Current = Cursors.Default
    End Sub
    Private Sub uiTrnTerimaJasa_Talent_AppBma(ByVal status As String)
        System.Windows.Forms.Cursor.Current = Cursors.WaitCursor
        If Me.uiTrnTerimaJasa_Talent_FormError() Then
            System.Windows.Forms.Cursor.Current = Cursors.Default
            Exit Sub
        ...
        Try
            ...
            Else
                ...
                Me.tbtnSave.Enabled = True
            End If
            'Me.uiTrnTerimaJasa_Talent_JurnalSave()
        Catch ex As Data.OleDb.OleDbException
            MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, "SQL Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Catch ex As Exception
            MessageBox.Show("Data Not Saved" & vbCrLf & ex.Message, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub uiTrnTerimaJasa_Talent_BuiltJurnal()
        ...
        Dim requestdetil_foreignreal, requestdetil_foreignrate, requestdetil_qty As Decimal
        ...
        Dim persens(12) As Integer
        Dim minimal(12) As Decimal
        Dim maksimal(12) As Decimal
        Dim quota(12) As Decimal
        ...
        If Me.tbl_TrnTerimajasadetil.Rows.Count > 0 Then
            ...
            ' Untuk Penentuan Reference Pajak -----------------------------------------------------
            If Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 2 Then
                If Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak") = 1 Then
                    ' PPH21 Potong 
                    criteria = " code_pajak = 1"
                Else
                    ' PPH21 GrossUp 
                    Dim npwp As String = tbl_artis_temps.Rows(0).Item("npwp")
                    If npwp.Trim = "" Then
                        criteria = " code_pajak = 3"
                    Else
                        criteria = " code_pajak = 2"
                    End If

                End If
            ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 3 Or Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 4 Then
                If Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak") = 1 Then
                    ' PPh23/Royalti Potong
                    criteria = " code_pajak = 1"
                ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak") = 2 Then
                    ' PPh23/Royalti GrossUp
                    criteria = " code_pajak = 1"
                End If
            ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 1 Then
                ' No Tax 
                criteria = " code_pajak = 1"
            Else
            ...
            Me.DataFill(tbl_pajak_pph21, "ms_MstPajakPph21_Select", criteria)
            ...
            For rows_debet = 0 To Me.tbl_TrnTerimajasadetil.Rows.Count - 1
                ...
                table_mstArtisDetil2.Clear()
                tbl_artis_temps.Clear()

                Me.DataFill(table_mstArtisDetil2, "ms_MstArtisdetil_Select", String.Format(" code = '{0}' order by line desc", Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("item_id")))
                Me.DataFill(table_mstArtisDetil, "ms_MstArtisdetilSUM_Select", String.Format("code = '{0}' AND persen_tahun = YEAR(getdate()) ", Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("item_id")))
                Me.DataFill(tbl_artis_temps, "ms_MstArtis_Select", String.Format(" code = '{0}' and active = 1", Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("item_id")))

                For z = 0 To tbl_pajak_pph21.Rows.Count - 1
                    If (clsUtil.IsDbNull(tbl_artis_temps.Rows(0).Item("npwp"), String.Empty) = String.Empty Or clsUtil.IsDbNull(tbl_artis_temps.Rows(0).Item("npwp"), String.Empty) = "-") Then
                        persens(z) = clsUtil.IsDbNull(tbl_pajak_pph21.Rows(z).Item("persen_notnpwp"), 0)
                ...
                If Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 2 Then
                    If Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak") = 1 Then
                        ...
                        If table_mstArtisDetil.Rows.Count = 0 Then
                            ...
                            requestdetil_foreignreal = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreign")
                            requestdetil_foreignrate = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreignrate")
                            requestdetil_qty = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_qty_usage")

                            Temp_subtotal = (requestdetil_foreignreal * requestdetil_foreignrate * requestdetil_qty)
                            ...
                            Dim ppn_amount, ppn_percent As Decimal
                            ppn_percent = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen")
                            ppn_amount = Math.Round(Temp_subtotal * (ppn_percent / 100), MidpointRounding.ToEven)

                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnforeign") = ppn_amount
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal") = ppn_amount

                            Try
                                dbConn.Open()
                                Dim oCm As New OleDb.OleDbCommand("ms_MstArtisdetil_Insert", dbConn)
                                oCm.CommandType = CommandType.StoredProcedure
                                oCm.Parameters.Add("@code", System.Data.OleDb.OleDbType.VarWChar, 30).Value = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("item_id")
                                'If table_mstArtisDetil.Rows.Count > 0 Then
                                If table_mstArtisDetil2.Rows.Count > 0 Then
                                    oCm.Parameters.Add("@line", System.Data.OleDb.OleDbType.Integer, 4).Value = clsUtil.IsDbNull(table_mstArtisDetil2.Rows(0).Item("line"), 0) + 10
                                Else
                                    oCm.Parameters.Add("@line", System.Data.OleDb.OleDbType.Integer, 4).Value = 10
                                End If
                                oCm.Parameters.Add("@category_id", System.Data.OleDb.OleDbType.Decimal, 9).Value = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak")
                                oCm.Parameters.Add("@code_pajak", System.Data.OleDb.OleDbType.Decimal, 9).Value = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak")
                                ...
                                oCm.Parameters.Add("@amount_forartist", System.Data.OleDb.OleDbType.Decimal, 9).Value = bayar_artis + ppn_amount
                                ...
                                oCm.Parameters.Add("@order_id", System.Data.OleDb.OleDbType.VarWChar, 30).Value = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("order_id") 'Me.tbl_TrnTerimabarangdetil.Rows(rows_debet).Item("terimabarang_id")
                                oCm.Parameters.Add("@orderdetil_line", System.Data.OleDb.OleDbType.Integer, 4).Value = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("orderdetil_line") 'tbl_TrnTerimabarangdetil.Rows(rows_debet).Item("asset_line")
                            ...
                            'update ke terimajasadetil
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphforeign") = bayar_pajak
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphidrreal") = bayar_pajak
                            
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign") = bayar_total
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal") = bayar_total

                            pphAmount += bayar_pajak
                            ppnAmount += ppn_amount
                            amountForeign += bayar_total
                            amountIdrreal += bayar_total
                            amountDiscount += 0
                            ...
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("acc_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("acc_id")
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", bayar_total)
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", bayar_total)
                            If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                            ...
                            Else
                                Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            End If
                            ...
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("acc_id") = tbl_debetTemp.Rows(0).Item("acc_id")

                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", bayar_total)
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", bayar_total)
                            If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                                Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            Else
                                Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            End If
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("ref_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("order_id")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("ref_line") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("orderdetil_line")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreignrate") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreignrate")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("currency_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("currency_id")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("rekanan_id") = Me.obj_Rekanan_id.SelectedValue
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("rekanan_name") = Trim(Me.obj_Rekanan_id.Text)
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("strukturunit_id") = Me._STRUKTUR_UNIT 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("strukturunit_id")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("budget_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("budget_id")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("budget_name") = Trim(budget_name(0).Item(2))
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("budgetdetil_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("budgetdetil_id")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("budgetdetil_name") = Trim(budgetdetil_name(0).Item(2))
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_line") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_line") - 5
                            ...
                            Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasa_id")
                            Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id_ref") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("order_id")
                            Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id_refline") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("orderdetil_line")
                        ...
                        Else
                            ...
                            Temp_subtotal = (requestdetil_foreignreal * requestdetil_foreignrate * requestdetil_qty)
                            tbl_master_artisdetil.Clear()
                            Me.DataFill(tbl_master_artisdetil, "ms_MstArtisdetilSUM_Select", String.Format("code = '{0}' AND persen_tahun = YEAR(getdate()) ", Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("item_id")))
                            ...
                            Try
                                ...
                                oCm.Parameters.Add("@amount_forartist", System.Data.OleDb.OleDbType.Decimal, 9).Value = bayar_artis_ada + ppn_amount
                                oCm.Parameters.Add("@entry_date", System.Data.OleDb.OleDbType.DBTimeStamp, 4).Value = Now.Date
                                oCm.Parameters.Add("@entry_by", System.Data.OleDb.OleDbType.VarWChar, 100).Value = Me.UserName
                                oCm.Parameters.Add("@modified_date", System.Data.OleDb.OleDbType.DBTimeStamp, 4).Value = DBNull.Value
                                oCm.Parameters.Add("@modified_by", System.Data.OleDb.OleDbType.VarWChar, 100).Value = String.Empty
                            ...
                            'update ke terimajasadetil
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphforeign") = bayar_pajak_ada
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphidrreal") = bayar_pajak_ada
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign") = bayar_total_ada
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal") = bayar_total_ada

                            pphAmount += bayar_pajak_ada
                            ppnAmount += ppn_amount
                            amountForeign += bayar_total_ada
                            amountIdrreal += bayar_total_ada
                            amountDiscount += 0
                            ...
                            Me.tbl_TrnJurnaldetil_debet.Rows.Add()
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("acc_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("acc_id")
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", bayar_total_ada)
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", bayar_total_ada)
                            If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                                Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            Else
                                Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            ...
                            Me.tbl_TrnJurnaldetil_kredit.Rows.Add()
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("acc_id") = tbl_debetTemp.Rows(0).Item("acc_id")
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", bayar_total_ada)
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", bayar_total_ada)
                            If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                                Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            Else
                                Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                    ...
                    Else
                        ...
                        If table_mstArtisDetil.Rows.Count = 0 Then
                            ...
                            For row_index = 0 To Looping - 1
                                If jumlah_awal <= maksimal(0) Then
                                    ...
                                    Else
                                        bayar_pajak += bayar_sisa * (persens(0) / 100)
                                        pajak_gross += Math.Round(bayar_pajak * (100 / (100 - (persens(0) / 2))), MidpointRounding.ToEven)
                                ...
                                ElseIf jumlah_awal <= maksimal(1) Then
                                    ...
                                    Else
                                        bayar_pajak += bayar_sisa * (persens(1) / 100)
                                        pajak_gross += Math.Round(bayar_pajak * (100 / (100 - (persens(1) / 2))), MidpointRounding.ToEven)
                                        bayar_artis += bayar_sisa + object_tax ''''bayar_sisa
                                        amountWithTax = bayar_artis - pajak_gross
                                        bayar_total = pajak_gross + bayar_artis
                                ...
                                ElseIf jumlah_awal <= maksimal(2) Then
                                    ...
                                    Else
                                        bayar_pajak += bayar_sisa * (persens(2) / 100)
                                        pajak_gross += Math.Round(bayar_pajak * (100 / (100 - (persens(2) / 2))), MidpointRounding.ToEven)
                                        bayar_artis += bayar_sisa + object_tax ''''bayar_sisa
                                        amountWithTax = bayar_artis - pajak_gross
                                        bayar_total = pajak_gross + bayar_artis
                                        jumlah_awal = bayar_total
                                ...
                                ElseIf jumlah_awal > maksimal(2) Then
                                    bayar_pajak += bayar_sisa * (persens(3) / 100)
                                    pajak_gross += Math.Round(bayar_pajak * (100 / (100 - (persens(3) / 2))), MidpointRounding.ToEven)
                                    bayar_artis += bayar_sisa + object_tax ''''bayar_sisa
                                    amountWithTax = bayar_artis - pajak_gross
                                    bayar_total = pajak_gross + bayar_artis
                            ...
                            Dim ppn_amount, ppn_percent As Decimal
                            ppn_percent = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen")
                            ppn_amount = Math.Round(bayar_total * (ppn_percent / 100), MidpointRounding.ToEven)
                            ...
                            'update ke terimajasadetil
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphforeign") = pajak_gross
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphidrreal") = pajak_gross
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign") = bayar_total
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal") = bayar_total

                            pphAmount += pajak_gross
                            ppnAmount += ppn_amount
                            amountForeign += bayar_total
                            amountIdrreal += bayar_total
                            amountDiscount += 0
                            ...
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", bayar_total)
                            If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                                Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            Else
                                Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                            End If
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("ref_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("order_id")
                        ...
                        Else
                                ...
                                If temp_perhitungan < maksimal(0) Then
                                    ...
                                    If jumlah_awal_ada <= maksimal(0) Then
                                        ...
                                        Else
                                            ...
                                            pajak_gross_ada = Math.Round(bayar_pajak_ada * (100 / (100 - (persens(0) / 2))), MidpointRounding.ToEven)
                                    ...
                                    ElseIf jumlah_awal_ada <= maksimal(1) Then
                                        ...
                                        Else
                                            ...
                                            pajak_gross_ada = Math.Round(bayar_pajak_ada * (100 / (100 - (persens(1) / 2))), MidpointRounding.ToEven)
                                            amountWithTax_ada = Temp_subtotal - pajak_gross_ada
                                            bayar_total_ada = pajak_gross_ada + Temp_subtotal
                                            jumlah_awal_ada = bayar_total_ada
                                            persen_ada = persens(1)
                                            sisa_quota = maksimal(1) - ((Temp_subtotal * 0.5) + temp_perhitungan)
                                        End If
                                    ...
                                    ElseIf jumlah_awal_ada <= maksimal(2) Then
                                        ...
                                        Else
                                            ...
                                            pajak_gross_ada = Math.Round(bayar_pajak_ada * (100 / (100 - (persens(2) / 2))), MidpointRounding.ToEven)
                                            amountWithTax_ada = Temp_subtotal - pajak_gross_ada
                                            bayar_total_ada = pajak_gross_ada + Temp_subtotal
                                            jumlah_awal_ada = bayar_total_ada
                                            persen_ada = persens(2)
                                            sisa_quota = maksimal(2) - ((Temp_subtotal * 0.5) + temp_perhitungan)
                                        End If

                                    ElseIf jumlah_awal_ada > maksimal(2) Then
                                        bayar_pajak_ada += Math.Round(bayar_sisa_ada * (persens(3) / 100), MidpointRounding.ToEven)

                                        pajak_gross_ada = Math.Round(bayar_pajak_ada * (100 / (100 - (persens(3) / 2))), MidpointRounding.ToEven)
                                        amountWithTax_ada = Temp_subtotal - pajak_gross_ada
                                        bayar_total_ada = pajak_gross_ada + Temp_subtotal
                                        jumlah_awal_ada = bayar_total_ada
                                        persen_ada = persens(3)
                            ...
                            Dim ppn_amount, ppn_percent As Decimal
                            ppn_percent = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen")
                            ppn_amount = Math.Round(bayar_total_ada * (ppn_percent / 100), MidpointRounding.ToEven)
                            ...
                            Try
                                ...
                                oCm.Parameters.Add("@subtotal", System.Data.OleDb.OleDbType.Decimal, 9).Value = Temp_subtotal
                                oCm.Parameters.Add("@grand_total", System.Data.OleDb.OleDbType.Decimal, 9).Value = bayar_total_ada
                                oCm.Parameters.Add("@amount_forartist", System.Data.OleDb.OleDbType.Decimal, 9).Value = Temp_subtotal + ppn_amount
                                oCm.Parameters.Add("@entry_date", System.Data.OleDb.OleDbType.DBTimeStamp, 4).Value = Now.Date
                                oCm.Parameters.Add("@entry_by", System.Data.OleDb.OleDbType.VarWChar, 100).Value = Me.UserName
                                oCm.Parameters.Add("@modified_date", System.Data.OleDb.OleDbType.DBTimeStamp, 4).Value = DBNull.Value
                                oCm.Parameters.Add("@modified_by", System.Data.OleDb.OleDbType.VarWChar, 100).Value = String.Empty
                            ...
                            'update ke terimajasadetil
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphforeign") = pajak_gross_ada
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphidrreal") = pajak_gross_ada
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnforeign") = 0
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal") = 0
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign") = bayar_total_ada
                            Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal") = bayar_total_ada

                            pphAmount += pajak_gross_ada
                            ppnAmount += ppn_amount
                            amountForeign += bayar_total_ada
                            amountIdrreal += bayar_total_ada
                            amountDiscount += 0
                ...
                ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 3 Or Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 4 Then
                    ...
                    If Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak") = 1 Then
                        ...
                        'update ke terimajasadetil
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphforeign") = Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen") / 100)
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphidrreal") = Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen") / 100)
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnforeign") = Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100)
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal") = Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100)
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign") = Temp_subtotal - (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen") / 100)) + (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100))
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal") = Temp_subtotal - (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen") / 100)) + (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100))

                        pphAmount += Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen") / 100)
                        ppnAmount += Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100)
                        amountForeign += Temp_subtotal - (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen") / 100)) + (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100))
                        amountIdrreal += Temp_subtotal - (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen") / 100)) + (Temp_subtotal * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100))
                        amountDiscount += 0
                        ...
                        Me.tbl_TrnJurnaldetil_debet.Rows.Add()
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("acc_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("acc_id")
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", Temp_subtotal)
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", Temp_subtotal)
                        If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                        Else
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                        ...
                        Me.tbl_TrnJurnaldetil_kredit.Rows.Add()
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("acc_id") = tbl_debetTemp.Rows(0).Item("acc_id")
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", Temp_subtotal)
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", Temp_subtotal)
                        If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                        Else
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                    ...
                    ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak") = 2 Then
                        ...
                        Temp_subtotal = (requestdetil_foreignreal * requestdetil_foreignrate * requestdetil_qty)
                        pajak_pph23_grossUP_total = Temp_subtotal + ((Temp_subtotal * (100 / (100 - Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen")))) - Temp_subtotal)

                        'update ke terimajasadetil
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphforeign") = (Temp_subtotal * (100 / (100 - Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen")))) - Temp_subtotal
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphidrreal") = (Temp_subtotal * (100 / (100 - Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphpersen")))) - Temp_subtotal
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnforeign") = pajak_pph23_grossUP_total * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100)
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal") = pajak_pph23_grossUP_total * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100)
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign") = pajak_pph23_grossUP_total
                        Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal") = pajak_pph23_grossUP_total

                        pphAmount += (Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal
                        ppnAmount += pajak_pph23_grossUP_total * (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnpersen") / 100)
                        amountForeign += pajak_pph23_grossUP_total
                        amountIdrreal += pajak_pph23_grossUP_total
                        amountDiscount += 0
                        ...
                        Me.tbl_TrnJurnaldetil_debet.Rows.Add()
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("acc_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("acc_id")
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", pajak_pph23_grossUP_total)
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", pajak_pph23_grossUP_total)
                        If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                        Else
                            Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                        ...
                        Me.tbl_TrnJurnaldetil_kredit.Rows.Add()
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("acc_id") = tbl_debetTemp.Rows(0).Item("acc_id")
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", pajak_pph23_grossUP_total)
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", pajak_pph23_grossUP_total)
                        If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                        Else
                            Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                ...
                ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 1 Then
                    ...
                    Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphforeign") = 0
                    Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_pphidrreal") = 0
                    Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnforeign") = 0
                    Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal") = 0
                    Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign") = Temp_subtotal
                    Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal") = Temp_subtotal

                    pphAmount += 0
                    ppnAmount += 0
                    amountForeign += Temp_subtotal
                    amountIdrreal += Temp_subtotal
                    amountDiscount += 0
                    ...
                    Else
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                    End If
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("ref_id") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("order_id")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("ref_line") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("orderdetil_line")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreignrate") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("terimajasadetil_foreignrate")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("currency_id") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("currency_id")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("rekanan_id") = Me.obj_Rekanan_id.SelectedValue
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("rekanan_name") = Trim(Me.obj_Rekanan_id.Text)
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("strukturunit_id") = Me._STRUKTUR_UNIT 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("strukturunit_id")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("budget_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("budget_id")
                    ...
                    '============ Mulai masukkan data ke tab bagian Reference Na =======
                    Me.tbl_JurnalReference.Rows.Add()
                    Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("terimajasa_id")
                    Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id_ref") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("order_id")
                    Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id_refline") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("orderdetil_line")
                    '============ Akhir dari masukkan data ke tab Reference Kredit ===========

                    ''''''' type pajak dan kategory pajak = -- PILIH -- ''''''''''''''''''
                Else

                    pphAmount += 0
                    ppnAmount += 0
                    amountForeign += Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreign")
                    amountIdrreal += (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreign") * Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreignrate") * Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_qty_usage"))
                    amountDiscount += 0
                    ...
                    Me.tbl_TrnJurnaldetil_debet.Rows.Add()
                    Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("acc_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("acc_id")
                    Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreign"))
                    Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreign") * Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreignrate") * Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_qty_usage")))
                    If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                    Else
                        Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                    ...
                    Me.tbl_TrnJurnaldetil_kredit.Rows.Add()
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("acc_id") = tbl_debetTemp.Rows(0).Item("acc_id")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreign") = String.Format("{0:#,##0}", Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreign"))
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_idr") = String.Format("{0:#,##0}", (Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreign") * Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreignrate") * Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_qty_usage")))
                    If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc"), String.Empty) = String.Empty Then
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                    Else
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
        ...
        If isAcc_ok = "ok" Then
            Me.uiTrnTerimaJasa_Talent_JurnalSave()
        End If
        Me.uiTrnTerimaJasa_Talent_Save()
    End Sub

    Private Sub uiTrnTerimaJasa_Talent_BuiltJurnal2()
    ...
    Private Sub uiTrnTerimaJasa_Talent_BuiltJurnal3()
            ...
            For rows_debet = 0 To Me.tbl_TrnTerimajasadetil.Rows.Count - 1
                ...
                ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 3 Or Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 4 Then
                    ...
                    ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("type_pajak") = 2 Then
                        ...
                        '' ''Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("amount_artis") = Temp_subtotal + Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal")

                        '' ''Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign_incppn") = pajak_pph23_grossUP_total + Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal")
                        '' ''Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal_incppn") = pajak_pph23_grossUP_total + Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_ppnidrreal")

                        ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = (Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal
                        ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = (Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal
                        ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = 0
                        ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = 0
                        ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = pajak_pph23_grossUP_total
                        ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = pajak_pph23_grossUP_total
                ...
                ElseIf Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("kategori_pajak") = 1 Then
                    ...
                    '' ''Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalforeign_incppn") = Temp_subtotal
                    '' ''Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_totalidrreal_incppn") = Temp_subtotal

                    ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = 0
                    ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = 0
                    ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = 0
                    ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = 0
                    ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = Temp_subtotal
                    ' ''Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = Temp_subtotal
                    ...
                    Else
                        Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_descr") = tbl_artis_temps.Rows(0).Item("name") & " - " & Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_desc")
                    End If
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("ref_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("order_id") 'Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("order_id")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("ref_line") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("orderdetil_line") 'Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("orderdetil_line")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("jurnaldetil_foreignrate") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasadetil_foreignrate") 'Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("terimajasadetil_foreignrate")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("currency_id") = Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("currency_id")
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("rekanan_id") = Me.obj_Rekanan_id.SelectedValue
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("rekanan_name") = Trim(Me.obj_Rekanan_id.Text)
                    Me.tbl_TrnJurnaldetil_kredit.Rows(rows_debet).Item("strukturunit_id") = Me._STRUKTUR_UNIT 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("strukturunit_id")
                    ...
                    '============ Mulai masukkan data ke tab bagian Reference Na =======
                    Me.tbl_JurnalReference.Rows.Add()
                    Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("terimajasa_id") 'Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("terimajasa_id")
                    Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id_ref") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("order_id") 'Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("order_id")
                    Me.tbl_JurnalReference.Rows(rows_debet).Item("jurnal_id_refline") = Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("orderdetil_line") 'Me.tbl_TrnJurnaldetil_debet.Rows(rows_debet).Item("orderdetil_line")
                    '============ Akhir dari masukkan data ke tab Reference Kredit ===========
    ...
    Private Sub uiTrnTerimaJasa_Talent_ReGenerate_pajakArtis()
        Dim x, y As Integer
        ...
        For x = 0 To Me.tbl_TrnTerimajasadetil.Rows.Count - 1
            ...
            tbl_artis_temps.Clear()
            Me.DataFill(tbl_artis_temps, "ms_MstArtis_Select", String.Format(" code = '{0}' and active = 1", Me.tbl_TrnTerimajasadetil.Rows(x).Item("item_id")))

            ' Untuk Penentuan Reference Pajak -----------------------------------------------------
            If Me.tbl_TrnTerimajasadetil.Rows(x).Item("kategori_pajak") = 2 Then
                If Me.tbl_TrnTerimajasadetil.Rows(x).Item("type_pajak") = 1 Then
                    ' PPH21 Potong 
                    criteria = " code_pajak = 1"
                Else
                    ' PPH21 GrossUp 
                ...
                End If
            ElseIf Me.tbl_TrnTerimajasadetil.Rows(x).Item("kategori_pajak").Value = 3 Or Me.tbl_TrnTerimajasadetil.Rows(x).Item("kategori_pajak").Value = 4 Then
                If tbl_TrnTerimajasadetil.Rows(x).Item("type_pajak").Value = 1 Then
                    ' PPh23/Royalti Potong
                    criteria = " code_pajak = 1"
                ElseIf tbl_TrnTerimajasadetil.Rows(x).Item("type_pajak").Value = 2 Then
                    ' PPh23/Royalti GrossUp
                    criteria = " code_pajak = 1"
                End If
            ElseIf Me.tbl_TrnTerimajasadetil.Rows(x).Item("kategori_pajak").Value = 1 Then
                ' No Tax 
                criteria = " code_pajak = 1"
            Else
                'No TAX atau Tidak ada pajak
            ...
            If clsUtil.IsDbNull(Me.tbl_TrnTerimajasadetil.Rows(x).Item("kategori_pajak"), 0) = 2 Then
                tbl_artisDetil.Clear()
                Me.DataFill(tbl_artisDetil, "ms_MstArtisdetil_Select", String.Format(" order_id = '{0}' AND orderdetil_line = {1} ", Me.tbl_TrnTerimajasadetil.Rows(x).Item("order_id"), Me.tbl_TrnTerimajasadetil.Rows(x).Item("orderdetil_line")))
                Dim cek_ok As String = String.Empty
                Dim row_artis As Integer = 0

                If tbl_artisDetil.Rows.Count > 0 Then
                    artis_id = tbl_artisDetil.Rows(0).Item("code")
                    artis_line = tbl_artisDetil.Rows(0).Item("line")
                End If

                tbl_artisDetil_temps.Clear()
                Me.DataFill(tbl_artisDetil_temps, "ms_MstArtisdetil_Select", String.Format(" code = '{0}' AND persen_tahun = YEAR(getdate())", artis_id))
                    ...
                    ElseIf cek_ok = "ok" Then
                        If tbl_artisDetil_temps.Rows(y).Item("code_pajak") = 1 Then
                            ...
                            If row_artis = 2 Then
                                ...
                                For row_index = 0 To Looping - 1
                                    ...
                                    End If
                                Next
                                Dim ppn_amount, ppn_persen As Decimal

                                ppn_persen = Me.tbl_TrnTerimajasadetil.Rows(x).Item("terimajasadetil_ppnpersen")
                                ppn_amount = Math.Round(Temp_subtotal * (ppn_persen / 100), MidpointRounding.ToEven)
                        ...
                        Else
                            ...
                            If row_artis = 2 Then
                                ...
                                ppn_persen = Me.tbl_TrnTerimajasadetil.Rows(x).Item("terimajasadetil_ppnpersen")
                                ppn_amount = Math.Round(bayar_total * (ppn_persen / 100), MidpointRounding.ToEven)
...
#Region " Overrides "
    ...
    Public Overrides Function btnNew_Click() As Boolean
        ...
        End If
        Me.uiTrnTerimaJasa_Talent_NewData()
        Me.tbtnDel.Enabled = True
        Me.tbtnSave.Enabled = True
    ...
    Public Overrides Function btnLoad_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Talent_Retrieve()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrint_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Talent_Print()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrintPreview_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Talent_PrintPreview()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnDel_Click() As Boolean
        ...
        Else
            Me.uiTrnTerimaJasa_Talent_Delete()
        End If
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnFirst_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Talent_First()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnPrev_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Talent_Prev()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnNext_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Talent_Next()
        Me.Cursor = Cursors.Arrow
    ...
    Public Overrides Function btnLast_Click() As Boolean
        Me.Cursor = Cursors.WaitCursor
        Me.uiTrnTerimaJasa_Talent_Last()
        Me.Cursor = Cursors.Arrow
...
#Region " Layout & Init UI "
    ...
    Private Function FormatDgvTrnTerimajasadetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        Dim cType_pajak As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        Dim cKategori_pajak As System.Windows.Forms.DataGridViewComboBoxColumn = New System.Windows.Forms.DataGridViewComboBoxColumn
        ...
        Dim cTerimajasadetil_totalamountIncPPN As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cTerimajasadetil_totalamountidrIncPPN As System.Windows.Forms.DataGridViewTextBoxColumn = New System.Windows.Forms.DataGridViewTextBoxColumn

        Dim cAmount_artis As New System.Windows.Forms.DataGridViewTextBoxColumn
        ...
        cItem_id.HeaderText = "Artis Name"
        cItem_id.DataPropertyName = "item_id"
        cItem_id.Width = 150
        cItem_id.Visible = True
        cItem_id.ReadOnly = True
        cItem_id.DataSource = Me.tbl_MstArtis
        cItem_id.ValueMember = "code"
        cItem_id.DisplayMember = "name"

        cKategoriitem_id.Name = "kategoriitem_id"
        cKategoriitem_id.HeaderText = "Position"
        ...
        cKategoriitem_id.ValueMember = "code"
        cKategoriitem_id.DisplayMember = "name"
        ...
        cType_pajak.Visible = True
        cType_pajak.ReadOnly = True
        cType_pajak.ValueMember = "code_pajak"
        cType_pajak.DisplayMember = "pajak_name"
        cType_pajak.DataSource = Me.tbl_MstPajakType
        ...
        cKategori_pajak.Visible = True
        cKategori_pajak.ReadOnly = False
        cKategori_pajak.ValueMember = "category_id"
        cKategori_pajak.DisplayMember = "category_name"
        cKategori_pajak.DataSource = Me.tbl_MstPajakKategori
        ...
        cTerimajasadetil_totalamountIncPPN.Name = "terimajasadetil_totalforeign_incppn"
        cTerimajasadetil_totalamountIncPPN.HeaderText = "Total Amount (Inc. PPN)"
        ''''cTerimajasadetil_totalamountIncPPN.DataPropertyName = "terimajasadetil_totalforeign_incppn"
        cTerimajasadetil_totalamountIncPPN.Width = 160
        cTerimajasadetil_totalamountIncPPN.Visible = True
        cTerimajasadetil_totalamountIncPPN.ReadOnly = True
        cTerimajasadetil_totalamountIncPPN.DefaultCellStyle.BackColor = Color.Gainsboro
        cTerimajasadetil_totalamountIncPPN.DefaultCellStyle.Format = "#,##0.00"
        cTerimajasadetil_totalamountIncPPN.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        cTerimajasadetil_totalamountidrIncPPN.Name = "terimajasadetil_totalidrreal_incppn"
        cTerimajasadetil_totalamountidrIncPPN.HeaderText = "Total Amount(IDR)(Inc. PPN)"
        ''''cTerimajasadetil_totalamountidrIncPPN.DataPropertyName = "terimajasadetil_totalidrreal_incppn"
        cTerimajasadetil_totalamountidrIncPPN.Width = 180
        cTerimajasadetil_totalamountidrIncPPN.Visible = True
        cTerimajasadetil_totalamountidrIncPPN.ReadOnly = True
        cTerimajasadetil_totalamountidrIncPPN.DefaultCellStyle.BackColor = Color.Gainsboro
        cTerimajasadetil_totalamountidrIncPPN.DefaultCellStyle.Format = "#,##0"
        cTerimajasadetil_totalamountidrIncPPN.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        cAmount_artis.Name = "amount_artis"
        cAmount_artis.HeaderText = "Amount To Pay"
        ''''cAmount_artis.DataPropertyName = "amount_artis"
        cAmount_artis.Width = 120
        cAmount_artis.Visible = True
        cAmount_artis.ReadOnly = True
        cAmount_artis.DefaultCellStyle.BackColor = Color.Gainsboro
        cAmount_artis.DefaultCellStyle.Format = "#,##0.00"
        cAmount_artis.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

        objDgv.Columns.Clear()
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() _
        {cTerimajasa_id, cTerimajasadetil_line, cItem_id, cButton_days, cTerimajasadetil_qty_day_eps, _
        cTerimajasadetil_qty_usage, cTerimajasadetil_desc, cKategoriitem_id, cBrand_id, _
        ...
        cTerimajasadetil_idrreal, cTerimajasadetil_pphpersen, _
        cTerimajasadetil_disc, _
        cTerimajasadetil_pphAmount, cTerimajasadetil_pphAmountIDR, _
        cTerimajasadetil_totalamount, cTerimajasadetil_totalamountidr, _
        cTerimajasadetil_ppnpersen, cTerimajasadetil_ppnAmount, cTerimajasadetil_ppnAmountIDR, _
        cTerimajasadetil_totalamountIncPPN, cTerimajasadetil_totalamountidrIncPPN, cAmount_artis})
    ...
    Private Function FormatDgvTrnTerimajasaused(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        cTerimajasa_lineeps.Visible = True
        ...
        cTerimajasa_eps.HeaderText = "terimajasa_eps"
        cTerimajasa_eps.DataPropertyName = "terimajasa_eps"
        cTerimajasa_eps.Width = 100
        cTerimajasa_eps.DefaultCellStyle.Alignment = DataGridViewContentAlignment.NotSet
        cTerimajasa_eps.Visible = True
        cTerimajasa_eps.ReadOnly = False
        ...
        cTerimajasaused_qty.HeaderText = "terimajasaused_qty"
        ...
        cTerimajasaused_descr.HeaderText = "terimajasaused_descr"
        cTerimajasaused_descr.DataPropertyName = "terimajasaused_descr"
        cTerimajasaused_descr.Width = 100
        ...
        objDgv.Columns.Clear()
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() _
        {cChannel_id, cTerimajasa_id, cTerimajasa_line, cTerimajasa_lineeps, cOrder_id, cOrderdetil_line, cOrderdetiluse_line, cTerimajasa_eps, cTerimajasaused_check, cTerimajasaused_qty, cTerimajasaused_descr})
        objDgv.AutoGenerateColumns = False
        objDgv.AllowUserToAddRows = False
        objDgv.AllowUserToDeleteRows = False
    End Function
    Private Function FormatDgvTrnJurnaldetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        Dim cContractDetil_button As New System.Windows.Forms.DataGridViewButtonColumn
        ...
        cContractDetil_button.Name = "select_contract_detil"
        cContractDetil_button.HeaderText = "..."
        cContractDetil_button.Text = "..."
        cContractDetil_button.UseColumnTextForButtonValue = True
        cContractDetil_button.CellTemplate.Style.BackColor = Color.LightGray
        cContractDetil_button.Width = 30
        cContractDetil_button.DividerWidth = 3
        cContractDetil_button.Visible = True
        cContractDetil_button.ReadOnly = False

        objDgv.Columns.Clear()
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() _
        {cContractDetil_button, cJurnaldetil_line, cAcc_id, cAcc_no, cJurnaldetil_descr, _
    ...
    Private Function FormatDgvTrnOrderdetil(ByRef objDgv As System.Windows.Forms.DataGridView) As Boolean
        ...
        Dim cPajak_kategori As New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cPajak_type As New System.Windows.Forms.DataGridViewTextBoxColumn
        ...
        Dim cAmount_talent As New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cAmount_tax As New System.Windows.Forms.DataGridViewTextBoxColumn
        Dim cAmount_forartist As New System.Windows.Forms.DataGridViewTextBoxColumn
        ...
        cItem_name.Name = "artis_name"
        cItem_name.HeaderText = "Artis"
        cItem_name.DataPropertyName = "artis_name"
        cItem_name.Width = 130
        cItem_name.Visible = True
        cItem_name.ReadOnly = False

        cCategory_name.Name = "category_name"
        cCategory_name.HeaderText = "Position"
        ...
        cOrderdetil_descr.HeaderText = "Remarks"
        ...
        cOrderdetil_qty.HeaderText = "Persons"
        ...
        cCurrency.Name = "curr_name"
        cCurrency.HeaderText = "Curr."
        cCurrency.DataPropertyName = "curr_name"
        cCurrency.Width = 50
        ...
        cOrderdetil_foreign.HeaderText = "Deal Price"
        ...
        cROdetil_rowtotalforeign_incldisc.HeaderText = "SubTotal InclTax."
        ...
        cPajak_type.Name = "type_tax"
        cPajak_type.HeaderText = "Type"
        cPajak_type.DataPropertyName = "type_tax"
        cPajak_type.Width = 125
        cPajak_type.Visible = True
        cPajak_type.ReadOnly = False

        cPajak_kategori.Name = "category_tax"
        cPajak_kategori.HeaderText = "Category Tax"
        cPajak_kategori.Width = 125
        cPajak_kategori.DataPropertyName = "category_tax"
        cPajak_kategori.ReadOnly = False
        cPajak_kategori.Visible = True

        cAmount_talent.Name = "amount_talent"
        cAmount_talent.HeaderText = "Amount Talent"
        cAmount_talent.Width = 125
        cAmount_talent.DataPropertyName = "amount_talent"
        cAmount_talent.DefaultCellStyle.Format = "#,##0.00"
        cAmount_talent.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        cAmount_talent.Visible = True
        cAmount_talent.ReadOnly = True

        cAmount_tax.Name = "tax"
        cAmount_tax.HeaderText = "Tax"
        cAmount_tax.Width = 125
        cAmount_tax.DataPropertyName = "tax"
        cAmount_tax.DefaultCellStyle.Format = "#,##0.00"
        cAmount_tax.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        cAmount_tax.Visible = True
        cAmount_tax.ReadOnly = True

        cAmount_forartist.Name = "amount_forartist"
        cAmount_forartist.HeaderText = "Amount To Pay"
        cAmount_forartist.Width = 125
        cAmount_forartist.DataPropertyName = "amount_forartist"
        cAmount_forartist.DefaultCellStyle.Format = "#,##0.00"
        cAmount_forartist.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
        cAmount_forartist.Visible = True
        cAmount_forartist.ReadOnly = True

        cPpn_amount.Name = "ppn_amount"
        cPpn_amount.HeaderText = "Amount Ppn"
        ...
        objDgv.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() { _
           ...
           cPajak_kategori, cPajak_type, cOrderdetil_pphpercent, _
            cOrderdetil_ppnpercent, cPpn_amount, _
            cAmount_talent, _
            cAmount_tax, _
            cAmount_forartist, _
...
#Region " User Defined Function "
    ...
    Private Function uiTrnTerimaJasa_Talent_NewData() As Boolean
        'new data
        ...
        Me.tbl_TrnTerimajasa_Temp.Columns("terimajasa_type").DefaultValue = "TALENT"
        ...
        Me.tbl_TrnTerimajasadetil.Columns("terimajasadetil_type").DefaultValue = "TALENT"
        ...
        Me.tbl_TrnTerimajasaUsed = clsDataset.CreateTblTrnTerimajasausedTalent()
        ...
        ' ''Me.tbl_TrnTerimajasaUsed.Columns("terimajasadetil_type").DefaultValue = "TALENT"
    ...
    Private Function uiTrnTerimaJasa_Talent_Retrieve() As Boolean
        'retrieve data
        ...
        If chk_budget_Search.Checked = True Then
            criteria &= criteria & String.Format(" AND budget_id = '{0}'", Me.obj_budget_Search.Text)
        End If

        criteria &= " AND terimajasa_type = 'TALENT'"
    ...
    Private Function uiTrnTerimaJasa_Talent_Save() As Boolean
        'save data
        ...
        If tbl_TrnTerimajasa_Temp_Changes IsNot Nothing Or tbl_TrnTerimajasadetil_Changes IsNot Nothing Or tbl_TrnTerimajasaused_Changes IsNot Nothing Then
            ...
            Try
                ...
                If tbl_TrnTerimajasa_Temp_Changes IsNot Nothing Then
                    success = Me.uiTrnTerimaJasa_Talent_SaveMaster(terimajasa_id, tbl_TrnTerimajasa_Temp_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Saving Master Data at Me.uiTrnTerimaJasa_Talent_SaveMaster(tbl_TrnTerimajasa_Temp_Changes)")
                ...
                If tbl_TrnTerimajasadetil_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnTerimajasadetil.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnTerimaJasa_Talent_SaveDetil(terimajasa_id, tbl_TrnTerimajasadetil_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnTerimaJasa_Talent_SaveDetil(tbl_TrnTerimajasadetil_Changes)")
                ...
                If tbl_TrnTerimajasaused_Changes IsNot Nothing Then
                    For i = 0 To Me.tbl_TrnTerimajasaUsed.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnTerimaJasa_Talent_SaveDetilUsed(terimajasa_id, tbl_TrnTerimajasaused_Changes, MasterDataState)
                    If Not success Then Throw New Exception("Error: Save Detil Data at Me.uiTrnTerimaJasa_Talent_SaveDetilUsed(tbl_TrnTerimajasadetilUsed_Changes)")
    ...
    End Function
    Private Function uiTrnTerimaJasa_Talent_SaveMaster(ByRef terimajasa_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        ...
        Return True
    End Function
    Private Function uiTrnTerimaJasa_Talent_SaveDetil(ByRef terimajasa_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        ...
        dbCmdDelete = New OleDb.OleDbCommand("as_TrnTerimajasadetil_Delete", dbConnAsset)
        ...
        Return True
    End Function
    Private Function uiTrnTerimaJasa_Talent_SaveDetilUsed(ByRef terimajasa_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        ...
        dbCmdInsert = New OleDb.OleDbCommand("as_TrnTerimajasausedtalent_Insert", dbConnAsset)
        dbCmdInsert.CommandType = CommandType.StoredProcedure
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@channel_id", System.Data.OleDb.OleDbType.VarWChar, 20, "channel_id"))
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_id", System.Data.OleDb.OleDbType.VarWChar, 24))
        ...
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_lineeps", System.Data.OleDb.OleDbType.Integer, 4, "terimajasa_lineeps"))
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@order_id", System.Data.OleDb.OleDbType.VarWChar, 24, "order_id"))
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@orderdetil_line", System.Data.OleDb.OleDbType.Integer, 4, "orderdetil_line"))
        ...
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_eps", System.Data.OleDb.OleDbType.Integer, 4, "terimajasa_eps"))
        ...
        dbCmdInsert.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasaused_descr", System.Data.OleDb.OleDbType.VarWChar, 600, "terimajasaused_descr"))
        dbCmdInsert.Parameters("@terimajasa_id").Value = terimajasa_id


        dbCmdUpdate = New OleDb.OleDbCommand("as_TrnTerimajasausedtalent_Update", dbConnAsset)
        dbCmdUpdate.CommandType = CommandType.StoredProcedure
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@channel_id", System.Data.OleDb.OleDbType.VarWChar, 20, "channel_id"))
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_id", System.Data.OleDb.OleDbType.VarWChar, 24))
        ...
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_lineeps", System.Data.OleDb.OleDbType.Integer, 4, "terimajasa_lineeps"))
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@order_id", System.Data.OleDb.OleDbType.VarWChar, 24, "order_id"))
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@orderdetil_line", System.Data.OleDb.OleDbType.Integer, 4, "orderdetil_line"))
        ...
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_eps", System.Data.OleDb.OleDbType.Integer, 4, "terimajasa_eps"))
        ...
        dbCmdUpdate.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasaused_descr", System.Data.OleDb.OleDbType.VarWChar, 600, "terimajasaused_descr"))
        dbCmdUpdate.Parameters("@terimajasa_id").Value = terimajasa_id


        dbCmdDelete = New OleDb.OleDbCommand("as_TrnTerimajasausedtalent_Delete", dbConnAsset)
        dbCmdDelete.CommandType = CommandType.StoredProcedure
        ...
        dbCmdDelete.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_id", System.Data.OleDb.OleDbType.VarWChar, 24, "terimajasa_id"))
        ...
        dbCmdDelete.Parameters.Add(New System.Data.OleDb.OleDbParameter("@terimajasa_lineeps", System.Data.OleDb.OleDbType.Integer, 4, "terimajasa_lineeps"))
        dbCmdDelete.Parameters("@terimajasa_id").Value = terimajasa_id
    ...
    Private Function uiTrnTerimaJasa_Talent_JurnalSave() As Boolean
        'save data
        ...
        If tbl_TrnJurnal_Changes IsNot Nothing Or tbl_JurnalReference_Changes IsNot Nothing Or tbl_TrnJurnaldetil_kredit_Changes IsNot Nothing Or tbl_TrnJurnaldetil_debet_Changes IsNot Nothing Then
            ...
            Try
                ...
                If tbl_TrnJurnal_Changes IsNot Nothing Then
                    ...
                    success = Me.uiTrnTerimaJasa_Talent_JurnalSaveMaster(jurnal_id, tbl_TrnJurnal_Changes, MasterDataState)
                ...
                If tbl_TrnJurnaldetil_kredit_Changes IsNot Nothing Then
                    ...
                    success = Me.uiTrnJurnalJasa_Talent_JurnalSaveDetilKredit(jurnal_id, tbl_TrnJurnaldetil_kredit_Changes, MasterDataState)
                ...
                If tbl_JurnalReference_Changes IsNot Nothing Then
                    success = Me.uiTrnJurnalJasa_Talent_JurnalSaveReference(jurnal_id, tbl_JurnalReference_Changes, MasterDataState)
                ...
                If tbl_TrnJurnaldetil_debet_Changes IsNot Nothing Then
                    ...
                    For i = 0 To Me.tbl_TrnJurnaldetil_debet.Rows.Count - 1
                        ...
                        End If
                    Next
                    success = Me.uiTrnJurnalJasa_Talent_JurnalSaveDetilDebet(jurnal_id, tbl_TrnJurnaldetil_debet_Changes, MasterDataState)
    ...
    End Function
    Private Function uiTrnTerimaJasa_Talent_JurnalSaveMaster(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Return True
    End Function
    Private Function uiTrnJurnalJasa_Talent_JurnalSaveDetilKredit(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnJurnalJasa_Talent_JurnalSaveDetilDebet(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdUpdate As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Return True
    End Function
    Private Function uiTrnJurnalJasa_Talent_JurnalSaveReference(ByRef jurnal_id As Object, ByVal objTbl As DataTable, ByVal MasterDataState As System.Data.DataRowState) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbCmdInsert As OleDb.OleDbCommand
        Dim dbCmdDelete As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    Private Function uiTrnTerimaJasa_Talent_Delete() As Boolean
        Dim res As String = ""
        Dim terimajasa_id As Object = New Object
        ...
        If Me.DgvTrnTerimajasa.CurrentRow IsNot Nothing Then
            ...
            If res = DialogResult.Yes Then
                Me.uiTrnTerimaJasa_Talent_DeleteRow(Me.DgvTrnTerimajasa.CurrentRow.Index)
            End If
    ...
    Private Function uiTrnTerimaJasa_Talent_DeleteRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim dbCmdDelete As OleDb.OleDbCommand
        ...
        Try
            ...
            If Me.DgvTrnTerimajasa.Rows.Count > 1 Then
                ...
                If rowIndex = 0 Then
                    ...
                    Me.uiTrnTerimaJasa_Talent_OpenRow(NewRowIndex)
                ...
                Else
                    Me.tbl_TrnTerimajasa.Rows.RemoveAt(rowIndex)
                    Me.uiTrnTerimaJasa_Talent_OpenRow(rowIndex)
                End If
    ...
    Private Function uiTrnTerimaJasa_Talent_OpenRow(ByVal rowIndex As Integer) As Boolean
        Dim dbConn As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.DSN)
        Dim dbConnAsset As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.ASSET_DSN)
        Dim terimajasa_id As String
        ...
        Try
            ...
            dbConn.Open()
            dbConnAsset.Open()
            Me.uiTrnTerimaJasa_Talent_OpenRowMaster(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Talent_OpenRowDetil(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Talent_OpenRowDetilUsed(channel_id, terimajasa_id, dbConnAsset)
            Me.uiTrnTerimaJasa_Talent_OpenRowJurnal(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimaJasa_Talent_OpenRowJurnalDetil_kredit(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimaJasa_Talent_OpenRowJurnalDetil_Debet(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimajasa_Talent_OpenRowJurnalReference(channel_id, terimajasa_id, dbConn)
            Me.uiTrnTerimajasa_Talent_OpenRowResponse(channel_id, terimajasa_id, dbConn)

            Dim j As Integer
            If CInt(Me.DgvTrnTerimajasa.CurrentRow.Cells("terimajasa_appspv").Value) = 1 Then
                For j = 0 To Me.DgvTrnTerimajasadetil.Rows.Count - 1
                    Me.DgvTrnTerimajasadetil.Rows(j).Cells("amount_artis").Value = Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_totalidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_ppnidrreal").Value - Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_pphidrreal").Value

                    Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_totalforeign_incppn").Value = Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_totalforeign").Value + Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_ppnforeign").Value
                    Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_totalidrreal_incppn").Value = Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_totalidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(j).Cells("terimajasadetil_ppnidrreal").Value
                Next
            Else
                For j = 0 To Me.DgvTrnTerimajasadetil.Rows.Count - 1
                    Me.tax_detilppn(j)
            ...
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message, mUiName & ": uiTrnTerimaJasa_Talent_OpenRow()", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            dbConn.Close()
            dbConnAsset.Close()
        End Try
    ...
    Private Function uiTrnTerimaJasa_Talent_OpenRowMaster(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        ...
        Try
            ...
            If Me.tbl_TrnTerimajasa_Temp.Rows.Count > 0 Then
                Dim dbConnStart As OleDb.OleDbConnection = New OleDb.OleDbConnection(Me.START_DSN)
                dbConnStart.Open()
                Me.uiTalentOrder_OpenRowDetil(channel_id, tbl_TrnTerimajasa_Temp.Rows(0).Item("order_id"), dbConnStart)
                dbConnStart.Close()
            End If

        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnTerimaJasa_Talent_OpenRowMaster()" & vbCrLf & ex.Message)
        End Try

    End Function

    Private Function uiTrnTerimaJasa_Talent_OpenRowDetil(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
        ...
        Try
            ...
            Me.DgvTrnTerimajasadetil.DataSource = Me.tbl_TrnTerimajasadetil
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnTerimaJasa_Talent_OpenRowDetil()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnTerimaJasa_Talent_OpenRowDetilUsed(ByVal channel_id As String, ByVal terimajasa_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter

        dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasausedtalent_Select", dbConn)
        dbCmd.Parameters.Add("@Criteria", Data.OleDb.OleDbType.VarChar)
        dbCmd.Parameters("@Criteria").Value = String.Format("terimajasa_id='{0}'", terimajasa_id)
        dbCmd.CommandType = CommandType.StoredProcedure
        dbDA = New OleDb.OleDbDataAdapter(dbCmd)
        ...
        Try
            ...
            Me.dgvTerimaJasaUsed.DataSource = Me.tbl_TrnTerimajasaUsed
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTrnTerimaJasa_Talent_OpenRowDetilUsed()" & vbCrLf & ex.Message)
        End Try

    End Function
    Private Function uiTrnTerimaJasa_Talent_OpenRowJurnal(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimaJasa_Talent_OpenRowJurnalDetil_kredit(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimaJasa_Talent_OpenRowJurnalDetil_Debet(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimajasa_Talent_OpenRowJurnalReference(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTrnTerimajasa_Talent_OpenRowResponse(ByVal channel_id As String, ByVal jurnal_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter
    ...
    End Function
    Private Function uiTalentOrder_OpenRowDetil(ByVal channel_id As String, ByVal order_id As String, ByVal dbConn As OleDb.OleDbConnection) As Boolean
        Dim dbCmd As OleDb.OleDbCommand
        Dim dbDA As OleDb.OleDbDataAdapter

        dbCmd = New OleDb.OleDbCommand("as_TrnOrderDetilBpjTalent_Select", dbConn)
        ...
        Catch ex As Exception
            Throw New Exception(mUiName & ": uiTalentOrder_OpenRowDetil()" & vbCrLf & ex.Message)
        End Try
    ...
    Private Function uiTrnJurnal_TblDetilInverse(ByVal tbl As DataTable) As Boolean
        ...
        Return True
    End Function
    Private Function uiTrnTerimaJasa_Talent_First() As Boolean
        ...
        If iTab = 1 Then
            If Me.DATA_ISLOCKED Then
                move = True
            Else
                move = Me.uiTrnTerimaJasa_Talent_ConfirmSaveBeforeMove(Message)
            End If
        Else
            move = True
        End If
        ...
        If move Then
            ...
            Me.uiTrnTerimaJasa_Talent_RefreshPosition()
        End If
    End Function

    Private Function uiTrnTerimaJasa_Talent_Prev() As Boolean
    ...
    Private Function uiTrnTerimaJasa_Talent_Next() As Boolean
    ...
    Private Function uiTrnTerimaJasa_Talent_Last() As Boolean
    ...
    Private Function uiTrnTerimaJasa_Talent_RefreshPosition() As Boolean
        'refresh position
        Dim iTab As Integer = Me.ftabMain.SelectedIndex
        If iTab = 1 Then uiTrnTerimaJasa_Talent_OpenRow(Me.DgvTrnTerimajasa.CurrentRow.Index)
    End Function

    Private Function uiTrnTerimaJasa_Talent_ConfirmSaveBeforeMove(ByVal Message As String) As Boolean
    ...
    Private Function uiTrnTerimaJasa_Talent_FormError() As Boolean
...
#End Region
    ...
    Private Sub uiTrnTerimaJasa_Talent_FormBeforeNew() Handles Me.FormBeforeNew
        Me.objFormError.Clear()
    End Sub

    Private Sub uiTrnTerimaJasa_Talent_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ftabMain_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ftabMain.SelectedIndexChanged
        ...
        Select Case ftabMain.SelectedIndex
            ...
            Case 1
                ...
                If Me.DgvTrnTerimajasa.CurrentRow IsNot Nothing Then
                    Me.uiTrnTerimaJasa_Talent_OpenRow(Me.DgvTrnTerimajasa.CurrentRow.Index)
    ...
    Private Sub uiTrnTerimaJasa_LoadComboSearch()
        ...
        If Me._LOADCOMBOSEARCH = False Then
            ...
            oDataFiller.DataFillForComboString("code", "name", Me.tbl_MstArtis, "ms_MstArtis_Select", "")
            oDataFiller.DataFillForComboString("code", "name", Me.tbl_MstItemCategory, "ms_MstSkill_Select", "")
            oDataFiller.DataFillForComboAsset(Me.ASSET_DSN, "merk_id", "merk_name", Me.tbl_MstBrand, "as_MstMerk_Select", " merk_active = 1 ")
            ...
            oDataFiller.DataFillForCombo("category_id", "category_name", Me.tbl_MstPajakKategori, "ms_MstPajakKategori_Select", "")
            oDataFiller.DataFillForCombo("code_pajak", "pajak_name", Me.tbl_MstPajakType, "ms_MstPajakType_Select", "")
            ...
            Me.tbl_MstItemCategory.DefaultView.Sort = "name"
            ...
            Me.tbl_MstPajakKategori.DefaultView.Sort = "category_name"
            Me.tbl_MstPajakType.DefaultView.Sort = "pajak_name"
...
#End Region
    ...
    Private Sub btn_order_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_order.Click
        ...
        If Me.DgvTrnTerimajasadetil.Rows.Count = 0 Then
            Dim dlg As dlgTrnTerimajasa_Select_Talent = New dlgTrnTerimajasa_Select_Talent(Me.DSN, Me.ASSET_DSN, Me.obj_Rekanan_id.SelectedValue, Me.tbl_MstRekanan.Copy, Me._STRUKTUR_UNIT)

            Dim retObj As Object
            Dim retData As Collection
            Dim tblH As DataTable

            retObj = dlg.OpenDialog(Me, Me.obj_Channel_id.Text, "Talent")
            ...
            If retObj IsNot Nothing Then
                ...
                Me.uiTalentOrder_OpenRowDetil(Me._CHANNEL, tblH.Rows(0).Item("order_id"), dbConn)
            End If
        Else
    ...
    Private Sub Btn_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Add.Click
        Dim dlg As dlgTrnTerimaJasaDetil_Select_Talent = New dlgTrnTerimaJasaDetil_Select_Talent()
        ...
        If retObj IsNot Nothing Then
            ...
            For row_index = 0 To tblDetil.Rows.Count - 1
                ...
                row.Item("terimajasadetil_qty") = tblDetil.Rows(row_index).Item("to_outstanding")
                ...
                row.Item("kategoriitem_id") = tblDetil.Rows(row_index).Item("category_id") '"" 'tblDetil.Rows(row_index).Item("category_id")
                row.Item("brand_id") = 0
                ...
                row.Item("type_pajak") = tblDetil.Rows(row_index).Item("type_pajak")
                row.Item("kategori_pajak") = tblDetil.Rows(row_index).Item("kategori_pajak")
                ...
                If row.Item("kategori_pajak") = 2 Then
                    row.Item("terimajasadetil_pphpersen") = tblDetil.Rows(row_index).Item("persen")
                Else
                ...
                dbCmd = New OleDb.OleDbCommand("as_TrnTerimajasadetilUsed_Select_Talent", dbConn)
                ...
                Try
                    ...
                    For row_days = 0 To tbl_TrnOrderDetilUsed.Rows.Count - 1
                        ...
                        row.Item("terimajasa_lineeps") = tbl_TrnOrderDetilUsed.Rows(row_days).Item("orderdetiluse_line")
                        ...
                        row.Item("terimajasa_eps") = tbl_TrnOrderDetilUsed.Rows(row_days).Item("orderdetiluse_eps")
                        row.Item("terimajasaused_check") = 0
                        row.Item("terimajasaused_qty") = tbl_TrnOrderDetilUsed.Rows(row_days).Item("to_outstanding")
                        row.Item("terimajasaused_descr") = String.Empty
    ...
    Private Sub DgvTrnTerimajasadetil_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnTerimajasadetil.CellClick
        Select Case e.ColumnIndex
            Case Me.DgvTrnTerimajasadetil.Columns("select_days").Index
                ...
                Dim retObj As Object
                Dim retData As Collection
                Dim ListDaysOrder As New dlgTrnTerimaJasaUsed_Talent(Me.DSN, Me._CHANNEL, Me.obj_Terimajasa_id.Text, Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("orderdetil_line").Value, Me.obj_Terimajasa_status.SelectedItem, _
                ...
                If retObj IsNot Nothing Then
                    ...
                    For i = 0 To tbl_TrnTerimajasaDetilUsed_temps.DefaultView.Count - 1
                        For j = 0 To Me.tbl_TrnTerimajasaUsed.Rows.Count - 1
                            If tbl_TrnTerimajasaDetilUsed_temps.DefaultView.Item(i).Item("order_id") = Me.tbl_TrnTerimajasaUsed.Rows(j).Item("order_id") And _
                                ...
                                Me.tbl_TrnTerimajasaUsed.Rows(j).Item("terimajasaused_descr") = tbl_TrnTerimajasaDetilUsed_temps.DefaultView.Item(i).Item("terimajasaused_descr")
                    ...
                    If Me.tbl_TrnTerimajasadetil.Rows.Count > 0 Then
                        ...
                        tbl_artis_temps.Clear()
                        Me.DataFill(tbl_artis_temps, "ms_MstArtis_Select", String.Format(" code = '{0}' and active = 1", Me.tbl_TrnTerimajasadetil.Rows(e.RowIndex).Item("item_id")))


                        ' Untuk Penentuan Reference Pajak -----------------------------------------------------
                        If Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 2 Then
                            If Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("type_pajak").Value = 1 Then
                                ' PPH21 Potong 
                                criteria = " code_pajak = 1"
                            Else
                                ' PPH21 GrossUp 
                            ...
                            End If
                        ElseIf Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 3 Or Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 4 Then
                            If Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("type_pajak").Value = 1 Then
                                ' PPh23/Royalti Potong
                                criteria = " code_pajak = 1"
                            ElseIf Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("type_pajak").Value = 2 Then
                                ' PPh23/Royalti GrossUp
                                criteria = " code_pajak = 1"
                            End If
                        ElseIf Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 1 Then
                            ' No Tax 
                            criteria = " code_pajak = 1"
                        Else
                            'No TAX atau Tidak ada pajak
                        ...
                        criteria = String.Format(" order_id = '{0}' AND orderdetil_line = {1} ", Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("order_id").Value, Me.DgvTrnTerimajasadetil.Rows(DgvTrnTerimajasadetil.CurrentRow.Index).Cells("orderdetil_line").Value)
                        table_mstArtisDetil.Clear()
                        Me.DataFill(table_mstArtisDetil, "ms_MstArtisdetilSUM_Select", String.Format("code = '{0}' AND persen_tahun = YEAR(getdate()) ", Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("item_id").Value))
                        ...
                        If Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 2 Then
                            If Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("type_pajak").Value = 1 Then
                                ...
                                If table_mstArtisDetil.Rows.Count = 0 Then
                                    ...
                                    requestdetil_foreignreal = Format(clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0), "#,##0.00") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("asset_harga")
                                    requestdetil_foreignrate = Format(clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreignrate").Value, 0), "#,##0.00") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("asset_valas")
                                    requestdetil_qty = total_qty
                                    ...
                                    ppn_persen = Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnpersen").Value
                                    ppn_amount = Math.Round(Temp_subtotal * (ppn_persen / 100), MidpointRounding.ToEven)

                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = bayar_pajak
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = bayar_pajak
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = bayar_total
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = bayar_total

                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("amount_artis").Value = Temp_subtotal - bayar_pajak + ppn_amount

                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign_incppn").Value = bayar_total + ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal_incppn").Value = bayar_total + ppn_amount
                                ...
                                Else
                                    ...
                                    requestdetil_foreignreal = Format(clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreign").Value, 0), "#,##0.00") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("asset_harga")
                                    requestdetil_foreignrate = Format(clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_foreignrate").Value, 0), "#,##0.00") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("asset_valas")
                                    requestdetil_qty = total_qty 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("asset_qty")

                                    Temp_subtotal = (requestdetil_foreignreal * requestdetil_foreignrate * requestdetil_qty)

                                    Me.DataFill(tbl_master_artisdetil, "ms_MstArtisdetilSUM_Select", String.Format("code = '{0}' AND persen_tahun = YEAR(getdate()) ", Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("item_id").Value))
                                    temp_perhitungan = tbl_master_artisdetil.Rows(0).Item("total_50persen")
                                    ...
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = bayar_pajak_ada
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = bayar_pajak_ada
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = bayar_total_ada
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = bayar_total_ada

                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("amount_artis").Value = Temp_subtotal - bayar_pajak_ada + ppn_amount

                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign_incppn").Value = bayar_total_ada + ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal_incppn").Value = bayar_total_ada + ppn_amount
                            ...
                            Else
                                ...
                                If table_mstArtisDetil.Rows.Count = 0 Then
                                    ...
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = pajak_gross
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = pajak_gross
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = bayar_total
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = bayar_total
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("amount_artis").Value = Temp_subtotal + ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign_incppn").Value = bayar_total + ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal_incppn").Value = bayar_total + ppn_amount
                                    ' ============= Akhir yang belum ada di table =====================
                                Else
                                    ...
                                    ppn_persen = Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnpersen").Value
                                    ppn_amount = Math.Round(bayar_total_ada * (ppn_persen / 100), MidpointRounding.ToEven)

                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = pajak_gross_ada
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = pajak_gross_ada
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = bayar_total_ada
                                    Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = bayar_total_ada
                        ...
                        ElseIf Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 3 Or Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 4 Then
                            ...
                            If Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("type_pajak").Value = 1 Then
                                ...
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value / 100)
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value / 100)
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnpersen").Value / 100)
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnpersen").Value / 100)
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = Temp_subtotal - (Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value / 100))
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = Temp_subtotal - (Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value / 100))

                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("amount_artis").Value = Temp_subtotal - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value

                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign_incppn").Value = Temp_subtotal + Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value ' Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value + Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal_incppn").Value = Temp_subtotal + +Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value ' Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value
                            ...
                            ElseIf Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("type_pajak").Value = 2 Then
                                ...
                                Temp_subtotal = (requestdetil_foreignreal * requestdetil_foreignrate * requestdetil_qty)
                                pajak_pph23_grossUP_total = Temp_subtotal + ((Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal)

                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphforeign").Value = (Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphidrreal").Value = (Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value = (pajak_pph23_grossUP_total * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnpersen").Value))) - Temp_subtotal
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value = (pajak_pph23_grossUP_total * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnpersen").Value))) - Temp_subtotal
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = pajak_pph23_grossUP_total
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = pajak_pph23_grossUP_total

                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("amount_artis").Value = Temp_subtotal + Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign_incppn").Value = pajak_pph23_grossUP_total + Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnforeign").Value
                                Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal_incppn").Value = pajak_pph23_grossUP_total + Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_ppnidrreal").Value
                        ...
                        ElseIf Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("kategori_pajak").Value = 1 Then
                            ...
                            Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign").Value = Temp_subtotal
                            Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal").Value = Temp_subtotal
                            Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign_incppn").Value = Temp_subtotal
                            Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal_incppn").Value = Temp_subtotal
                        ...
                        Else
                            ...
                            Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalforeign_incppn").Value = Temp_subtotal
                            Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("terimajasadetil_totalidrreal_incppn").Value = Temp_subtotal
                            Me.DgvTrnTerimajasadetil.Rows(Me.DgvTrnTerimajasadetil.CurrentRow.Index).Cells("amount_artis").Value = Temp_subtotal
                        End If
                    End If
                End If
    ...
    Private Function tax_detilppn(ByVal rowIndex As Integer) As Boolean
        Dim tbl_TrnTerimajasaDetilUsed_temps As DataTable = New DataTable

        'buat ngitung pajak artis per row
        Dim tbl_pajak_pph21 As DataTable = New DataTable
        Dim table_mstArtisDetil As DataTable = New DataTable
        Dim tbl_master_artisdetil As DataTable = New DataTable
        Dim tbl_artis_temps As DataTable = New DataTable
        ...
        If Me.tbl_TrnTerimajasadetil.Rows.Count > 0 Then
            ...
            Me.DataFill(tbl_artis_temps, "ms_MstArtis_Select", String.Format(" code = '{0}' and active = 1", Me.tbl_TrnTerimajasadetil.Rows(rowIndex).Item("item_id")))

            ' Untuk Penentuan Reference Pajak -----------------------------------------------------
            If Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 2 Then
                If Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("type_pajak").Value = 1 Then
                    ' PPH21 Potong 
                    criteria = " code_pajak = 1"
                Else
                    ' PPH21 GrossUp 
                ...
                End If
            ElseIf Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 3 Or Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 4 Then
                If Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("type_pajak").Value = 1 Then
                    ' PPh23/Royalti Potong
                    criteria = " code_pajak = 1"
                ElseIf Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("type_pajak").Value = 2 Then
                    ' PPh23/Royalti GrossUp
                    criteria = " code_pajak = 1"
                End If
            ElseIf Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 1 Then
                ' No Tax 
                criteria = " code_pajak = 1"
            Else
                'No TAX atau Tidak ada pajak
            ...
            criteria = String.Format(" order_id = '{0}' AND orderdetil_line = {1} ", Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("order_id").Value, Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("orderdetil_line").Value)
            table_mstArtisDetil.Clear()
            'Me.DataFill(table_mstArtisDetil, "ms_MstArtisdetil_Select", String.Format(" code = '{0}' order by line desc", Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("item_id").Value))
            Me.DataFill(table_mstArtisDetil, "ms_MstArtisdetilSUM_Select", String.Format(" code = '{0}' AND persen_tahun = YEAR(getdate()) ", Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("item_id").Value))
            ...
            If Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 2 Then
                If Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("type_pajak").Value = 1 Then
                    ...
                    If table_mstArtisDetil.Rows.Count = 0 Then
                        ...
                        requestdetil_foreignreal = Format(clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_foreign").Value, 0), "#,##0.00") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("asset_harga")
                        requestdetil_foreignrate = Format(clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_foreignrate").Value, 0), "#,##0.00") 'Me.tbl_TrnTerimajasadetil.Rows(rows_debet).Item("asset_valas")
                        requestdetil_qty = clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_qty_usage").Value, 0)
                        ...
                        ppn_persen = Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnpersen").Value
                        ppn_amount = Math.Round(Temp_subtotal * (ppn_persen / 100), MidpointRounding.ToEven)

                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphforeign").Value = bayar_pajak
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value = bayar_pajak
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value = bayar_total
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value = bayar_total

                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("amount_artis").Value = Temp_subtotal - bayar_pajak + ppn_amount

                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign_incppn").Value = bayar_total + ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal_incppn").Value = bayar_total + ppn_amount
                    ...
                    Else
                        ...
                        Me.DataFill(tbl_master_artisdetil, "ms_MstArtisdetilSUM_Select", String.Format("code = '{0}' AND persen_tahun = YEAR(getdate()) ", Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("item_id").Value))
                        temp_perhitungan = tbl_master_artisdetil.Rows(0).Item("total_50persen")
                        ...
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphforeign").Value = bayar_pajak_ada
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value = bayar_pajak_ada
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value = bayar_total_ada
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value = bayar_total_ada

                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("amount_artis").Value = Temp_subtotal - bayar_pajak_ada + ppn_amount

                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign_incppn").Value = bayar_total_ada + ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal_incppn").Value = bayar_total_ada + ppn_amount
                ...
                Else
                    ...
                    If table_mstArtisDetil.Rows.Count = 0 Then
                        ...
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphforeign").Value = pajak_gross
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value = pajak_gross
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value = bayar_total
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value = bayar_total
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("amount_artis").Value = Temp_subtotal + ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign_incppn").Value = bayar_total + ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal_incppn").Value = bayar_total + ppn_amount
                    ...
                    Else
                        ...
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphforeign").Value = pajak_gross_ada
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value = pajak_gross_ada
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value = ppn_amount
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value = bayar_total_ada
                        Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value = bayar_total_ada
            ...
            ElseIf Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 3 Or Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 4 Then
                ...
                If Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("type_pajak").Value = 1 Then
                    ...
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphforeign").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphpersen").Value / 100)
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphpersen").Value / 100)
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnpersen").Value / 100)
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value = Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnpersen").Value / 100)
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value = Temp_subtotal - (Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphpersen").Value / 100))
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value = Temp_subtotal - (Temp_subtotal * (Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphpersen").Value / 100))

                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("amount_artis").Value = Temp_subtotal - Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value

                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign_incppn").Value = Temp_subtotal + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value 'Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal_incppn").Value = Temp_subtotal + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value 'Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value
                ...
                ElseIf Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("type_pajak").Value = 2 Then
                    ...
                    Temp_subtotal = (requestdetil_foreignreal * requestdetil_foreignrate * requestdetil_qty)
                    pajak_pph23_grossUP_total = Temp_subtotal + ((Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal)

                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphforeign").Value = (Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value = (Temp_subtotal * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphpersen").Value))) - Temp_subtotal
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value = (pajak_pph23_grossUP_total * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnpersen").Value))) - Temp_subtotal
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value = (pajak_pph23_grossUP_total * (100 / (100 - Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnpersen").Value))) - Temp_subtotal
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value = pajak_pph23_grossUP_total
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value = pajak_pph23_grossUP_total

                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("amount_artis").Value = Temp_subtotal + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value

                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign_incppn").Value = Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value
                    Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal_incppn").Value = Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value + Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value
            ...
            ElseIf Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("kategori_pajak").Value = 1 Then
                ...
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphforeign").Value = 0
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_pphidrreal").Value = 0
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnforeign").Value = 0
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_ppnidrreal").Value = 0
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign").Value = Temp_subtotal
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal").Value = Temp_subtotal
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign_incppn").Value = 0
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal_incppn").Value = 0
            ...
            Else
                ...
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalforeign_incppn").Value = Temp_subtotal
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("terimajasadetil_totalidrreal_incppn").Value = Temp_subtotal
                Me.DgvTrnTerimajasadetil.Rows(rowIndex).Cells("amount_artis").Value = Temp_subtotal
...
ulang:
    ...
    Private Sub FtabJurnal_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles FtabJurnal.SelectedIndexChanged
        ...
        Select Case ftabMain.SelectedIndex
            Case 0
                Me.DgvTrnJurnaldetil_Pembayaran.Columns("select_contract_detil").Visible = True

            Case 1
                Me.DgvTrnJurnaldetil.Columns("select_contract_detil").Visible = False
...
#Region "PRINT"
    ...
    Private Sub GenerateDataDetail()
        ...
        For i = 0 To Me.tbl_PrintDetil.Rows.Count - 1
            objDetil = New DataSource.clsRptTerimaJasaTalentDetil(Me.DSN, Me.ASSET_DSN)
            With objDetil
    ...
    Private Function uiTrnTerimaJasa_Talent_Print() As Boolean
        ...
        If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 1 Then
            ...
            Else
                'objReportH.ReportEmbeddedResource = "ASSET.RptTerimaJasa_TalentX.rdlc"
                objReportH.ReportEmbeddedResource = "ASSET.RptTerimaJasa_Talentxx.rdlc"
            End If
    ...
    Private Function uiTrnTerimaJasa_Talent_PrintPreview() As Boolean
        ...
        If Me.DgvTrnTerimajasa.Rows(Me.DgvTrnTerimajasa.CurrentRow.Index).Cells("terimajasa_appspv").Value = 1 Then
            ...
            Dim frmPrint As dlgRptTerimaJasaTalent = New dlgRptTerimaJasaTalent(Me.DSN, Me.ASSET_DSN, Me.SptServer, Me._CHANNEL, ket)
            Dim criteria As String = String.Empty
...
#End Region
    ...
    Private Sub btn_BuiltJurnal_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_BuiltJurnal.Click
        Dim row As DataRow
        Dim tbl_debetTemp As DataTable = New DataTable
        Dim i As Integer
        ...
        If isOk = True Then
            ...
            row.Item("acc_id") = Me.DgvTrnTerimajasadetil.CurrentRow.Cells("acc_id").Value '0
            ...
            Else
                ...
                If clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("type_pajak").Value, 1) = 1 Then
                    row.Item("jurnaldetil_foreignrate") = Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreignrate").Value
                    row.Item("jurnaldetil_foreign") = ((String.Format("{0:#,##0.00}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreign").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)) - String.Format("{0:#,##0.00}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0)))
                    row.Item("jurnaldetil_idr") = ((String.Format("{0:#,##0}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_idrreal").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)) - String.Format("{0:#,##0}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0)))
                Else
                    row.Item("jurnaldetil_foreignrate") = Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreignrate").Value
                    row.Item("jurnaldetil_foreign") = (((String.Format("{0:#,##0.00}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_foreign").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)) - String.Format("{0:#,##0.00}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0))) + String.Format("{0:#,##0}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_pphforeign").Value, 0)))
                    row.Item("jurnaldetil_idr") = (((String.Format("{0:#,##0}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_idrreal").Value, 0)) * clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_qty_usage").Value, 0)) - String.Format("{0:#,##0}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_disc").Value, 0))) + String.Format("{0:#,##0}", clsUtil.IsDbNull(Me.DgvTrnTerimajasadetil.CurrentRow.Cells("terimajasadetil_pphidrreal").Value, 0)))
                End If
...
ulang2:
    ...
    Private Sub DgvTrnJurnaldetil_Pembayaran_CellContentClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvTrnJurnaldetil_Pembayaran.CellContentClick
        If e.RowIndex >= 0 Then
            Select Case e.ColumnIndex
                Case Me.DgvTrnJurnaldetil_Pembayaran.Columns("select_contract_detil").Index
                    Dim dlg As New dlgSelectContract(Me.DSN)
                    Me.Cursor = Cursors.WaitCursor
                    dlg.OpenDialog(Me, clsUtil.IsDbNull(Me.DgvTrnJurnaldetil_Pembayaran.Item("ref_id", e.RowIndex).Value, String.Empty), clsUtil.IsDbNull(Me.DgvTrnJurnaldetil_Pembayaran.Item("ref_line", e.RowIndex).Value, 0))
...
ulang2:
    ...
    Private Sub btn_budget_Search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_budget_Search.Click
        Dim budget_id As String
        Dim dlg As dlgSearch = New dlgSearch()
        Dim retData As String
        retData = dlg.OpenDialog(Me, Me.tbl_TrnBudget.Copy, "budget")
        budget_id = retData

        If budget_id IsNot Nothing Then
            Me.obj_budget_Search.Text = budget_id
        End If
    End Sub

    Private Function uiFormErrorApprove() As Boolean
        ...
        Try
            ...
            If Me._USERTYPE = "spv" Then
                'cek approve contract
                Dim i As Integer
                Dim cell_order_id, cell_orderdetil_line As DataGridViewCell
                Dim dgv_error, row_error As Boolean
                Dim tbl_SelectContract As DataTable = clsDataset.CreateTblViewContractSrtis

                Me.DgvTrnJurnaldetil.AllowUserToAddRows = False

                For i = 0 To Me.DgvTrnTerimajasadetil.Rows.Count - 1
                    row_error = False
                    Message = "Contract number has not been approve KaDept."
                    cell_order_id = Me.DgvTrnTerimajasadetil.Rows(i).Cells("order_id")
                    cell_orderdetil_line = Me.DgvTrnTerimajasadetil.Rows(i).Cells("orderdetil_line")

                    oDataFiller.DataFillLineID(tbl_SelectContract, "as_ViewContract_Select", cell_order_id.Value, cell_orderdetil_line.Value)

                    If tbl_SelectContract.Rows.Count > 0 Then

                        If tbl_SelectContract.Rows(0).Item("app_dept") = 0 Then
                            cell_order_id.ErrorText = Message
                            row_error = True
                        Else
                            cell_order_id.ErrorText = ""
                        End If
                    ...
                    If row_error Then
                        dgv_error = True
                        Me.DgvTrnTerimajasadetil.Rows(i).DefaultCellStyle.BackColor = Color.Coral
                        Return False
                    Else
                        Me.DgvTrnTerimajasadetil.Rows(i).DefaultCellStyle.BackColor = Color.White
                    End If
